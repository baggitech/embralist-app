      ...
      <div class="row pt-sm-2">
                  ...
                  <nav class="docs-list list-group list-group-borderless" onclick="closeSidebar()">
                    ...
                    <div class="dropdown">
                      ...
                      <ul id="anchorNav" class="nav nav-underline flex-column border-start ms-2 my-2" style="gap: .25rem;">
                        <li class="nav-item"><a class="nav-link fw-normal" href="#code-inline">Inline code</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#code-user-input">User input</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#code-variables">Variables</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#code-block">Code block</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#code-scrollable">Code block scrollable</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#code-highlighting">Code highlighting</a></li>
                      </ul>
                    </div>
                    <div class="dropend">
        ...
        <main class="col-lg-9 pt-1 pb-5 mb-sm-2 mb-md-3">
          ...
          <section class="pt-2 pb-md-2">
            <a class="badge d-inline-flex align-items-center text-info bg-info-subtle fw-semibold text-decoration-none py-2 px-3 mb-2 rounded-pill" href="https://getbootstrap.com/docs/5.3/content/reboot/#inline-code" target="_blank" rel="noreferrer">
              Bootstrap docs
          ...
          <section class="alert d-sm-flex text-body-emphasis bg-info-subtle border-0 py-4 mb-5">
            ...
            <div class="ps-sm-3 pe-sm-5 w-100">
              <p class="mb-3">The code highlighting feature is made with the <a class="alert-link" href="https://highlightjs.org" target="_blank" rel="noreferrer">Highlight.js</a> plugin. Ensure that you include the necessary references to the plugin's .css and .js files in your document:</p>
              <pre class="code-highlight border mb-3" data-bs-theme="dark"><code class="language-html">&lt;link rel=&quot;stylesheet&quot; href=&quot;https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/styles/atom-one-dark.min.css&quot;&gt;&lt;/link&gt;
&lt;script src=&quot;https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/highlight.min.js&quot;&gt;&lt;/script&gt;</code></pre>
              <p class="mb-2">You can easily switch between different themes by referencing alternative CSS styles. Here is the complete list of all <a class="alert-link" href="https://github.com/highlightjs/highlight.js/tree/main/src/styles" target="_blank" rel="noreferrer">available themes</a>.</p>
            </div>
          </section>


          <!-- Inline code -->
          <section id="code-inline" class="docs-section pb-sm-2 mb-5">
            <h4>Inline code</h4>
                ...
                <div class="tab-content">
                  ...
                  <div id="html-1" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      ...
                      <pre id="inline-code" class="code-highlight mx-n2 mb-n2"><code class="language-html">&lt;p&gt;Wrap inline snippets of code with &lt;code&gt;&amp;lt;code&amp;gt;&lt;/code&gt;.&lt;/p&gt;</code></pre>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <!-- User input -->
          <section id="code-user-input" class="docs-section pb-sm-2 mb-5">
            <h4>User input</h4>
            <div class="card border-0 shadow">
              <span class="d-none d-block-dark position-absolute top-0 start-0 w-100 h-100 bg-dark rounded opacity-50"></span>
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  ...
                  <div id="html-2" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#user-input-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
...
&lt;/p&gt;</code></pre>
          ...
          <!-- Variables -->
          <section id="code-variables" class="docs-section pb-sm-2 mb-5">
            <h4>Variables</h4>
            <div class="card border-0 shadow">
              <span class="d-none d-block-dark position-absolute top-0 start-0 w-100 h-100 bg-dark rounded opacity-50"></span>
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  ...
                  <div id="html-3" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#variables-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
                      <pre id="variables-code" class="code-highlight mx-n2 mb-n2"><code class="language-html">&lt;var&gt;y&lt;/var&gt; = &lt;var&gt;mx&lt;/var&gt; + &lt;var&gt;b&lt;/var&gt;</code></pre>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <!-- Code block -->
          <section id="code-block" class="docs-section pb-sm-2 mb-5">
            <h4>Code block</h4>
            <div class="card border-0 shadow">
              <span class="d-none d-block-dark position-absolute top-0 start-0 w-100 h-100 bg-dark rounded opacity-50"></span>
              <div class="card-body position-relative z-2">
...
&lt;p&gt;And another line of sample text here...&lt;/p&gt;</code></pre>
                  ...
                  <div id="html-4" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#block-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
                      <pre id="block-code" class="code-highlight mx-n2 mb-n2"><code class="language-html">&lt;pre&gt;
...
&lt;/pre&gt;</code></pre>
          ...
          <section id="code-scrollable" class="docs-section pb-sm-2 mb-5">
              ...
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  <div id="preview-5" class="tab-pane pt-4 pb-2 mt-3 fade show active" role="tabpanel">
                    <pre class="overflow-auto" style="height: 19.75rem"><code>&lt;div class=&quot;table-responsive&quot;&gt;
  &lt;table class=&quot;table&quot;&gt;
    &lt;thead&gt;
      &lt;tr&gt;
        &lt;th&gt;#&lt;/th&gt;
...
&lt;/div&gt;</code></pre>
                  ...
                  <div id="html-5" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#scrollable-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
                      <pre id="scrollable-code" class="code-highlight mx-n2 mb-n2"><code class="language-html">&lt;pre class=&quot;overflow-auto&quot; style=&quot;height: 20rem;&quot;&gt;
  &lt;code&gt;
    Code goes here...
  &lt;/code&gt;
&lt;/pre&gt;</code></pre>
          ...
          <!-- Code highlighting -->
          <section id="code-highlighting" class="docs-section">
              ...
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  <div id="preview-6" class="tab-pane pt-4 pb-2 mt-3 fade show active" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 px-2 mt-2 me-2 z-3" data-copy-code="#copy-this-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
...
&lt;/div&gt;</code></pre>
                  ...
                  <div id="html-6" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#highlighting-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>

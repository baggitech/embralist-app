...
<head>
  <?php $title = "Help Single Article v.3"; include('partials/title-meta.php'); ?>
...
<body>
  ...
  <main class="content-wrapper">
          ...
          <div class="col-md-7">
            ...
            <div class="bg-body border rounded p-2">
              <form class="d-flex flex-column flex-sm-row gap-2 p-1">
                <input type="search" class="form-control form-control-lg border-0 rounded-0 ps-3"
                  placeholder="What do you need help with?">
                <button type="submit" class="btn btn-icon btn-lg btn-primary d-none d-sm-inline-flex"
                  aria-label="Search">
            ...
            <!-- Popular searches -->
            <div class="nav justify-content-center justify-content-md-start gap-2 text-center text-md-start fs-sm pt-4"
              data-bs-theme="dark">
            ...
            <div class="ps-md-5 ps-xl-0">
              <div class="position-relative w-100 ms-auto" style="max-width: 416px">
                <div class="ratio bg-body-secondary"
                  style="--fn-aspect-ratio: calc(344 / 416 * 100%); -webkit-clip-path: url(#mask); clip-path: url(#mask)">
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          ...
          <nav class="pb-2" aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="help-topics-v3.php">Help center</a></li>
              <li class="breadcrumb-item"><a href="#!">Search and navigation</a></li>
              <li class="breadcrumb-item active" aria-current="page">Single article v.3</li>
            </ol>
          </nav>

          <h1 class="h2 mb-5">How to use the search to find a doctor</h1>
          <p>Finding the right doctor is essential for maintaining good health, and our search tool is designed to make
            this process easy and efficient. Start by accessing the search bar on our homepage or within our mobile app.
            Enter relevant keywords that describe the type of doctor you need, such as the specialty (e.g.,
            "Cardiologist," "Pediatrician"), condition (e.g., "Diabetes," "Allergies"), procedure (e.g., "Physical
            exam," "Surgery"), and your location to narrow down the results.</p>
          <p>After entering your keywords, use the available filters to refine your search further. Filters can help you
            sort by distance, patient ratings, years of experience, insurance acceptance, and even the doctor's gender
            if you have a preference.</p>
          <p>Reviewing the profiles of doctors in your search results is crucial. Each profile typically includes a
            biography detailing the doctor's background and specialties, patient reviews, office hours and locations,
            and contact information. These details will help you make an informed decision about which doctor suits your
            needs.</p>
          <p>When you find a doctor that matches your criteria, you can make an appointment directly online if that
            option is available, or contact the office using the provided phone number or email. Be sure to prepare any
            necessary documents and medical history for your visit to ensure a productive appointment.</p>
          ...
          <h2 class="h4 pt-3 pt-lg-4">Additional tips</h2>
          <p>Using our search tool, finding the right doctor has never been easier. Follow these steps to ensure you
            find a healthcare provider that meets your needs and provides the care you deserve.</p>
          <ul class="gap-3 pb-3 pb-lg-4">
            <li>
              <span class="text-dark-emphasis fw-semibold">Ask for recommendations:</span> If you're unsure where to
              start, ask friends, family, or your current healthcare provider for recommendations.
            </li>
            <li>
              <span class="text-dark-emphasis fw-semibold">Check credentials:</span> Verify the doctor's credentials and
              board certifications to ensure they are qualified.
            </li>
            <li>
              <span class="text-dark-emphasis fw-semibold">Consider Telehealth options:</span> If you have difficulty
              traveling, check if the doctor offers virtual appointments.
            </li>
          </ul>

          <!-- Alert -->
          <div class="alert d-flex alert-info mb-3" role="alert">
            <i class="fi-info fs-lg pe-1 mt-1 me-2"></i>
            <div class="fs-sm">When you find a doctor that matches your criteria, you can make an appointment directly
              online if that option is available, or contact the office using the provided phone number or email.</div>
          </div>

          <p class="pt-3 pt-lg-4">If you're unsure where to start, consider asking for recommendations from friends,
            family, or your current healthcare provider. Always check the doctor's credentials and board certifications
            to ensure they are qualified. For those with travel difficulties, explore telehealth options that the doctor
            might offer.</p>
          <p>Using our search tool simplifies the process of finding a healthcare provider, ensuring you receive the
            care you deserve efficiently and conveniently.</p>

          <!-- Article meta -->
          <div class="d-flex align-items-center fs-sm text-body-secondary pt-3 pt-lg-4 pb-2">
            5 months ago
        ...
        <aside class="col-lg-4 col-xl-3 offset-xl-1" style="margin-top: -105px">
          <div class="offcanvas-lg offcanvas-end sticky-lg-top ps-lg-4 ps-xl-0" id="articlesSidebar">
            <div class="d-none d-lg-block" style="height: 105px"></div>
            <div class="offcanvas-header position-relative d-block py-3 p-lg-0 mb-lg-4">
              <div class="d-flex align-items-center">
                <h3 class="h5 offcanvas-title">Search and navigation</h3>
                <button type="button" class="btn-close d-lg-none" data-bs-dismiss="offcanvas"
                  data-bs-target="#articlesSidebar" aria-label="Close"></button>
              </div>
              <div class="position-absolute start-0 top-100 w-100 border-bottom d-lg-none m-0"></div>
            </div>
            <div class="offcanvas-body d-block">
              <ul class="nav flex-column gap-3">
                <li class="nav-item">
                  <a class="nav-link position-relative p-0 active" aria-current="page" href="#!">
                ...
                <li class="nav-item">
                  <a class="nav-link position-relative fw-normal p-0" href="#!">
                    <i class="fi-chevron-right fs-base me-2 ms-n1"></i>
                ...
                <li class="nav-item">
                  <a class="nav-link position-relative fw-normal p-0" href="#!">
                    <i class="fi-chevron-right fs-base me-2 ms-n1"></i>
                    <span class="hover-effect-underline stretched-link">Search for doctors by specialty or
                      location</span>
                  </a>
                </li>
              </ul>
    ...
    <section class="container pt-2 pt-sm-3 pt-md-4 pt-lg-5 pb-5 my-xxl-3">
      <div class="bg-info rounded overflow-hidden mb-2 mb-sm-3 mb-md-4 mb-lg-5">
        <div class="row">
          <div
            class="col-md-6 d-flex justify-content-center justify-content-md-start text-center text-md-start py-md-2 py-lg-4">
          ...
          <div class="col-md-6">
            <div class="position-relative h-100">
              <img src="assets/img/help/v3/cta.jpg" class="position-absolute top-0 start-0 w-100 h-100 object-fit-cover"
                alt="Image">
            </div>
          </div>
        </div>
  ...
  <button type="button"
    ...
    data-bs-toggle="offcanvas" data-bs-target="#articlesSidebar" aria-controls="articlesSidebar" data-bs-theme="light">

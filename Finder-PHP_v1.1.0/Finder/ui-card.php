      ...
      <div class="row pt-sm-2">
                  ...
                  <nav class="docs-list list-group list-group-borderless" onclick="closeSidebar()">
                    ...
                    <div class="dropdown">
                      ...
                      <ul id="anchorNav" class="nav nav-underline flex-column border-start ms-2 my-2" style="gap: .25rem;">
                        <li class="nav-item"><a class="nav-link fw-normal" href="#card-basic">Basic example</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#card-alt-style">Alternative card style</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#card-image-caps">Image caps</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#card-image-hover">Image hover effects</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#card-horizontal">Horizontal layout</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#card-header-footer">Header and footer</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#card-text-alignment">Text alignment</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#card-nav-tabs">Navigation: Tabs</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#card-nav-pills">Navigation: Pills</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#card-list-group">List group inside card</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#card-bg-solid">Card styles: Solid background</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#card-bg-subtle">Card styles: Subtle background</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#card-border-color">Card styles: Border and text color</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#card-group">Layout: Card group</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#card-grid">Layout: Card grid</a></li>
                      </ul>
                    </div>
                    <div class="dropend">
        ...
        <main class="col-lg-9 pt-1 pb-5 mb-sm-2 mb-md-3">
          ...
          <section class="py-2 pb-sm-3">
            <a class="badge d-inline-flex align-items-center text-info bg-info-subtle fw-semibold text-decoration-none py-2 px-3 mb-2 rounded-pill" href="https://getbootstrap.com/docs/5.3/components/card/" target="_blank" rel="noreferrer">
              Bootstrap docs
          ...
          <!-- Basic example -->
          <section id="card-basic" class="docs-section pb-sm-2 mb-5">
            <h4>Basic example</h4>
                ...
                <div class="tab-content">
                  ...
                  <div id="html-1" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#card-basic-code">
...
&lt;/div&gt;</code></pre>
          ...
          <section id="card-alt-style" class="docs-section pb-sm-2 mb-5">
              ...
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  ...
                  <div id="html-2" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#card-alt-style-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
...
&lt;/div&gt;</code></pre>
          ...
          <!-- Image caps -->
          <section id="card-image-caps" class="docs-section pb-sm-2 mb-5">
            <h4>Image caps</h4>
            <div class="card border-0 shadow">
              <span class="d-none d-block-dark position-absolute top-0 start-0 w-100 h-100 bg-dark rounded opacity-50"></span>
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  <div id="preview-3" class="tab-pane pt-4 pb-2 mt-3 fade show active" role="tabpanel">
                    <div class="d-flex flex-column flex-sm-row gap-4">
                      <div class="card" style="max-width: 350px">
                        <div class="ratio" style="--fn-aspect-ratio: calc(272 / 416 * 100%)">
                          <img src="assets/img/blog/v2/vlog/03.jpg" class="card-img-top" alt="Card image">
                        </div>
                        <div class="card-body">
                          <h5 class="card-title">Card title</h5>
                          <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                      ...
                      <div class="card" style="max-width: 350px">
                        ...
                        <div class="ratio" style="--fn-aspect-ratio: calc(272 / 416 * 100%)">
                          <img src="assets/img/blog/v2/vlog/01.jpg" class="card-img-bottom" alt="Card image">
                        </div>
                      </div>
                    </div>
                  </div>
                  <div id="html-3" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#card-image-caps-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
...
&lt;div class=&quot;card&quot;&gt;
  ...
  &lt;div class=&quot;ratio&quot; style=&quot;--fn-aspect-ratio: calc(305 / 416 * 100%)&quot;&gt;
    &lt;img src=&quot;assets/img/blog/v2/vlog/03.jpg&quot; class=&quot;card-img-top&quot; alt=&quot;Card image&quot;&gt;
  &lt;/div&gt;
  &lt;div class=&quot;card-body&quot;&gt;
    &lt;h5 class=&quot;card-title&quot;&gt;Card title&lt;/h5&gt;
...
&lt;/div&gt;</code></pre>
          ...
          <!-- Image hover effects -->
          <section id="card-image-hover" class="docs-section pb-sm-2 mb-5">
              ...
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                        ...
                        <div class="hover-effect-scale hover-effect-opacity card-img-top position-relative overflow-hidden">
                          ...
                          <div class="hover-effect-target d-flex position-absolute top-0 start-0 w-100 h-100 align-items-center justify-content-center z-2 opacity-0">
                            <div class="d-flex align-items-center gap-3 fs-sm bg-dark bg-opacity-50 text-white rounded-pill py-2 px-3">
                              ...
                              <span class="d-flex align-items-center fw-medium">
                                <i class="fi-message-square fs-base me-1"></i>
                                8
                              </span>
                            </div>
                          </div>
                          <div class="ratio hover-effect-target" style="--fn-aspect-ratio: calc(300 / 416 * 100%)">
                            <img src="assets/img/blog/v1/01.jpg" alt="Card image">
                          </div>
                        </div>
                        <div class="card-body">
                          <h5 class="card-title">Card title</h5>
                      ...
                      <div class="card" style="max-width: 350px">
                        <div class="position-relative hover-effect-opacity card-img-top overflow-hidden">
                          <div class="ratio" style="--fn-aspect-ratio: calc(300 / 416 * 100%)">
                            ...
                            <img src="assets/img/blog/v1/02.jpg" class="hover-effect-target position-absolute top-0 start-0 opacity-0" alt="Image hover">
                          </div>
                        </div>
                        <div class="card-body">
                          <h5 class="card-title">Card title</h5>
                  ...
                  <div id="html-4" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#card-image-hover-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
...
&lt;/div&gt;</code></pre>
          ...
          <!-- Horizontal layout -->
          <section id="card-horizontal" class="docs-section pb-sm-2 mb-5">
              ...
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  ...
                  <div id="html-5" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#card-horizontal-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
...
&lt;/div&gt;</code></pre>
          ...
          <!-- Header and footer -->
          <section id="card-header-footer" class="docs-section pb-sm-2 mb-5">
              ...
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  ...
                  <div id="html-6" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#card-header-footer-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
...
&lt;/div&gt;</code></pre>
          ...
          <!-- Text alignment -->
          <section id="card-text-alignment" class="docs-section pb-sm-2 mb-5">
              ...
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  ...
                  <div id="html-7" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#card-text-alignment-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
...
&lt;/div&gt;</code></pre>
          ...
          <!-- Navigation: Tabs -->
          <section id="card-nav-tabs" class="docs-section pb-sm-2 mb-5">
              ...
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  ...
                  <div id="html-8" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#card-nav-tabs-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
...
&lt;/div&gt;</code></pre>
          ...
          <!-- Navigation: Pills -->
          <section id="card-nav-pills" class="docs-section pb-sm-2 mb-5">
              ...
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  ...
                  <div id="html-9" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#card-nav-pills-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
...
&lt;/div&gt;</code></pre>
          ...
          <section id="card-list-group" class="docs-section pb-sm-2 mb-5">
              ...
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  ...
                  <div id="html-10" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#card-list-group-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
...
&lt;/div&gt;</code></pre>
          ...
          <section id="card-bg-solid" class="docs-section pb-sm-2 mb-5">
              ...
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  ...
                  <div id="html-11" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#card-bg-solid-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
...
&lt;/div&gt;</code></pre>
          ...
          <section id="card-bg-subtle" class="docs-section pb-sm-2 mb-5">
              ...
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  ...
                  <div id="html-12" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#card-bg-subtle-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
...
&lt;/div&gt;</code></pre>
          ...
          <section id="card-border-color" class="docs-section pb-sm-2 mb-5">
              ...
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  ...
                  <div id="html-13" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#card-border-color-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
...
&lt;/div&gt;</code></pre>
          ...
          <!-- Layout: Card group -->
          <section id="card-group" class="docs-section pb-sm-2 mb-5">
              ...
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  ...
                  <div id="html-14" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#card-group-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
...
&lt;/div&gt;</code></pre>
          ...
          <!-- Layout: Card grid -->
          <section id="card-grid" class="docs-section">
              ...
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  <div id="preview-15" class="tab-pane pt-4 pb-2 mt-3 fade show active" role="tabpanel">
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-4">
                      <div class="col">
                        <div class="card">
                          <div class="ratio" style="--fn-aspect-ratio: calc(300 / 416 * 100%)">
                            <img src="assets/img/blog/v1/01.jpg" class="card-img-top" alt="Image">
                          </div>
                          <div class="card-body">
                            <h5 class="card-title">Card title</h5>
                      ...
                      <div class="col">
                        <div class="card">
                          <div class="ratio" style="--fn-aspect-ratio: calc(300 / 416 * 100%)">
                            <img src="assets/img/blog/v1/02.jpg" class="card-img-top" alt="Image">
                          </div>
                          <div class="card-body">
                            <h5 class="card-title">Card title</h5>
                            <p class="card-text">Some quick example text to build on the card title.</p>
                      ...
                      <div class="col">
                        <div class="card">
                          <div class="ratio" style="--fn-aspect-ratio: calc(300 / 416 * 100%)">
                            <img src="assets/img/blog/v1/03.jpg" class="card-img-top" alt="Image">
                          </div>
                          <div class="card-body">
                            <h5 class="card-title">Card title</h5>
                            <p class="card-text">Some quick example text to build on the card title.</p>
                      ...
                      <div class="col">
                        <div class="card">
                          <div class="ratio" style="--fn-aspect-ratio: calc(300 / 416 * 100%)">
                            <img src="assets/img/blog/v1/05.jpg" class="card-img-top" alt="Image">
                          </div>
                          <div class="card-body">
                            <h5 class="card-title">Card title</h5>
                            <p class="card-text">Some quick example text to build on the card title.</p>
                      ...
                      <div class="col">
                        <div class="card">
                          <div class="ratio" style="--fn-aspect-ratio: calc(300 / 416 * 100%)">
                            <img src="assets/img/blog/v1/06.jpg" class="card-img-top" alt="Image">
                          </div>
                          <div class="card-body">
                            <h5 class="card-title">Card title</h5>
                            <p class="card-text">Some quick example text to build on the card title.</p>
                      ...
                      <div class="col">
                        <div class="card">
                          <div class="ratio" style="--fn-aspect-ratio: calc(300 / 416 * 100%)">
                            <img src="assets/img/blog/v1/07.jpg" class="card-img-top" alt="Image">
                          </div>
                          <div class="card-body">
                            <h5 class="card-title">Card title</h5>
                            <p class="card-text">Some quick example text to build on the card title.</p>
                  ...
                  <div id="html-15" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#card-grid-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>

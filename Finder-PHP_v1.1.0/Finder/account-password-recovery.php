    ...
    <div class="d-lg-flex">
      ...
      <div class="d-flex flex-column min-vh-100 w-100 py-4 mx-auto me-lg-5" style="max-width: 416px">
        ...
        <header class="navbar align-items-center px-0 pb-4 mt-n2 mt-sm-0 mb-2 mb-md-3 mb-lg-4">
          ...
          <div class="nav">
            <a class="nav-link fs-base animate-underline p-0" href="account-signin.php">
        ...
        <form class="needs-validation pb-4 mb-3 mb-lg-4" novalidate>
          <div class="position-relative mb-4">
            ...
            <input type="email" class="form-control form-control-lg form-icon-start" placeholder="Email address"
              required>

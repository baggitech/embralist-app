...
<html lang="en" data-bs-theme="light" data-pwa="true">
  <head>    
    <?php $title = "Account - Sign In"; include('partials/title-meta.php'); ?>
      ...
      <div class="d-lg-flex">
        ...
        <div class="d-flex flex-column min-vh-100 w-100 py-4 mx-auto me-lg-5" style="max-width: 416px">
          ...
          <footer class="mt-auto">
            ...
            <p class="fs-xs mb-0">
              &copy; All rights reserved. Made by <a class="hover-effect-underline text-dark-emphasis text-decoration-none" href="https://1.envato.market/coderthemes" target="_blank" rel="noreferrer">Coderthemes</a>
            </p>
          </footer>
        </div>

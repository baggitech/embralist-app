...
<head>
  <?php $title = "City Guide - Homepage"; include('partials/title-meta.php'); ?>
  ...
  <main class="content-wrapper">
    ...
    <section class="position-relative pt-5 pb-md-3 pb-lg-4 pb-xl-5 mt-n1 mt-sm-0">
      <div class="container position-relative z-2 pt-md-4 pt-lg-5 pb-xxl-3">
        <div class="pt-sm-2 mx-auto" style="max-width: 820px">
          <h1 class="display-4 text-center mb-sm-4">Start exploring Barcelona</h1>
          <p class="fs-lg text-center pb-3 pb-sm-0 pb-lg-2 pb-xl-3 mb-4 mb-sm-5 mx-auto" style="max-width: 546px">Find
            great places to stay, eat, shop, or visit from our respected partners and local experts.</p>
              ...
              <article class="hover-effect-scale position-relative flex-shrink-0 text-center px-3">
                ...
                <h3 class="h6 fw-normal pt-3 pt-sm-4 mb-0">
                  <a class="hover-effect-underline stretched-link"
                    href="listings-top-filters-city-guide.php">Accommodation</a>
                </h3>
              </article>
              <article class="hover-effect-scale position-relative flex-shrink-0 text-center px-3">
                ...
                <h3 class="h6 fw-normal pt-3 pt-sm-4 mb-0">
                  <a class="hover-effect-underline stretched-link"
                    href="listings-side-filters-city-guide.php">Shopping</a>
                </h3>
              </article>
              <article class="hover-effect-scale position-relative flex-shrink-0 text-center px-3">
                ...
                <h3 class="h6 fw-normal pt-3 pt-sm-4 mb-0">
                  <a class="hover-effect-underline stretched-link" href="listings-side-filters-city-guide.php">Food
                    &amp; Drink</a>
                </h3>
              </article>
              <article class="hover-effect-scale position-relative flex-shrink-0 text-center px-3">
                ...
                <h3 class="h6 fw-normal pt-3 pt-sm-4 mb-0">
                  <a class="hover-effect-underline stretched-link"
                    href="listings-side-filters-city-guide.php">Entertainment</a>
                </h3>
              </article>
              <article class="hover-effect-scale position-relative flex-shrink-0 text-center px-3">
                ...
                <h3 class="h6 fw-normal pt-3 pt-sm-4 mb-0">
                  <a class="hover-effect-underline stretched-link"
                    href="listings-side-filters-city-guide.php">Health</a>
                </h3>
              </article>
            </div>
          </div>
        ...
        <div class="d-flex align-items-start justify-content-between gap-4 pb-3 mb-2 mb-sm-3 mb-lg-4">
          ...
          <div class="nav">
            <a class="nav-link position-relative fs-base text-nowrap py-1 px-0"
              href="listings-top-filters-city-guide.php">
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <article class="card hover-effect-scale hover-effect-opacity bg-transparent border-0">
                ...
                <div class="card-body pt-3 pb-2 px-0">
                  <h3 class="h5 mb-0">
                    <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.php">Pine
                      Cottage</a>
                  </h3>
                </div>
            ...
            <div class="swiper-slide">
              <article class="card hover-effect-scale hover-effect-opacity bg-transparent border-0">
                ...
                <div class="card-body pt-3 pb-2 px-0">
                  <h3 class="h5 mb-0">
                    <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.php">Big Tree
                      Cottage</a>
                  </h3>
                </div>
                <div class="card-footer d-flex align-items-center gap-3 bg-transparent border-0 p-0">
            ...
            <div class="swiper-slide">
              <article class="card hover-effect-scale hover-effect-opacity bg-transparent border-0">
                ...
                <div class="card-body pt-3 pb-2 px-0">
                  <h3 class="h5 mb-0">
                    <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.php">Crystal Studio
                      Apartment</a>
                  </h3>
                </div>
                <div class="card-footer d-flex align-items-center gap-3 bg-transparent border-0 p-0">
        ...
        <div class="col-md-5 mb-4 mb-md-0 pb-1 pb-md-0">
          <div class="position-relative">
            ...
            <div class="swiper position-absolute top-0 start-0 w-100 h-100" id="images" data-swiper='{
              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <img src="assets/img/home/city-guide/new/01.jpg"
                    class="position-absolute top-0 start-0 w-100 h-100 bg-body-tertiary rounded object-fit-cover"
                    alt="Image">
                </div>
                <div class="swiper-slide">
                  <img src="assets/img/home/city-guide/new/02.jpg"
                    class="position-absolute top-0 start-0 w-100 h-100 bg-body-tertiary rounded object-fit-cover"
                    alt="Image">
                </div>
                <div class="swiper-slide">
                  <img src="assets/img/home/city-guide/new/03.jpg"
                    class="position-absolute top-0 start-0 w-100 h-100 bg-body-tertiary rounded object-fit-cover"
                    alt="Image">
                </div>
              </div>
            ...
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                ...
                <p class="pb-2 pb-xl-3">Experience authentic Mediterranean flavors at Jardinet D'Aribau, a charming
                  restaurant in the heart of Barcelona. With a focus on quality and creativity, Jardinet D'Aribau offers
                  a diverse menu that blends traditional Mediterranean cuisine with modern culinary techniques. Perfect
                  for a memorable dining experience!</p>
                <a class="btn btn-lg btn-primary rounded-pill d-none d-sm-inline-flex"
                  href="single-entry-city-guide.php">
                  View more
                  <i class="fi-chevron-right fs-xl ms-1 me-n1"></i>
                </a>
                <a class="btn btn-primary rounded-pill d-sm-none" href="single-entry-city-guide.php">
                  View more
              ...
              <div class="swiper-slide">
                ...
                <p class="pb-2 pb-xl-3">Enter a world of aquatic discovery at one of the biggest aquariums in Europe,
                  featuring a five-million-liter main tank and thousands of sea creatures from all over the world.
                  Marvel at the mesmerizing dance of stingrays, the graceful glide of sea turtles, and the vibrant
                  colors of tropical fish.</p>
                <a class="btn btn-lg btn-primary rounded-pill d-none d-sm-inline-flex"
                  href="single-entry-city-guide.php">
                  View more
                  <i class="fi-chevron-right fs-xl ms-1 me-n1"></i>
              ...
              <div class="swiper-slide">
                ...
                <p class="pb-2 pb-xl-3">VRFun on International Drive is an immersive virtual reality park offering
                  cutting-edge VR experiences for all ages. Guests can engage in thrilling multiplayer games, virtual
                  roller coasters, and interactive adventures in a high-tech environment, making it a top attraction for
                  futuristic fun and family entertainment.</p>
                <a class="btn btn-lg btn-primary rounded-pill d-none d-sm-inline-flex"
                  href="single-entry-city-guide.php">
                  View more
                  <i class="fi-chevron-right fs-xl ms-1 me-n1"></i>
    ...
    <section class="container pt-2 pt-sm-3 pt-md-4 pt-lg-5 pb-5 my-xxl-3">
      <div class="d-flex align-items-start justify-content-between gap-4 pb-3 mb-2 mb-sm-3 mb-lg-4">
        ...
        <div class="nav">
          <a class="nav-link position-relative fs-base text-nowrap py-1 px-0"
            href="listings-side-filters-city-guide.php">
            <span class="hover-effect-underline stretched-link me-1">View all</span>
            <i class="fi-chevron-right fs-lg"></i>
          </a>
        </div>
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 g-4 mb-sm-n1">
        ...
        <div class="col d-flex flex-column mb-sm-1">
          <article class="hover-effect-scale position-relative d-inline-flex align-items-start">
            ...
            <div class="min-w-0 pt-1 ps-3">
              <h3 class="h6 mb-1">
                <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.php">Mado</a>
              </h3>
        ...
        <div class="col d-flex flex-column mb-sm-1">
          <article class="hover-effect-scale position-relative d-inline-flex align-items-start">
            ...
            <div class="min-w-0 pt-1 ps-3">
              <h3 class="h6 mb-1">
                <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.php">Hard Rock Cafe</a>
              </h3>
              <div class="d-flex align-items-center gap-1 mb-2">
                <i class="fi-star-filled text-warning"></i>
        ...
        <div class="col d-flex flex-column mb-sm-1">
          <article class="hover-effect-scale position-relative d-inline-flex align-items-start">
            ...
            <div class="min-w-0 pt-1 ps-3">
              <h3 class="h6 mb-1">
                <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.php">Sbarro</a>
              </h3>
              <div class="d-flex align-items-center gap-1 mb-2">
                <i class="fi-star-filled text-warning"></i>
        ...
        <div class="col d-flex flex-column mb-sm-1">
          <article class="hover-effect-scale position-relative d-inline-flex align-items-start">
            ...
            <div class="min-w-0 pt-1 ps-3">
              <h3 class="h6 mb-1">
                <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.php">McDonald's</a>
              </h3>
              <div class="d-flex align-items-center gap-1 mb-2">
                <i class="fi-star-filled text-warning"></i>
                <span class="fs-sm text-secondary-emphasis">4.9</span>
        ...
        <div class="col d-flex flex-column mb-sm-1">
          <article class="hover-effect-scale position-relative d-inline-flex align-items-start">
            ...
            <div class="min-w-0 pt-1 ps-3">
              <h3 class="h6 mb-1">
                <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.php">Taco Bell</a>
              </h3>
              <div class="d-flex align-items-center gap-1 mb-2">
                <i class="fi-star-filled text-warning"></i>
        ...
        <div class="col d-flex flex-column mb-sm-1">
          <article class="hover-effect-scale position-relative d-inline-flex align-items-start">
            ...
            <div class="min-w-0 pt-1 ps-3">
              <h3 class="h6 mb-1">
                <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.php">El Pollo Loco</a>
              </h3>
              <div class="d-flex align-items-center gap-1 mb-2">
                <i class="fi-star-filled text-warning"></i>
        ...
        <div class="col d-flex flex-column mb-sm-1">
          <article class="hover-effect-scale position-relative d-inline-flex align-items-start">
            ...
            <div class="min-w-0 pt-1 ps-3">
              <h3 class="h6 mb-1">
                <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.php">Jack Restaurant</a>
              </h3>
              <div class="d-flex align-items-center gap-1 mb-2">
                <i class="fi-star-filled text-warning"></i>
                <span class="fs-sm text-secondary-emphasis">4.9</span>
        ...
        <div class="col d-flex flex-column mb-sm-1">
          <article class="hover-effect-scale position-relative d-inline-flex align-items-start">
            ...
            <div class="min-w-0 pt-1 ps-3">
              <h3 class="h6 mb-1">
                <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.php">TacoTime</a>
              </h3>
              <div class="d-flex align-items-center gap-1 mb-2">
                <i class="fi-star-filled text-warning"></i>
        ...
        <div class="col d-flex flex-column mb-sm-1">
          <article class="hover-effect-scale position-relative d-inline-flex align-items-start">
            ...
            <div class="min-w-0 pt-1 ps-3">
              <h3 class="h6 mb-1">
                <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.php">Domino's Pizza</a>
              </h3>
              <div class="d-flex align-items-center gap-1 mb-2">
                <i class="fi-star-filled text-warning"></i>
                <span class="fs-sm text-secondary-emphasis">4.5</span>
                  ...
                  <div class="vstack gap-4">
                    ...
                    <article class="hover-effect-scale position-relative d-inline-flex align-items-start mt-1 mt-sm-2">
                      <div class="flex-shrink-0 rounded overflow-hidden p-3 px-md-4">
                        <div class="ratio hover-effect-target z-1"
                          ...
                          <img src="assets/img/home/city-guide/restaurants/03-light.png" class="d-none-dark"
                            alt="Image">
                          <img src="assets/img/home/city-guide/restaurants/03-dark.png" class="d-none d-block-dark"
                            alt="Image">
                        </div>
                      ...
                      <div class="min-w-0 pt-1 ps-3">
                        <h3 class="h6 mb-1">
                          <a class="hover-effect-underline stretched-link"
                            href="single-entry-city-guide.php">Sbarro</a>
                        </h3>
                        <div class="d-flex align-items-center gap-1 mb-2">
                          <i class="fi-star-filled text-warning"></i>
                          <span class="fs-sm text-secondary-emphasis">4.8</span>
                    ...
                    <article class="hover-effect-scale position-relative d-inline-flex align-items-start mt-1 mt-sm-2">
                      ...
                      <div class="min-w-0 pt-1 ps-3">
                        <h3 class="h6 mb-1">
                          <a class="hover-effect-underline stretched-link"
                            href="single-entry-city-guide.php">TacoTime</a>
                        </h3>
                        <div class="d-flex align-items-center gap-1 mb-2">
                          <i class="fi-star-filled text-warning"></i>
                          <span class="fs-sm text-secondary-emphasis">4.6</span>
            ...
            <div class="col-md-6 col-lg-7 col-xl-8">
              <div class="position-relative bg-body-tertiary rounded overflow-hidden p-4">
                <div class="p-xl-2">
                  ...
                  <div class="vstack gap-4">
                    ...
                    <article class="hover-effect-scale position-relative d-inline-flex align-items-start mt-1 mt-sm-2">
                      ...
                      <div class="min-w-0 pt-1 ps-3">
                        <h3 class="h6 mb-1">
                          <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.php">Sagrada
                            Familia</a>
                        </h3>
                        <div class="d-flex align-items-center gap-1 mb-2">
                          <i class="fi-star-filled text-warning"></i>
                    ...
                    <article class="hover-effect-scale position-relative d-inline-flex align-items-start mt-1 mt-sm-2">
                      ...
                      <div class="min-w-0 pt-1 ps-3">
                        <h3 class="h6 mb-1">
                          <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.php">Park
                            Güell</a>
                        </h3>
                        <div class="d-flex align-items-center gap-1 mb-2">
                          <i class="fi-star-filled text-warning"></i>
                    ...
                    <article class="hover-effect-scale position-relative d-inline-flex align-items-start mt-1 mt-sm-2">
                      ...
                      <div class="min-w-0 pt-1 ps-3">
                        <h3 class="h6 mb-1">
                          <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.php">Camp Nou
                            Tour</a>
                        </h3>
                        <div class="d-flex align-items-center gap-1 mb-2">
                          <i class="fi-star-filled text-warning"></i>
                ...
                <div class="position-absolute end-0 bottom-0 z-1 d-none d-lg-block ps-5 ps-xl-0 me-n5 me-xl-n4 me-xxl-3"
                  ...
                  <img src="assets/img/home/city-guide/places/photographer.png"
                    class="position-relative z-1 ps-5 ps-xl-0 ms-3 ms-xl-0" width="388" alt="Photographer">
                </div>
              </div>
            </div>
          </div>
              ...
              <article class="card h-100 hover-effect-scale hover-effect-opacity bg-transparent">
                ...
                <div class="card-body pt-3 pb-2 px-3">
                  ...
                  <h3 class="h5 pt-1 mb-2">
                    <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.php">Barcelona
                      National Zoo</a>
                  </h3>
                  <p class="fs-sm mb-0">Discover fascinating animals and a fun-filled adventure for the whole family.
                  </p>
                </div>
              ...
              <article class="card h-100 hover-effect-scale hover-effect-opacity bg-transparent">
                ...
                <div class="card-body pt-3 pb-2 px-3">
                  <span
                    class="badge text-body-emphasis bg-secondary-subtle text-decoration-none mb-2">Entertainment</span>
                  <h3 class="h5 pt-1 mb-2">
                    <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.php">Mountain Lake
                      Tour</a>
                  </h3>
                  <p class="fs-sm mb-0">Enjoy breathtaking views, fresh air, and a peaceful escape into the wilderness.
                  </p>
                </div>
                <div class="card-footer bg-transparent border-0 pt-0 pb-3 px-3">
                  <div class="d-flex align-items-center gap-3">
              ...
              <article class="card h-100 hover-effect-scale hover-effect-opacity bg-transparent">
                ...
                <div class="card-body pt-3 pb-2 px-3">
                  <span
                    class="badge text-body-emphasis bg-secondary-subtle text-decoration-none mb-2">Entertainment</span>
                  <h3 class="h5 pt-1 mb-2">
                    <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.php">Jeep Tour with
                      4x4 Club</a>
                  </h3>
              ...
              <article class="card h-100 hover-effect-scale hover-effect-opacity bg-transparent">
                ...
                <div class="card-body pt-3 pb-2 px-3">
                  <span
                    class="badge text-body-emphasis bg-secondary-subtle text-decoration-none mb-2">Entertainment</span>
                  <h3 class="h5 pt-1 mb-2">
                    <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.php">Art &amp;
                      Design Museum</a>
                  </h3>
    ...
    <div class="container pt-sm-2 pt-md-3 pt-lg-4">
      <div class="accordion row pb-5 mb-sm-2 mb-md-3 mb-lg-4" id="footerLinks">
        ...
        <div class="col-sm-5 col-md-4 col-lg-3">
          <a class="d-inline-flex align-items-center text-dark-emphasis text-decoration-none mb-4" href="index.php">

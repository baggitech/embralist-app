...
<html lang="en" data-bs-theme="light" data-pwa="true">
  <head>
    ...
    <title>Finder Docs | Global options</title>
    ...
    <div class="container pt-4">
      <div class="row pt-sm-2">
        ...
        <main class="col-lg-9 pt-1 pb-5 mb-sm-2 mb-md-3">
          ...
          <!-- Page content -->
          <section class="mb-3">
            <p>The Bootstrap framework provides a variety of customizable global options through the <code>_variables.scss</code> file. These settings allow you to quickly modify the overall styling by enabling or disabling specific features according to your project needs.</p>
            ...
            <div class="position-relative mb-5" style="max-width: 720px" data-bs-theme="dark">
              <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 me-2 px-2 z-3" data-copy-code="#bs-options-code">
...
$color-mode-type:             data !default; // `data` or `media-query`</code></pre>
            ...
            <p>To customize these settings to your needs, override the default values by copying them into your project's <code>src/scss/_user-variables.scss</code> file and modifying the values accordingly. This approach ensures that your custom configurations are applied throughout the framework.</p>
            <h3 class="h4 pt-3">Example of customizing variables</h3>
            <p class="mb-4">Suppose you want to disable rounded corners and shadows, but enable CSS grid support. You would copy the relevant variables into <code>src/scss/_user-variables.scss</code> and adjust them as follows:</p>
            <div class="position-relative mb-4" style="max-width: 720px" data-bs-theme="dark">
              <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 me-2 px-2 z-3" data-copy-code="#override-options-code">
                <i class="fi-copy fs-sm me-1"></i>
                Copy
              </button>
...
$enable-cssgrid: true;</code></pre>
            ...
            <p class="mb-0">Bootstrap also supports different color modes. By default, the <code>$color-mode-type</code> is set to <code>data</code>, which means the color mode can be toggled via <code>data-bs-theme</code> attributes in HTML. Alternatively, if set to <code>media-query</code>, the color mode will respond to the user's system preferences.</p>
          </section>
        </main>
      </div>
    </div>

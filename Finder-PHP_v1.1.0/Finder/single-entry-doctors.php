...
<head>
  <?php $title = "Doctors - Doctor Details Page"; include('partials/title-meta.php'); ?>
...
<body class="bg-body-tertiary">
    ...
    <div class="container pt-4 pb-5 mb-xxl-3">
      ...
      <nav class="pb-2" aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="listings-list-doctors.php">Physicians</a></li>
          <li class="breadcrumb-item active" aria-current="page">Dr. Michael Johnston</li>
        </ol>
      </nav>
        ...
        <div class="col-lg-8">
          ...
          <div class="position-relative p-4 mb-4">
            <div class="position-relative z-1 p-xl-2">
                ...
                <div class="vstack ps-sm-4 ps-xl-5 ms-md-2 ms-xl-0">
                  <div class="d-flex align-items-start justify-content-between gap-3 pb-1 ms-3 ms-sm-0 mb-2">
                    ...
                    <div class="d-flex align-items-center position-relative gap-1 mt-1">
                      ...
                      <a class="fs-sm text-secondary-emphasis hover-effect-underline stretched-link text-decoration-none"
                        href="#reviews">4.5</a>
                  ...
                  <figure class="pt-4 mt-auto ms-n5 ms-sm-0 mb-0">
                    <blockquote class="blockquote fs-base fw-medium">
                      <p>Dr. Johnston is a very knowledgeable cardiologist. He provided excellent care, improving my
                        heart health. I'm very grateful!</p>
                    </blockquote>
              ...
              <p class="fs-sm mb-0">Dr. Michael Johnston, a highly experienced cardiologist with over two decades in the
                field, provides comprehensive and advanced cardiovascular care. Known for his expertise in diagnosing
                and treating a wide range of heart conditions, Dr. Johnston combines cutting-edge medical techniques
                with personalized treatment plans to ensure the best possible outcomes for his patients. Whether it's
                managing chronic heart disease, performing complex procedures, or offering preventative care, Dr.
                Johnston's meticulous diagnostic analysis and patient-centered approach make him a trusted leader in
                cardiovascular health. Rely on his expertise to safeguard your heart health and improve your quality of
                life.</p>
              ...
              <ul class="list-unstyled fs-sm">
                ...
                <li>
                  <span class="fw-medium text-body-emphasis">Johns Hopkins University</span> - Residency in
            ...
            <div class="position-relative z-1 p-xl-2">
                ...
                <div class="col-sm-7 col-md-9 col-lg-8">
                  <div class="vstack gap-3">
                    <div class="hstack gap-2">
                      ...
                      <div class="progress w-100" role="progressbar" aria-label="Five stars" aria-valuenow="65"
                    ...
                    <div class="hstack gap-2">
                      ...
                      <div class="progress w-100" role="progressbar" aria-label="Four stars" aria-valuenow="21"
                        aria-valuemin="0" aria-valuemax="100" style="height: 4px">
                    ...
                    <div class="hstack gap-2">
                      ...
                      <div class="progress w-100" role="progressbar" aria-label="Three stars" aria-valuenow="10"
                        aria-valuemin="0" aria-valuemax="100" style="height: 4px">
              ...
              <div class="vstack gap-4">
                ...
                <div class="vstack gap-2 mb-sm-2">
                  ...
                  <p class="fs-sm mb-1">Dr. Michael Johnston is truly a life-saver. His expertise and attention to
                    detail are unmatched. He took the time to explain everything clearly and made sure I felt
                    comfortable every step of the way. Thanks to him, my heart health is now better than ever. I highly
                    recommend him!</p>
                ...
                <div class="vstack gap-2 mb-sm-2">
                  ...
                  <p class="fs-sm mb-1">From the first consultation, Dr. Johnston showed exceptional care and
                    professionalism. His thorough approach to diagnosing my heart condition was impressive, and his
                    treatment plan has worked wonders. I feel fortunate to have found such a knowledgeable and
                    compassionate cardiologist.</p>
                  <div class="nav align-items-center">
                    <button type="button" class="nav-link text-body-secondary animate-scale px-0 me-n1">
                      <i class="fi-thumbs-up fs-base animate-target me-1"></i>
                      13
                ...
                <div class="vstack gap-2 mb-sm-2">
                  ...
                  <p class="fs-sm mb-1">Dr. Johnston was incredibly attentive and reassuring during a very stressful
                    time for me. He made complex medical concepts easy to understand and guided me through the entire
                    process. His expertise gave me confidence, and my heart is now in great shape. Five stars for sure!
                  </p>
                  <div class="nav align-items-center">
                    <button type="button" class="nav-link text-body-secondary animate-scale px-0 me-n1">
                      <i class="fi-thumbs-up fs-base animate-target me-1"></i>
                ...
                <div class="vstack gap-2 mb-sm-2">
                  ...
                  <p class="fs-sm mb-1">I can't say enough good things about Dr. Johnston. His calm demeanor, vast
                    knowledge, and caring nature set him apart. He listens carefully to all concerns and tailors
                    treatments to each patient's needs. I'm grateful for the care I've received and highly recommend him
                    to anyone seeking a top-notch cardiologist.</p>
                  <div class="nav align-items-center">
                    <button type="button" class="nav-link text-body-secondary animate-scale px-0 me-n1">
                      <i class="fi-thumbs-up fs-base animate-target me-1"></i>
                      27
                ...
                <div class="vstack gap-2 mb-sm-2">
                  ...
                  <p class="fs-sm mb-1">Dr. Johnston is an excellent cardiologist and clearly knows his field well. My
                    treatment has been effective, and I feel much healthier. The only reason for 4 stars is that the
                    wait time for my appointment was longer than expected, but once I saw him, the care was outstanding.
                  </p>
                  <div class="nav align-items-center">
                    <button type="button" class="nav-link text-body-secondary animate-scale px-0 me-n1">
                      <i class="fi-thumbs-up fs-base animate-target me-1"></i>
        ...
        <div class="col-lg-4" style="margin-top: -100px">
          <div class="offcanvas-lg offcanvas-end sticky-lg-top" id="bookAppointment">
            ...
            <div class="offcanvas-header pt-3">
              ...
              <button type="button" class="btn-close" data-bs-dismiss="offcanvas" data-bs-target="#bookAppointment"
      ...
      <div class="d-flex align-items-start justify-content-between gap-4 pt-5 pb-3 mt-xxl-3 mb-2 mb-sm-3">
        ...
        <div class="nav">
          <a class="nav-link position-relative text-nowrap py-1 px-0" href="listings-grid-doctors.php">
        ...
        <div class="swiper-wrapper">
            ...
            <article class="card h-100 hover-effect-scale z-1 border-0">
              <div class="card-img-top bg-body-tertiary overflow-hidden">
                <div class="ratio hover-effect-target" style="--fn-aspect-ratio: calc(200 / 306 * 100%)">
                  <img src="assets/img/listings/doctors/18.jpg" alt="Image">
                </div>
              </div>
              <div class="card-body">
              ...
              <span
                class="position-absolute top-0 start-0 w-100 h-100 z-n1 bg-body-tertiary rounded d-none d-block-dark"></span>
            </article>
          </div>
          ...
          <div class="swiper-slide h-auto">
            <article class="card h-100 hover-effect-scale z-1 border-0">
              <div class="card-img-top bg-body-tertiary overflow-hidden">
                <div class="ratio hover-effect-target" style="--fn-aspect-ratio: calc(200 / 306 * 100%)">
                  <img src="assets/img/listings/doctors/19.jpg" alt="Image">
                </div>
              </div>
              <div class="card-body">
                <div class="d-flex align-items-center gap-1 mb-2">
          ...
          <div class="swiper-slide h-auto">
            <article class="card h-100 hover-effect-scale z-1 border-0">
              <div class="card-img-top bg-body-tertiary overflow-hidden">
                <div class="ratio hover-effect-target" style="--fn-aspect-ratio: calc(200 / 306 * 100%)">
                  <img src="assets/img/listings/doctors/21.jpg" alt="Image">
                </div>
              </div>
              <div class="card-body">
                <div class="d-flex align-items-center gap-1 mb-2">
  ...
  <!-- Sidebar with appointemnt booking form offcanvas toggle that is visible on screens < 992px wide (lg breakpoint) -->
  <button type="button"
    ...
    data-bs-toggle="offcanvas" data-bs-target="#bookAppointment" aria-controls="bookAppointment" data-bs-theme="light">
    <i class="fi-clock fs-base me-2"></i>
    Book appointment
  </button>

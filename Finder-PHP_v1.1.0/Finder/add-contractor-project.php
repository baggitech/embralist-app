...
<head>
  <?php $title = "Add Contractor - Create First Project"; include('partials/title-meta.php'); ?>
        ...
        <div class="overflow-x-auto">
          <div class="d-flex flex-nowrap align-items-center gap-1 pb-3 mb-md-1">
            ...
            <div class="d-flex align-items-center gap-2 gap-sm-3 text-nowrap">
              <div class="d-flex align-items-center justify-content-center bg-white rounded-circle flex-shrink-0"
                style="width: 44px; height: 44px">
                <i class="fi-grid fs-lg text-info"></i>
              </div>
      ...
      <div class="row pt-md-1 pt-lg-2 pt-xl-3 pb-2 pb-sm-3 pb-md-4 pb-lg-5">
        ...
        <div class="col-lg-7">
          ...
          <div class="mb-3 mb-md-4">
            ...
            <input type="text" class="form-control form-control-lg" id="project-name" required>
          </div>
          <div class="mb-3 mb-md-4">
            ...
            <textarea class="form-control form-control-lg" rows="6" id="project-description"
              placeholder="Tell potential customers about project" required></textarea>
          </div>
          <label for="price" class="form-label">Approximate price *</label>
          ...
          <div class="pt-3 mt-3">
            ...
            <p class="fs-sm mb-0">The maximum photo size is 8 MB. Formats: jpeg, jpg, png. Put the main picture first.
            </p>
            ...
            <div class="border rounded p-3">
              <div class="row row-cols-2 row-cols-sm-3 g-2">
                ...
                <div class="col">
                  <div class="hover-effect-opacity position-relative overflow-hidden rounded">
                    ...
                    <div class="ratio" style="--fn-aspect-ratio: calc(180 / 268 * 100%)">
                      <img src="assets/img/add-item/contractor/01.jpg" alt="Image">
                    </div>
                    <div
                ...
                <div class="col">
                  <div class="hover-effect-opacity position-relative overflow-hidden rounded">
                    <div class="ratio" style="--fn-aspect-ratio: calc(180 / 268 * 100%)">
                      <img src="assets/img/add-item/contractor/02.jpg" alt="Image">
                    </div>
                    <div
                      class="hover-effect-target position-absolute top-0 start-0 d-flex align-items-center justify-content-center w-100 h-100 opacity-0">
                      <button type="button" class="btn btn-icon btn-sm btn-light position-relative z-2"
                ...
                <div class="col">
                  <div class="hover-effect-opacity position-relative overflow-hidden rounded">
                    <div class="ratio" style="--fn-aspect-ratio: calc(180 / 268 * 100%)">
                      <img src="assets/img/add-item/contractor/03.jpg" alt="Image">
                    </div>
                    <div
                      class="hover-effect-target position-absolute top-0 start-0 d-flex align-items-center justify-content-center w-100 h-100 opacity-0">
                      <button type="button" class="btn btn-icon btn-sm btn-light position-relative z-2"
                ...
                <div class="col">
                  <div class="hover-effect-opacity position-relative overflow-hidden rounded">
                    <div class="ratio" style="--fn-aspect-ratio: calc(180 / 268 * 100%)">
                      <img src="assets/img/add-item/contractor/04.jpg" alt="Image">
                    </div>
                    <div
                      class="hover-effect-target position-absolute top-0 start-0 d-flex align-items-center justify-content-center w-100 h-100 opacity-0">
                      <button type="button" class="btn btn-icon btn-sm btn-light position-relative z-2"
            ...
            <div class="pt-4">
              <label for="link" class="form-label">Link to the video</label>
              <div class="position-relative">
          ...
          <div class="d-flex flex-column flex-sm-row align-items-sm-center gap-3 pt-5">
            ...
            <div class="nav">
              <a class="nav-link hover-effect-underline fs-base" href="#!">Add project later</a>
            </div>
          </div>
        </div>

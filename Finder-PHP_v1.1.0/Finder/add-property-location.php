...
<head>
  <?php $title = "Add Property - Location"; include('partials/title-meta.php'); ?>
...
<body>
  ...
  <footer class="sticky-bottom bg-body pb-3">
    <div class="progress rounded-0" role="progressbar" aria-label="Dark example" aria-valuenow="28.57" aria-valuemin="0"
    ...
    <div class="container d-flex gap-3 pt-3">
      <a class="btn btn-outline-dark animate-slide-start" href="add-property-type.php">
        <i class="fi-arrow-left animate-target fs-base ms-n1 me-2"></i>
        Back
      </a>
      <a class="btn btn-dark animate-slide-end ms-auto" href="add-property-photos.php">
        Next

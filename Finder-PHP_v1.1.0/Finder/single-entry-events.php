...
<head>
  <?php $title = "Events - Event Details Page"; include('partials/title-meta.php'); ?>
...
<body>
  ...
  <header class="navbar navbar-expand-lg bg-body navbar-sticky sticky-top z-fixed px-0" data-sticky-element>
    <div class="container">
      ...
      <!-- Navbar brand (Logo) -->
      <a class="navbar-brand py-1 py-md-2 py-xl-1 me-2 me-sm-n4 me-md-n5 me-lg-0" href="home-events.php">
  ...
  <main class="content-wrapper">
    ...
    <nav class="container pt-4 pb-2 pb-md-3" aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="home-events.php">Home</a></li>
        <li class="breadcrumb-item"><a href="listings-events.php">Concerts</a></li>
        <li class="breadcrumb-item active" aria-current="page">Summer Jazz Festival 2024</li>
      </ol>
    </nav>
    ...
    <section class="container pb-3 pb-md-4 pb-lg-5 mb-xxl-3">
      <div class="row pb-5">
        ...
        <div class="col-sm-9 col-md-5 col-lg-4 pb-3 pb-sm-0 mb-4 mb-sm-5 mb-md-0">
          <div class="ratio bg-body-tertiary rounded overflow-hidden" style="--fn-aspect-ratio: calc(500 / 416 * 100%)">
            <img src="assets/img/listings/events/single/main.png" alt="Image">
          </div>
          <div class="vstack gap-1 pt-3 mt-2 mt-sm-3">
            <div class="fs-xs">120 tickets available</div>
            <div class="h4 text-info mb-0">$49.00 - $199.00</div>
            <div class="d-flex gap-3 pt-2 mt-1">
              <button type="button" class="btn btn-lg btn-primary w-100">Buy ticket now</button>
              <div class="dropdown">
                <button type="button" class="btn btn-icon btn-lg btn-outline-secondary animate-scale"
                  data-bs-toggle="dropdown" aria-label="Share">
                  <i class="fi-share-2 fs-lg animate-target"></i>
                </button>
              ...
              <button type="button" class="btn btn-icon btn-lg btn-outline-secondary animate-pulse"
                aria-label="Add to Wishlist">
                <i class="fi-heart fs-lg animate-target"></i>
              </button>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-7 offset-lg-1">
          <div class="ps-md-4 ps-lg-0">
            ...
            <h1 class="display-6 mb-4">Summer Jazz Festival 2024</h1>
            <ul class="list-unstyled gap-3 fs-sm pb-3 pb-sm-0 mb-4 mb-sm-5">
              <li class="d-flex">
              ...
              <li class="d-flex flex-wrap gap-2">
                ...
                <div class="nav">
                  <a class="nav-link position-relative text-nowrap p-0"
                    href="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3205.7842597857743!2d-87.64681469579065!3d41.883363520780215!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x880e2cc7a05140b3%3A0x2cbb7ee901071961!2s640%20W%20Washington%20St%2C%20Chicago%2C%20IL%2060606%2C%20USA!5e0!3m2!1sen!2suk!4v1726150605227!5m2!1sen!2suk"
                    data-glightbox="width: 100vw; height: 100vh;" data-gallery="map">
                    <i class="fi-map fs-base me-2"></i>
                    <span class="hover-effect-underline stretched-link">Show on the map</span>
                  </a>
                </div>
              </li>
            </ul>
            ...
            <!-- Organizer -->
            <div
              class="d-flex flex-column flex-sm-row flex-md-column flex-lg-row align-items-center justify-content-between gap-3 bg-body-tertiary rounded p-4">
              <div class="d-flex align-items-center gap-2">
                <svg class="text-info flex-shrink-0" xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                  fill="currentColor">
                  <path
                    d="M16 22.4a6.4 6.4 0 0 1 0-12.8 6.4 6.4 0 1 1 0 12.8zM3.653 18.586c-1.834.317-3.092 2.057-2.388 3.75a15.56 15.56 0 0 0 4.585 6.115c2.908 2.353 6.575 3.61 10.343 3.546s7.388-1.447 10.21-3.898a15.53 15.53 0 0 0 4.365-6.268c.644-1.716-.675-3.412-2.52-3.666s-3.501 1.064-4.412 2.659a8.94 8.94 0 0 1-1.903 2.316c-1.619 1.406-3.697 2.2-5.858 2.236s-4.266-.684-5.934-2.034a8.96 8.96 0 0 1-1.984-2.249c-.967-1.563-2.669-2.824-4.504-2.506zm28.223-.994A15.37 15.37 0 0 0 32 15.638C32 7.001 24.837 0 16 0S0 7.001 0 15.638a15.4 15.4 0 0 0 .203 2.495 5.01 5.01 0 0 1 3.121-1.899c1.34-.231 2.559.087 3.589.681-.061-.417-.092-.844-.092-1.277 0-4.955 4.11-8.972 9.18-8.972s9.18 4.017 9.18 8.972a8.83 8.83 0 0 1-.053.967c1.008-.629 2.215-.988 3.563-.803a5.02 5.02 0 0 1 3.186 1.79z" />
                </svg>
                <div class="d-flex align-items-center gap-1 ps-1">
                  <div class="h6 mb-0">By Monte Fest</div>
                  <i class="fi-bullet"></i>
                  <div class="fs-xs">1265 Followers</div>
                </div>
              </div>
            ...
            <!-- Description -->
            <h2 class="h5 pt-3 pt-sm-0 mt-4 mt-sm-5">Event Description</h2>
            <p class="fs-sm">Summer Jaz Festival will immerse the audience in an unrivaled atmosphere, performing the
              best hits of legendary artists: Frank Sinatra, Tony Bennett, Nat King Cole, Louis Armstrong and many
              others.</p>
            <p class="fs-sm">The vocalist of the quintet is the talented Adam Sparsky, whose voice transports listeners
              to the era of great jazz. He is complemented by skillful musicians: Rhythmic Resonance Group on saxophone,
              Nostalgic Jazzphonic Quartet on keys, Chromatic Odyssey Assembly on drums. We invite you to an evening of
              unsurpassed musical emotions and impressions.</p>

            <!-- Participants -->
            <h2 class="h5 pt-3 pt-sm-0 mt-4 mt-sm-5">Participants</h2>
            <div class="overflow-x-auto pb-3 mb-2">
              <ul class="nav nav-pills flex-nowrap gap-2 text-nowrap">
                <li class="nav-item me-1">
                  <a class="nav-link active" aria-current="page" href="#!">Aug 15</a>
                </li>
                <li class="nav-item me-1">
                  <a class="nav-link" href="#!">Aug 16</a>
                </li>
                <li class="nav-item me-1">
                  <a class="nav-link" href="#!">Aug 17</a>
                </li>
              </ul>
            </div>
            ...
            <div class="swiper" data-swiper='{
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <article class="hover-effect-scale position-relative">
                    <div class="ratio bg-body-tertiary rounded overflow-hidden"
                      style="--fn-aspect-ratio: calc(150 / 232 * 100%)">
                      <img src="assets/img/listings/events/single/participants/01.jpg" class="hover-effect-target"
                        alt="Image">
                    </div>
                    <div class="fs-sm pt-2 mt-1">19:00</div>
                    <h3 class="h6 mt-1 mb-0">
                      <a class="hover-effect-underline stretched-link" href="#!">Rhythmic Resonance Group</a>
                    </h3>
                  </article>
                </div>
                ...
                <div class="swiper-slide">
                  <article class="hover-effect-scale position-relative">
                    <div class="ratio bg-body-tertiary rounded overflow-hidden"
                      style="--fn-aspect-ratio: calc(150 / 232 * 100%)">
                      <img src="assets/img/listings/events/single/participants/02.jpg" class="hover-effect-target"
                        alt="Image">
                    </div>
                    <div class="fs-sm pt-2 mt-1">20:00</div>
                    <h3 class="h6 mt-1 mb-0">
                      <a class="hover-effect-underline stretched-link" href="#!">Chromatic Odyssey Assembly</a>
                    </h3>
                  </article>
                </div>
                ...
                <div class="swiper-slide">
                  <article class="hover-effect-scale position-relative">
                    <div class="ratio bg-body-tertiary rounded overflow-hidden"
                      style="--fn-aspect-ratio: calc(150 / 232 * 100%)">
                      <img src="assets/img/listings/events/single/participants/03.jpg" class="hover-effect-target"
                        alt="Image">
                    </div>
                    <div class="fs-sm pt-2 mt-1">21:30</div>
                    <h3 class="h6 mt-1 mb-0">
            ...
            <!-- Amenities -->
            <h2 class="h5 pt-3 pt-sm-0 mt-4 mt-sm-5">Amenities</h2>
            <div class="row row-cols-2 row-cols-sm-3 row-cols-md-2 row-cols-lg-3 gy-3">
              <div class="col d-flex align-items-center gap-2">
                <i class="fi-wheelchair fs-xl me-1"></i>
                Accessible ticket
              </div>
              <div class="col d-flex align-items-center gap-2">
                <i class="fi-camera fs-xl me-1"></i>
                Photo &amp; video
              </div>
              <div class="col d-flex align-items-center gap-2">
                <i class="fi-wifi fs-xl me-1"></i>
                Free WiFi
              </div>
              <div class="col d-flex align-items-center gap-2">
                <i class="fi-parking fs-xl me-1"></i>
                Free parking
              </div>
              <div class="col d-flex align-items-center gap-2">
                <i class="fi-no-smoking fs-xl me-1"></i>
                Non-smoking
              </div>
              <div class="col d-flex align-items-center gap-2">
                <i class="fi-wine fs-xl me-1"></i>
                Bar area
              </div>
            </div>
          </div>
              ...
              <div class="col-sm-7 col-md-6 col-lg-12 d-flex flex-column order-md-1">
                <div class="card-body pe-sm-0 pe-lg-4">
                  ...
                  <h3 class="h5 pt-1 mb-2">
                    <a class="hover-effect-underline stretched-link" href="#!">Workout with Fitness Stars</a>
                  </h3>
            ...
            <div class="row">
              ...
              <div class="col-sm-7 col-md-6 d-flex flex-column order-md-1">
                <div class="card-body pe-sm-0">
                  ...
                  <h3 class="h5 pt-1 mb-2">
                    <a class="hover-effect-underline stretched-link" href="#!">Winter Fest</a>
                  </h3>
                  <div class="d-flex align-items-center fs-sm">
                    <i class="fi-map-pin me-1"></i>
                    Chicago
    ...
    <div class="container pt-sm-2 pt-md-3 pb-md-2">
      ...
      <div class="border-bottom pb-4">
        <div class="d-flex align-items-center justify-content-between pb-2 pb-sm-3">
          <a class="d-inline-flex align-items-center text-dark-emphasis text-decoration-none" href="home-events.php">

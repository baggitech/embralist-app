...
<head>
  <?php $title = "Add Property - Photos and Videos"; include('partials/title-meta.php'); ?>
...
<body>
          ...
          <div class="border rounded p-3">
            <div class="row row-cols-2 row-cols-sm-3 g-2">
              ...
              <div class="col">
                <div class="hover-effect-opacity position-relative overflow-hidden rounded">
                  ...
                  <div class="ratio" style="--fn-aspect-ratio: calc(180 / 268 * 100%)">
                    <img src="assets/img/add-item/property/01.jpg" alt="Image">
                  </div>
                  <div
              ...
              <div class="col">
                <div class="hover-effect-opacity position-relative overflow-hidden rounded">
                  <div class="ratio" style="--fn-aspect-ratio: calc(180 / 268 * 100%)">
                    <img src="assets/img/add-item/property/02.jpg" alt="Image">
                  </div>
                  <div
                    class="hover-effect-target position-absolute top-0 start-0 d-flex align-items-center justify-content-center w-100 h-100 opacity-0">
                    <button type="button" class="btn btn-icon btn-sm btn-light position-relative z-2"
              ...
              <div class="col">
                <div class="hover-effect-opacity position-relative overflow-hidden rounded">
                  <div class="ratio" style="--fn-aspect-ratio: calc(180 / 268 * 100%)">
                    <img src="assets/img/add-item/property/03.jpg" alt="Image">
                  </div>
                  <div
                    class="hover-effect-target position-absolute top-0 start-0 d-flex align-items-center justify-content-center w-100 h-100 opacity-0">
                    <button type="button" class="btn btn-icon btn-sm btn-light position-relative z-2"
              ...
              <div class="col">
                <div class="hover-effect-opacity position-relative overflow-hidden rounded">
                  <div class="ratio" style="--fn-aspect-ratio: calc(180 / 268 * 100%)">
                    <img src="assets/img/add-item/property/04.jpg" alt="Image">
                  </div>
                  <div
                    class="hover-effect-target position-absolute top-0 start-0 d-flex align-items-center justify-content-center w-100 h-100 opacity-0">
                    <button type="button" class="btn btn-icon btn-sm btn-light position-relative z-2"
  ...
  <footer class="sticky-bottom bg-body pb-3">
    ...
    <div class="container d-flex gap-3 pt-3">
      <a class="btn btn-outline-dark animate-slide-start" href="add-property-location.php">
        <i class="fi-arrow-left animate-target fs-base ms-n1 me-2"></i>
        Back
      </a>
      <a class="btn btn-dark animate-slide-end ms-auto" href="add-property-details.php">
        Next

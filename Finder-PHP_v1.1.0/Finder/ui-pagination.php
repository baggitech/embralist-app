...
<html lang="en" data-bs-theme="light" data-pwa="true">
  <head>
    ...
    <title>Finder Docs | Pagination</title>
      ...
      <div class="row pt-sm-2">
                  ...
                  <nav class="docs-list list-group list-group-borderless" onclick="closeSidebar()">
                    ...
                    <div class="dropdown">
                      ...
                      <ul id="anchorNav" class="nav nav-underline flex-column border-start ms-2 my-2" style="gap: .25rem;">
                        <li class="nav-item"><a class="nav-link fw-normal" href="#pagination-basic">Basic example</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#pagination-icons">With icons</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#pagination-sizing">Sizing</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#pagination-select">Items per page select</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#pagination-load-more">Load more (One-page)</a></li>
                      </ul>
                    </div>
                    <div class="dropend">
        ...
        <main class="col-lg-9 pt-1 pb-5 mb-sm-2 mb-md-3">
          ...
          <section class="py-2 pb-sm-3">
            <a class="badge d-inline-flex align-items-center text-info bg-info-subtle fw-semibold text-decoration-none py-2 px-3 mb-2 rounded-pill" href="https://getbootstrap.com/docs/5.3/components/pagination/" target="_blank" rel="noreferrer">
              Bootstrap docs
          ...
          <!-- Basic example -->
          <section id="pagination-basic" class="docs-section pb-sm-2 mb-5">
            <h4>Basic example</h4>
                ...
                <div class="tab-content">
                  ...
                  <div id="html-1" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#pagination-basic-code">
...
&lt;/nav&gt;</code></pre>
          ...
          <!-- With icons -->
          <section id="pagination-icons" class="docs-section pb-sm-2 mb-5">
            <h4>With icons</h4>
            <div class="card border-0 shadow">
              <span class="d-none d-block-dark position-absolute top-0 start-0 w-100 h-100 bg-dark rounded opacity-50"></span>
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  ...
                  <div id="html-2" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#pagination-icons-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
...
&lt;/nav&gt;</code></pre>
          ...
          <!-- Sizing -->
          <section id="pagination-sizing" class="docs-section pb-sm-2 mb-5">
            <h4>Sizing</h4>
            <div class="card border-0 shadow">
              <span class="d-none d-block-dark position-absolute top-0 start-0 w-100 h-100 bg-dark rounded opacity-50"></span>
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  ...
                  <div id="html-3" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#pagination-sizing-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
...
&lt;/nav&gt;</code></pre>
          ...
          <section id="pagination-select" class="docs-section pb-sm-2 mb-5">
              ...
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  ...
                  <div id="html-4" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#pagination-select-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
...
&lt;/div&gt;</code></pre>
          ...
          <!-- Load more (One-page) -->
          <section id="pagination-load-more" class="docs-section">

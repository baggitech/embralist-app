...
<html lang="en" data-bs-theme="light" data-pwa="true">
  <head>
    ...
    <title>Finder Docs | Utilities</title>
      ...
      <div class="row pt-sm-2">
                  ...
                  <nav class="docs-list list-group list-group-borderless" onclick="closeSidebar()">
                    ...
                    <div class="dropend">
                      ...
                      <ul id="anchorNav" class="nav nav-underline flex-column border-start ms-2 my-2" style="gap: .25rem;">
                        <li class="nav-item"><a class="nav-link fw-normal" href="#utilities-dotted-bg">Dotted background</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#utilities-borders">Borders</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#utilities-cursors">Cursors</a></li>
                      </ul>
                    </div>
                    <div class="dropend">
        ...
        <main class="col-lg-9 pt-1 pb-5 mb-sm-2 mb-md-3">
          ...
          <section class="py-2 pb-sm-3">
            ...
            <h1 class="pt-1">Finder utilities</h1>
            <p class="text-body-secondary mb-4">Custom Finder utility classes.</p>
          </section>


          <!-- Dotted background -->
          <section id="utilities-dotted-bg" class="docs-section pb-sm-2 mb-5">
                ...
                <div class="tab-content">
                  <div id="preview-1" class="tab-pane pt-4 pb-2 mt-2 fade show active" role="tabpanel">
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3 g-md-4">
                      <div class="col">
                        <div class="position-relative bg-dotted rounded" style="--fn-bg-color: var(--fn-primary-bg-subtle); --fn-dot-color: var(--fn-primary)">
                      ...
                      <div class="col">
                        <div class="position-relative bg-dotted rounded" style="--fn-bg-color: var(--fn-success-bg-subtle); --fn-dot-color: var(--fn-success)">
                          <div class="ratio ratio-4x3 d-none d-sm-block"></div>
                          <div class="ratio ratio-16x9 d-sm-none"></div>
                          <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center">
                      ...
                      <div class="col">
                        <div class="position-relative bg-dotted rounded" style="--fn-bg-color: var(--fn-danger-bg-subtle); --fn-dot-color: var(--fn-danger)">
                          <div class="ratio ratio-4x3 d-none d-sm-block"></div>
                          <div class="ratio ratio-16x9 d-sm-none"></div>
                          <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center">
                      ...
                      <div class="col">
                        <div class="position-relative bg-dotted rounded" style="--fn-bg-color: var(--fn-warning-bg-subtle); --fn-dot-color: var(--fn-warning)">
                          <div class="ratio ratio-4x3 d-none d-sm-block"></div>
                          <div class="ratio ratio-16x9 d-sm-none"></div>
                          <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center">
                      ...
                      <div class="col">
                        <div class="position-relative bg-dotted rounded" style="--fn-bg-color: var(--fn-info-bg-subtle); --fn-dot-color: var(--fn-info)">
                          <div class="ratio ratio-4x3 d-none d-sm-block"></div>
                          <div class="ratio ratio-16x9 d-sm-none"></div>
                          <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center">
                      ...
                      <div class="col">
                        <div class="position-relative bg-dotted rounded" style="--fn-bg-color: var(--fn-dark-bg-subtle); --fn-dot-color: var(--fn-dark)">
                          <div class="ratio ratio-4x3 d-none d-sm-block"></div>
                          <div class="ratio ratio-16x9 d-sm-none"></div>
                          <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center">
...
&lt;div class=&quot;bg-dotted p-4&quot; style=&quot;--fn-bg-color: var(--fn-dark-bg-subtle); --fn-dot-color: var(--fn-dark)&quot;&gt;...&lt;/div&gt;</code></pre>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <!-- Borders -->
          <section id="utilities-borders" class="docs-section pb-sm-2 mb-5">
            <h4>Borders</h4>
            <div class="card border-0 shadow">
              <span class="d-none d-block-dark position-absolute top-0 start-0 w-100 h-100 bg-dark rounded opacity-50"></span>
              <div class="card-body position-relative z-2">
...
&lt;div class=&quot;border border-dotted p-4&quot;&gt;...&lt;/div&gt;</code></pre>
          ...
          <!-- Cursors -->
          <section id="utilities-cursors" class="docs-section">
            <h4>Cursors</h4>
            <div class="card border-0 shadow">
              <span class="d-none d-block-dark position-absolute top-0 start-0 w-100 h-100 bg-dark rounded opacity-50"></span>
              <div class="card-body position-relative z-2">

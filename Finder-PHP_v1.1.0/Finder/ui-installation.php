...
<head>
  ...
  <title>Finder Docs | Installation</title>
  ...
  <div class="container pt-4">
    <div class="row pt-sm-2">
      ...
      <main class="col-lg-9 pt-1 pb-5 mb-sm-2 mb-md-3">
        ...
        <section class="pb-sm-2 mb-5">
          <div class="border-start border-4 border-warning rounded-end-4 shadow overflow-hidden py-3 py-sm-4 px-4 px-sm-5">
            ...
            <div class="position-relative z-1 py-3">
              <h2 class="h4 text-body-emphasis fw-normal lh-base">The <span class="fw-semibold">Finder template</span> you are currently viewing is a <span class="fw-semibold">Static PHP</span> template built with Bootstrap 5, and it is <span class="fw-semibold">NOT a WordPress</span> theme.</h2>
              <p class="fs-lg text-body-secondary mb-0">Please do not attempt to install the Finder files on WordPress, as this will not work.</p>
            </div>
          </div>
        </section>
        ...
        <!-- Prerequisites -->
        <section class="docs-section pb-sm-2 mb-5" id="prerequisites">
          <h2 class="h3 pb-1 pb-sm-0 mb-sm-4">Prerequisites</h2>
          <ul class="gap-3">
            <li><span class="text-body-emphasis fw-semibold">PHP / CSS / JS (required):</span> These core web technologies are essential for using the template.</li>
        ...
        <section class="docs-section pb-sm-2 mb-5" id="dev-environment">
          ...
          <div class="alert alert-info text-body-emphasis d-flex py-4 mb-4">
            ...
            <div class="ps-2 ps-sm-3 pe-sm-4 w-100">
              <span class="text-info fw-semibold">Please note:</span> The following steps are entirely optional. They are designed for advanced users who wish to leverage a professional-grade front-end toolset included with Finder to accelerate the development process. If you are not familiar with these tools or do not have time to explore them, you can continue to customize Finder using plain HTML, CSS, and JS. In this case, feel free to skip this and next sections. Happy coding! 😉
            </div>
          </div>
          <h3 class="h5 fs-lg pt-1 pt-sm-2">Finder is built using modern web development toolset.</h3>
          <dl class="mb-0">
            <dt>Bootstrap <a class="fw-medium" href="http://getbootstrap.com" target="_blank" rel="noopener">Official website</a></dt>
            <dd class="pb-3 border-bottom">Bootstrap 5 is the latest iteration of the world's most popular HTML, CSS, and JS framework. Finder extends Bootstrap with a variety of its own plugins and components, enriching the core framework to provide enhanced functionality and design options.</dd>
            ...
            <dd class="pb-3 border-bottom">Finder's core scripts and all dependencies are meticulously crafted using vanilla JavaScript (ES6 modules) to ensure optimal performance and broad compatibility across various platforms.</dd>
            <dt>Npm (Node.js) <a class="fw-medium" href="https://www.npmjs.com/" target="_blank" rel="noopener">Official website</a></dt>
            <dd class="pb-3 border-bottom">Npm is the default package manager for the Node.js environment. It offers robust package management capabilities and includes a powerful feature known as "Npm scripts." These scripts facilitate repetitive tasks such as minification, compilation, unit testing, and linting. The Silicon build system uses a series of JavaScript files, each designated for specific tasks, and associated Npm scripts to execute these tasks.</dd>

            <dt>PHP <a target="_blank" href="https://www.php.net/">Official website</a></dt>
            <dd class="fs-sm pb-3 border-bottom">A popular general-purpose scripting language that is
              especially
              suited to web development.
            </dd>
            <dt>Xampp (For Windows) <a target="_blank" href="https://www.apachefriends.org/">Official
                website</a>
            </dt>
            <dd class="fs-sm pb-0">XAMPP is a completely free, easy to install Apache
        ...
        <!-- Text editor or CLI -->
        <section class="docs-section pb-sm-2 mb-5" id="editor-cli">
        ...
        <section class="docs-section mb-3" id="install-node">
          ...
          <h3 class="h5 pt-2">Installing necessary packages for Finder development</h3>
          <p>Once Node.js and npm are installed, you're ready to install all the dependencies required for developing with Finder.</p>
          <p>Open your command line tool and type the following command:</p>
          <kbd class="d-inline-block mb-3">npm install</kbd>
          <p class="mb-0">This command initiates the installation of all dependencies listed in the <code>Finder/package.json</code> file. Please wait until the installation process is complete before proceeding to the next section, <a class="fw-medium" href="npm-scripts.php">Npm commands (scripts).</a></p>
        </section>
      </main>
    </div>
  </div>

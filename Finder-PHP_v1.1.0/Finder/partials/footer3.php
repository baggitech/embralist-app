    ...
    <div class="container pt-sm-2 pt-md-3 pt-lg-4">
        ...
        <div class="accordion row pb-4 py-sm-5" id="footerLinks">
                ...
                <div class="accordion-item border-0">
                    <h6 class="accordion-header" id="buySellHeading">
                        ...
                        <button type="button" class="accordion-button collapsed py-3 d-sm-none" data-bs-toggle="collapse"
                            data-bs-target="#buySell" aria-expanded="false" aria-controls="buySell">Buying &amp; selling</button>
                    </h6>
                    <div class="accordion-collapse collapse d-sm-block" id="buySell" aria-labelledby="buySellHeading"
                        data-bs-parent="#footerLinks">
                        <ul class="nav flex-column gap-2 pt-sm-1 pt-lg-2 pb-3 pb-sm-0 mt-n1 mb-1 mb-sm-0">
                            <li class="pt-1">
                                <a class="nav-link hover-effect-underline d-inline text-body fw-normal p-0" href="#!">Find a car</a>
                            </li>
                            <li class="pt-1">
                                <a class="nav-link hover-effect-underline d-inline text-body fw-normal p-0" href="#!">Sell your
                                    car</a>
                            </li>
                            <li class="pt-1">
                                <a class="nav-link hover-effect-underline d-inline text-body fw-normal p-0" href="#!">Car dealers</a>
                            </li>
                            <li class="pt-1">
                                <a class="nav-link hover-effect-underline d-inline text-body fw-normal p-0" href="#!">Compare cars</a>
                            </li>
                            <li class="pt-1">
                                <a class="nav-link hover-effect-underline d-inline text-body fw-normal p-0" href="#!">Online car
                                    appraisal</a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="col-sm-4 col-md-2 col-lg-3">
                <div class="accordion-item border-0">
                    <h6 class="accordion-header" id="aboutLinksHeading">
                        ...
                        <button type="button" class="accordion-button collapsed py-3 d-sm-none" data-bs-toggle="collapse"
                            data-bs-target="#aboutLinks" aria-expanded="false" aria-controls="aboutLinks">About</button>
                    </h6>
                    <div class="accordion-collapse collapse d-sm-block" id="aboutLinks" aria-labelledby="aboutLinksHeading"
                        data-bs-parent="#footerLinks">
                        <ul class="nav flex-column gap-2 pt-sm-1 pt-lg-2 pb-3 pb-sm-0 mt-n1 mb-1 mb-sm-0">
                            <li class="pt-1">
                                <a class="nav-link hover-effect-underline d-inline text-body fw-normal p-0" href="#!">About Finder</a>
                            </li>
                            <li class="pt-1">
                                <a class="nav-link hover-effect-underline d-inline text-body fw-normal p-0" href="#!">Contact us</a>
                            </li>
                            <li class="pt-1">
                                <a class="nav-link hover-effect-underline d-inline text-body fw-normal p-0" href="#!">FAQs &amp;
                                    support</a>
                            </li>
                            <li class="pt-1">
                                <a class="nav-link hover-effect-underline d-inline text-body fw-normal p-0" href="#!">Mobile app</a>
                            </li>
                            <li class="pt-1">
                                <a class="nav-link hover-effect-underline d-inline text-body fw-normal p-0" href="#!">Blog &amp;
                                    news</a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="accordion-item border-0">
                    ...
                    <div class="accordion-collapse collapse d-sm-block" id="profileLinks" aria-labelledby="profileLinksHeading"
                        ...
                        <ul class="nav flex-column gap-2 pt-sm-1 pt-lg-2 pb-3 pb-sm-0 mt-n1 mb-1 mb-sm-0">
                            ...
                            <li class="pt-1">
                                <a class="nav-link hover-effect-underline d-inline text-body fw-normal p-0" href="#!">Wishlist</a>
                            </li>
                            <li class="pt-1">
            ...
            <div class="col-md-5 col-lg-4 col-xl-3 pt-4 pt-sm-5 pt-md-0 mt-3 mt-sm-0">
                ...
                <p class="fs-sm text-body-secondary mb-4">Download Finder App and join the community of car enthusiasts.</p>

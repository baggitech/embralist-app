...
<html lang="en" data-bs-theme="light" data-pwa="true">
  <head>
    ...
    <title>Finder Docs | Breadcrumb</title>
      ...
      <div class="row pt-sm-2">
              ...
              <div class="offcanvas-body d-block flex-grow-1 overflow-hidden pt-0 pe-0 pb-lg-2">
                <div id="scrollable" class="h-100 overflow-y-auto pe-4">
                  <nav class="docs-list list-group list-group-borderless" onclick="closeSidebar()">
                    ...
                    <div class="dropdown">
                      <a class="list-group-item list-group-item-action justify-content-between dropdown-toggle pe-3 pe-none active" href="breadcrumb.php">
                        Breadcrumb
        ...
        <main class="col-lg-9 pt-1 pb-5 mb-sm-2 mb-md-3">
          ...
          <section class="pt-2 pb-lg-1">
            <a class="badge d-inline-flex align-items-center text-info bg-info-subtle fw-semibold text-decoration-none py-2 px-3 mb-2 rounded-pill" href="https://getbootstrap.com/docs/5.3/components/breadcrumb/" target="_blank" rel="noreferrer">
              Bootstrap docs
              ...
              <div class="tab-content">
                <div id="preview-1" class="tab-pane pt-4 pb-2 mt-3 fade show active" role="tabpanel">
                  <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item active" aria-current="page">Property page</li>
                    </ol>
                  </nav>
                  <nav aria-label="breadcrumb">
                ...
                <div id="html-1" class="tab-pane pt-4 fade" role="tabpanel">
                  <div class="position-relative" data-bs-theme="dark">
                    <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#breadcrumb-code">

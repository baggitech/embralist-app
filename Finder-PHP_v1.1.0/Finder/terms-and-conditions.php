...
<html lang="en" data-bs-theme="light" data-pwa="true">
  <head>
    <?php $title = "Terms and Conditions"; include('partials/title-meta.php'); ?>
      ...
      <div class="container pt-4 pt-sm-5 pb-5 mt-2 mt-sm-0 mt-lg-2 mb-2 mb-md-3 mb-lg-4 mb-xl-5">
        <div class="row justify-content-center">
          <div class="col-lg-11 col-xl-10 col-xxl-9">
            ...
            <hr class="mt-0">
            <div class="h6 pt-2 pt-lg-3"><span class="text-body-secondary fw-medium">Last updated:</span> August 15, 2024</div>
            <p>Welcome to Finder! These terms and conditions outline the rules and regulations for the use of Finder's Website, located at <span class="fw-semibold">findertheme.com</span>. By accessing this website, we assume you accept these terms and conditions. Do not continue to use Finder if you do not agree to take all of the terms and conditions stated on this page.</p>

            <h2 class="h4 pt-3 pt-lg-4">1. Definitions</h2>
            <ul>
              <li><span class="fw-semibold text-body-emphasis">"Finder"</span> refers to our real estate listings website.</li>
              <li><span class="fw-semibold text-body-emphasis">"User"</span> refers to anyone using our website, including sellers, buyers, renters, and agents.</li>
              <li><span class="fw-semibold text-body-emphasis">"Listing"</span> refers to any property listed for sale, purchase, or rent on Finder.</li>
            </ul>

            <h2 class="h4 pt-3 pt-lg-4">2. Acceptance of Terms</h2>
            <p>By using Finder, you agree to comply with and be legally bound by the terms and conditions set forth below, whether or not you become a registered user of the services. These terms govern your access to and use of the website and services, and constitute a binding legal agreement between you and Finder.</p>

            <h2 class="h4 pt-3 pt-lg-4">3. Use of the Website</h2>
            <h3 class="h6 pt-1">a. Eligibility</h3>
            <p>To use Finder, you must be at least 18 years old and capable of forming a binding contract with Finder and not be barred from using the services under applicable law.</p>
            ...
            <p>Your use of Finder is also governed by our Privacy Policy, which is incorporated by reference into these terms. Please review our Privacy Policy to understand our practices.</p>
            ...
            <p>You agree to indemnify and hold Finder and its affiliates, officers, agents, and employees harmless from any claim or demand, including reasonable attorney's fees, made by any third party due to or arising out of your use of the website, your violation of these terms, or your violation of any rights of another.</p>

            <h2 class="h4 pt-3 pt-lg-4">11. Modifications to the Service</h2>
            <p>Finder reserves the right to modify or discontinue, temporarily or permanently, the service with or without notice at any time.</p>
            ...
            <p>If you have any questions, or comments about these Terms please contact Finder at:</p>
            <ul class="list-unstyled pb-1">
              ...
              <li class="nav pt-1">
                <a class="nav-link align-items-start fs-base p-0" href="mailto:contact@findertheme.com">
            ...
            <p class="pb-3 mb-0">For customer service inquiries, please review Your Account Settings, visit Finder's <a class="fw-medium" href="help-topics-v1.php">Help Center.</a></p>

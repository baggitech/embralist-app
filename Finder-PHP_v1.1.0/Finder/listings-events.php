...
<head>
  <?php $title = "Events - Listings with Top Filters";
...
<body>
        ...
        <div class="offcanvas-body pt-2 pb-4 py-lg-0 mx-lg-auto">
          <ul class="navbar-nav position-relative">
            ...
            <li class="nav-item dropdown position-static py-lg-2 me-lg-n1 me-xl-0">
              <a class="nav-link dropdown-toggle active" aria-current="page" href="#" role="button" data-bs-toggle="dropdown" data-bs-trigger="hover" aria-expanded="false">Listings</a>
  ...
  <main class="content-wrapper">
    ...
    <section class="container mb-2">
      ...
      <!-- Filters -->
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-2 g-md-3 g-lg-4 mb-4">
        <div class="col">
        ...
        <div class="col">
          <div class="position-relative">
            ...
            <input type="text" class="form-control form-icon-start bg-transparent" data-datepicker='{"dateFormat": "M j, Y"}' placeholder="Date">
          </div>
        </div>
        <div class="col">
          <div class="position-relative">
      ...
      <div class="d-flex align-items-center justify-content-between gap-3">
        <div class="overflow-x-auto pb-3">
          <ul class="nav nav-pills flex-nowrap gap-2 text-nowrap">
            ...
            <li class="nav-item me-1">
              <a class="nav-link" href="#!">Hiphop</a>
            </li>
          </ul>
        </div>
        <div class="d-flex align-items-center gap-4 pb-3 me-n2">
          <div class="fs-sm text-nowrap d-none d-md-inline"><span class="d-none d-lg-inline">Showing</span> 96 results</div>
    ...
    <section class="container pb-2 pb-sm-3 pb-md-4 pb-lg-5 mb-xxl-3">
      <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 g-4">
          ...
          <article class="card h-100 hover-effect-scale hover-effect-opacity bg-body-tertiary border-0">
            ...
            <div class="bg-body-secondary rounded overflow-hidden">
              <div class="ratio hover-effect-target" style="--fn-aspect-ratio: calc(250 / 416 * 100%)">
                <img src="assets/img/listings/events/01.jpg" alt="Image">
              </div>
            </div>
            <div class="card-body">
              ...
              <h3 class="h5 pt-1 mb-2">
                <a class="hover-effect-underline stretched-link" href="single-entry-events.php">Paradox Band</a>
              </h3>
        ...
        <div class="col">
          <article class="card h-100 hover-effect-scale hover-effect-opacity bg-body-tertiary border-0">
            ...
            <div class="bg-body-secondary rounded overflow-hidden">
              <div class="ratio hover-effect-target" style="--fn-aspect-ratio: calc(250 / 416 * 100%)">
                <img src="assets/img/listings/events/02.jpg" alt="Image">
              </div>
            </div>
            <div class="card-body">
              <ul class="list-unstyled flex-row flex-wrap align-items-center gap-2 fs-sm mb-2">
              ...
              <h3 class="h5 pt-1 mb-2">
                <a class="hover-effect-underline stretched-link" href="single-entry-events.php">Laura Sparski - Cello</a>
              </h3>
              <div class="d-flex align-items-center fs-sm">
                <i class="fi-map-pin me-1"></i>
                Chicago
            ...
            <div class="card-footer d-flex align-items-center justify-content-between gap-3 bg-transparent border-0 pt-0 pb-4">
              <div class="h5 text-info mb-0">$27.00</div>
              <button type="button" class="btn btn-outline-dark position-relative z-2">Book now</button>
            </div>
          </article>
        </div>
        ...
        <div class="col">
          <article class="card h-100 hover-effect-scale hover-effect-opacity bg-body-tertiary border-0">
            ...
            <div class="card-body">
              ...
              <h3 class="h5 pt-1 mb-2">
                <a class="hover-effect-underline stretched-link" href="single-entry-events.php">Sunset Disco Party</a>
              </h3>
              <div class="d-flex align-items-center fs-sm">
                <i class="fi-map-pin me-1"></i>
                Chicago
        ...
        <div class="col">
          <article class="card h-100 hover-effect-scale hover-effect-opacity bg-body-tertiary border-0">
            ...
            <div class="card-body">
              ...
              <h3 class="h5 pt-1 mb-2">
                <a class="hover-effect-underline stretched-link" href="single-entry-events.php">Nostalgic Jazzphonic Quartet</a>
              </h3>
              <div class="d-flex align-items-center fs-sm">
                <i class="fi-map-pin me-1"></i>
                Chicago
        ...
        <div class="col">
          <article class="card h-100 hover-effect-scale hover-effect-opacity bg-body-tertiary border-0">
            ...
            <div class="bg-body-secondary rounded overflow-hidden">
              <div class="ratio hover-effect-target" style="--fn-aspect-ratio: calc(250 / 416 * 100%)">
                <img src="assets/img/listings/events/05.jpg" alt="Image">
              </div>
            </div>
            <div class="card-body">
              <ul class="list-unstyled flex-row flex-wrap align-items-center gap-2 fs-sm mb-2">
              ...
              <h3 class="h5 pt-1 mb-2">
                <a class="hover-effect-underline stretched-link" href="single-entry-events.php">Music Festival</a>
              </h3>
              <div class="d-flex align-items-center fs-sm">
                <i class="fi-map-pin me-1"></i>
                Chicago
            ...
            <div class="card-footer d-flex align-items-center justify-content-between gap-3 bg-transparent border-0 pt-0 pb-4">
              <div class="h5 text-info mb-0">$50.00</div>
              <button type="button" class="btn btn-outline-dark position-relative z-2">Book now</button>
            </div>
          </article>
        </div>
        ...
        <div class="col">
          <article class="card h-100 hover-effect-scale hover-effect-opacity bg-body-tertiary border-0">
            ...
            <div class="bg-body-secondary rounded overflow-hidden">
              <div class="ratio hover-effect-target" style="--fn-aspect-ratio: calc(250 / 416 * 100%)">
                <img src="assets/img/listings/events/06.jpg" alt="Image">
              </div>
            </div>
            <div class="card-body">
              <ul class="list-unstyled flex-row flex-wrap align-items-center gap-2 fs-sm mb-2">
              ...
              <h3 class="h5 pt-1 mb-2">
                <a class="hover-effect-underline stretched-link" href="single-entry-events.php">Jazz Night Event</a>
              </h3>
              <div class="d-flex align-items-center fs-sm">
                <i class="fi-map-pin me-1"></i>
                Chicago
            ...
            <div class="card-footer d-flex align-items-center justify-content-between gap-3 bg-transparent border-0 pt-0 pb-4">
              <div class="h5 text-info mb-0">$42.00</div>
              <button type="button" class="btn btn-outline-dark position-relative z-2">Book now</button>
            </div>
          </article>
        </div>
        ...
        <div class="col">
          <article class="card h-100 hover-effect-scale hover-effect-opacity bg-body-tertiary border-0">
            ...
            <div class="bg-body-secondary rounded overflow-hidden">
              <div class="ratio hover-effect-target" style="--fn-aspect-ratio: calc(250 / 416 * 100%)">
                <img src="assets/img/listings/events/07.jpg" alt="Image">
              </div>
            </div>
            <div class="card-body">
              <ul class="list-unstyled flex-row flex-wrap align-items-center gap-2 fs-sm mb-2">
              ...
              <h3 class="h5 pt-1 mb-2">
                <a class="hover-effect-underline stretched-link" href="single-entry-events.php">Local Rock Band</a>
              </h3>
              <div class="d-flex align-items-center fs-sm">
                <i class="fi-map-pin me-1"></i>
                Chicago
            ...
            <div class="card-footer d-flex align-items-center justify-content-between gap-3 bg-transparent border-0 pt-0 pb-4">
              <div class="h5 text-info mb-0">$29.00</div>
              <button type="button" class="btn btn-outline-dark position-relative z-2">Book now</button>
            </div>
          </article>
        </div>
        ...
        <div class="col">
          <article class="card h-100 hover-effect-scale hover-effect-opacity bg-body-tertiary border-0">
            ...
            <div class="bg-body-secondary rounded overflow-hidden">
              <div class="ratio hover-effect-target" style="--fn-aspect-ratio: calc(250 / 416 * 100%)">
                <img src="assets/img/listings/events/08.jpg" alt="Image">
              </div>
            </div>
            <div class="card-body">
              <ul class="list-unstyled flex-row flex-wrap align-items-center gap-2 fs-sm mb-2">
              ...
              <h3 class="h5 pt-1 mb-2">
                <a class="hover-effect-underline stretched-link" href="single-entry-events.php">John Horrison - Guitar Solo</a>
              </h3>
              <div class="d-flex align-items-center fs-sm">
                <i class="fi-map-pin me-1"></i>
                Chicago
        ...
        <div class="col">
          <article class="card h-100 hover-effect-scale hover-effect-opacity bg-body-tertiary border-0">
            ...
            <div class="bg-body-secondary rounded overflow-hidden">
              <div class="ratio hover-effect-target" style="--fn-aspect-ratio: calc(250 / 416 * 100%)">
                <img src="assets/img/listings/events/09.jpg" alt="Image">
              </div>
            </div>
            <div class="card-body">
              <ul class="list-unstyled flex-row flex-wrap align-items-center gap-2 fs-sm mb-2">
              ...
              <h3 class="h5 pt-1 mb-2">
                <a class="hover-effect-underline stretched-link" href="single-entry-events.php">Melisa Martin in Chicago</a>
              </h3>
              <div class="d-flex align-items-center fs-sm">
                <i class="fi-map-pin me-1"></i>
                Chicago
        ...
        <div class="col">
          <article class="card h-100 hover-effect-scale hover-effect-opacity bg-body-tertiary border-0">
            ...
            <div class="bg-body-secondary rounded overflow-hidden">
              <div class="ratio hover-effect-target" style="--fn-aspect-ratio: calc(250 / 416 * 100%)">
                <img src="assets/img/listings/events/10.jpg" alt="Image">
              </div>
            </div>
            <div class="card-body">
              <ul class="list-unstyled flex-row flex-wrap align-items-center gap-2 fs-sm mb-2">
              ...
              <h3 class="h5 pt-1 mb-2">
                <a class="hover-effect-underline stretched-link" href="single-entry-events.php">Summer Music Festival 2024</a>
              </h3>
              <div class="d-flex align-items-center fs-sm">
                <i class="fi-map-pin me-1"></i>
                Chicago
            ...
            <div class="card-footer d-flex align-items-center justify-content-between gap-3 bg-transparent border-0 pt-0 pb-4">
              <div class="h5 text-info mb-0">$53.00</div>
              <button type="button" class="btn btn-outline-dark position-relative z-2">Book now</button>
            </div>
          </article>
        </div>
        ...
        <div class="col">
          <article class="card h-100 hover-effect-scale hover-effect-opacity bg-body-tertiary border-0">
            ...
            <div class="bg-body-secondary rounded overflow-hidden">
              <div class="ratio hover-effect-target" style="--fn-aspect-ratio: calc(250 / 416 * 100%)">
                <img src="assets/img/listings/events/11.jpg" alt="Image">
              </div>
            </div>
            <div class="card-body">
              <ul class="list-unstyled flex-row flex-wrap align-items-center gap-2 fs-sm mb-2">
            ...
            <div class="card-footer d-flex align-items-center justify-content-between gap-3 bg-transparent border-0 pt-0 pb-4">
              <div class="h5 text-info mb-0">$36.00</div>
              <button type="button" class="btn btn-outline-dark position-relative z-2">Book now</button>
            </div>
          </article>
        </div>
        ...
        <div class="col">
          <article class="card h-100 hover-effect-scale hover-effect-opacity bg-body-tertiary border-0">
            ...
            <div class="bg-body-secondary rounded overflow-hidden">
              <div class="ratio hover-effect-target" style="--fn-aspect-ratio: calc(250 / 416 * 100%)">
                <img src="assets/img/listings/events/12.jpg" alt="Image">
              </div>
            </div>
            <div class="card-body">
              <ul class="list-unstyled flex-row flex-wrap align-items-center gap-2 fs-sm mb-2">
              ...
              <h3 class="h5 pt-1 mb-2">
                <a class="hover-effect-underline stretched-link" href="single-entry-events.php">DJ Hardwall - Disco Party</a>
              </h3>
              <div class="d-flex align-items-center fs-sm">
                <i class="fi-map-pin me-1"></i>
                Chicago
            ...
            <div class="card-footer d-flex align-items-center justify-content-between gap-3 bg-transparent border-0 pt-0 pb-4">
              <div class="h5 text-info mb-0">$49.00</div>
              <button type="button" class="btn btn-outline-dark position-relative z-2">Book now</button>
            </div>
          </article>
        </div>
      ...
      <!-- Pagination -->
      <nav class="pt-3 pb-5 mt-3" aria-label="Listings pagination">
            ...
            <div class="swiper-slide">
              <article class="card hover-effect-scale hover-effect-opacity bg-transparent border-0">
                ...
                <div class="card-body pt-3 pt-sm-4 p-0">
                  ...
                  <h3 class="h5 mb-0">
                    <a class="hover-effect-underline stretched-link" href="single-entry-events.php">Soccer Championship: Battle for the Cup</a>
                  </h3>
                </div>
              </article>
            </div>
            ...
            <div class="swiper-slide">
              <article class="card hover-effect-scale hover-effect-opacity bg-transparent border-0">
                ...
                <div class="card-body pt-3 pt-sm-4 p-0">
                  ...
                  <h3 class="h5 mb-0">
                    <a class="hover-effect-underline stretched-link" href="single-entry-events.php">Boston Home Run Classic: Baseball</a>
                  </h3>
                </div>
              </article>
            </div>
            ...
            <div class="swiper-slide">
              <article class="card hover-effect-scale hover-effect-opacity bg-transparent border-0">
                ...
                <div class="card-body pt-3 pt-sm-4 p-0">
                  ...
                  <h3 class="h5 mb-0">
                    <a class="hover-effect-underline stretched-link" href="single-entry-events.php">Regional Motocross Championship</a>
                  </h3>
                </div>
              </article>
            </div>
            ...
            <div class="swiper-slide">
              <article class="card hover-effect-scale hover-effect-opacity bg-transparent border-0">
                ...
                <div class="card-body pt-3 pt-sm-4 p-0">
                  ...
                  <h3 class="h5 mb-0">
                    <a class="hover-effect-underline stretched-link" href="single-entry-events.php">Boxing WBA Professional League 2024</a>
                  </h3>
                </div>
              </article>
            </div>
            ...
            <div class="swiper-slide">
              <article class="card hover-effect-scale hover-effect-opacity bg-transparent border-0">
                ...
                <div class="card-body pt-3 pt-sm-4 p-0">
                  ...
                  <h3 class="h5 mb-0">
                    <a class="hover-effect-underline stretched-link" href="single-entry-events.php">Philadelphia Open Tennis Tournament</a>
                  </h3>
                </div>
              </article>
            </div>
            ...
            <div class="row h-100">
              <div class="col-sm-5 col-md-6 col-lg-12 order-sm-2 order-lg-1">
                <div class="position-relative h-100 bg-body-secondary rounded overflow-hidden">
                  ...
                  <img src="assets/img/listings/events/15.jpg" class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 object-fit-cover" style="object-position: center top" alt="Image">
                </div>
              </div>
              <div class="col-sm-7 col-md-6 col-lg-12 d-flex flex-column order-md-1">
                <div class="card-body pe-sm-0 pe-lg-4">
                  ...
                  <h3 class="h5 pt-1 mb-2">
                    <a class="hover-effect-underline stretched-link" href="single-entry-events.php">Workout with Fitness Stars</a>
                  </h3>
                  <div class="d-flex align-items-center fs-sm">
                    <i class="fi-map-pin me-1"></i>
                    Chicago
                ...
                <div class="card-footer d-flex align-items-center justify-content-between gap-3 bg-transparent border-0 pt-0 pt-sm-4 p-4 pe-sm-0 pe-lg-4">
            ...
            <div class="row">
              <div class="col-sm-5 col-md-6 order-sm-2">
                <div class="position-relative h-100 bg-body-secondary rounded overflow-hidden">
                  ...
                  <div class="ratio ratio-16x9 d-lg-none"></div>
                  <img src="assets/img/listings/events/16.jpg" class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 object-fit-cover" style="object-position: center top" alt="Image">
                </div>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-sm-7 col-md-6 d-flex flex-column order-md-1">
                <div class="card-body pe-sm-0">
                  ...
                  <h3 class="h5 pt-1 mb-2">
                    <a class="hover-effect-underline stretched-link" href="single-entry-events.php">Parallax Show Ballet</a>
                  </h3>
                  <div class="d-flex align-items-center fs-sm">
                    <i class="fi-map-pin me-1"></i>
                    Chicago
  ...
  <footer class="footer bg-body border-top pt-5" data-bs-theme="dark">
    <div class="container pt-sm-2 pt-md-3 pb-md-2">
        ...
        <div class="col-sm-4 col-md-2 col-xl-3">
          <div class="accordion-item border-0">
            <h6 class="accordion-header" id="eventLinksHeading">
              ...
              <button type="button" class="accordion-button collapsed py-3 d-sm-none" data-bs-toggle="collapse" data-bs-target="#eventLinks" aria-expanded="false" aria-controls="eventLinks">Events</button>
            </h6>
            <div class="accordion-collapse collapse d-sm-block" id="eventLinks" aria-labelledby="eventLinksHeading" data-bs-parent="#footerLinks">
              <ul class="nav flex-column gap-2 pt-sm-1 pt-lg-2 pb-3 pb-sm-0 mt-n1 mb-1 mb-sm-0">
                <li class="pt-1">
                  <a class="nav-link hover-effect-underline d-inline text-body fw-normal p-0" href="#!">Popular near you</a>
                </li>
                <li class="pt-1">
                  <a class="nav-link hover-effect-underline d-inline text-body fw-normal p-0" href="#!">Online events</a>
                </li>
                <li class="pt-1">
          ...
          <div class="accordion-item border-0">
            ...
            <div class="accordion-collapse collapse d-sm-block" id="forProviders" aria-labelledby="forProvidersHeading" data-bs-parent="#footerLinks">
              <ul class="nav flex-column gap-2 pt-sm-1 pt-lg-2 pb-3 pb-sm-0 mt-n1 mb-1 mb-sm-0">
                ...
                <li class="pt-1">
                  <a class="nav-link hover-effect-underline d-inline text-body fw-normal p-0" href="#!">Event ticket service</a>
                </li>
                <li class="pt-1">
          ...
          <div class="accordion-item border-0">
            ...
            <div class="accordion-collapse collapse d-sm-block" id="ourCompany" aria-labelledby="ourCompanyHeading" data-bs-parent="#footerLinks">
              <ul class="nav flex-column gap-2 pt-sm-1 pt-lg-2 pb-3 pb-sm-0 mt-n1 mb-1 mb-sm-0">
                ...
                <li class="pt-1">
                  <a class="nav-link hover-effect-underline d-inline text-body fw-normal p-0" href="#!">Ticket delivery</a>
                </li>
                <li class="pt-1">
      ...
      <div class="d-flex flex-column flex-sm-row align-items-center justify-content-between pb-4 pt-3 pt-sm-2 pt-md-3 pt-lg-4">
        ...
        <p class="text-body-secondary fs-sm text-center mb-0">&copy; All rights reserved. Made by <a class="text-body fw-medium text-decoration-none hover-effect-underline" href="https://1.envato.market/coderthemes" target="_blank" rel="noreferrer">Coderthemes</a></p>
      </div>
    </div>
  </footer>

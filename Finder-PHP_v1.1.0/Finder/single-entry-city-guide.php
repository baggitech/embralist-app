...
<head>
  <?php $title = "City Guide - Place Details Page"; include('partials/title-meta.php'); ?>
      ...
      <form class="modal-content needs-validation" novalidate>
        ...
        <div class="modal-body pb-3 pt-0">
          ...
          <div>
            ...
            <textarea class="form-control rounded-5" rows="4" id="review-text" required></textarea>
        ...
        <div class="modal-footer flex-nowrap gap-3 border-0 px-4">
          ...
          <button type="submit" class="btn btn-primary w-100 rounded-pill m-0">Submit review</button>
        </div>
      </form>
    </div>
  </div>
        ...
        <div class="offcanvas-body pt-2 pb-4 py-lg-0 mx-lg-auto">
          <ul class="navbar-nav position-relative">
            <li class="nav-item dropdown py-lg-2 me-lg-n1 me-xl-0">
              <a class="nav-link dropdown-toggle rounded-pill" href="#" role="button" data-bs-toggle="dropdown"
            ...
            <li class="nav-item dropdown position-static py-lg-2 me-lg-n1 me-xl-0">
              <a class="nav-link dropdown-toggle rounded-pill active" aria-current="page" href="#" role="button"
            ...
            <li class="nav-item dropdown py-lg-2 me-lg-n1 me-xl-0">
              ...
              <ul class="dropdown-menu">
                <li class="dropend">
                  <a class="dropdown-item dropdown-toggle rounded-pill" href="#" role="button" data-bs-toggle="dropdown"
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item rounded-pill" href="account-password-recovery.php">Password
                        Recovery</a></li>
                  </ul>
                </li>
            ...
            <li class="nav-item dropdown py-lg-2 me-lg-n1 me-xl-0">
              ...
              <ul class="dropdown-menu">
                <li class="dropend">
                  <a class="dropdown-item dropdown-toggle rounded-pill" href="#!" role="button"
                ...
                <li class="dropend">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item rounded-pill" href="help-single-article-v1.php">Help Single Article
                        v.1</a></li>
                    <li><a class="dropdown-item rounded-pill" href="help-single-article-v2.php">Help Single Article
                        v.2</a></li>
                    <li><a class="dropdown-item rounded-pill" href="help-single-article-v3.php">Help Single Article
                        v.3</a></li>
                  </ul>
                </li>
                <li class="dropend">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item rounded-pill" href="404-bg-image.php">Background Image (Real
                        Estate)</a></li>
                    <li><a class="dropdown-item rounded-pill" href="404-icon.php">Icon Image (Cars)</a></li>
                    <li><a class="dropdown-item rounded-pill" href="404-split-screen.php">Split Screen
                        (Contractors)</a></li>
                    <li><a class="dropdown-item rounded-pill" href="404-illustration.php">Illustration (City Guide)</a>
                    </li>
                  </ul>
                </li>
                <li><a class="dropdown-item rounded-pill" href="terms-and-conditions.php">Terms &amp; Conditions</a>
                </li>
              </ul>
            </li>
  ...
  <main class="content-wrapper">
    ...
    <section class="container pt-4 pb-5 mb-xxl-3">
      ...
      <nav class="pb-2" aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="home-city-guide.php">Home</a></li>
          <li class="breadcrumb-item"><a href="listings-side-filters-city-guide.php">Restaurants</a></li>
      ...
      <div class="d-flex align-items-center justify-content-between gap-3 position-relative z-2 mb-3 mb-lg-4">
        <div class="d-flex align-items-center w-100 gap-3">
          <div class="ratio ratio-1x1 flex-shrink-0" style="max-width: 56px">
            <img src="assets/img/listings/city-guide/single/logo-light.png" class="d-none-dark" alt="Logo">
            <img src="assets/img/listings/city-guide/single/logo-dark.png" class="d-none d-block-dark" alt="Logo">
          </div>
        ...
        <div class="d-flex gap-2">
          ...
          <button type="button" class="btn btn-icon btn-secondary animate-pulse rounded-circle" data-bs-toggle="tooltip"
            data-bs-custom-class="tooltip-sm" title="Wishlist" aria-label="Wishlist">
      ...
      <div class="row row-cols-1 row-cols-md-2 g-3 g-lg-4 pb-sm-2 mb-5">
        <div class="col">
          <a class="hover-effect-scale hover-effect-opacity position-relative d-flex rounded overflow-hidden"
            ...
            <div class="ratio hover-effect-target bg-body-tertiary rounded"
              ...
              <img src="assets/img/listings/city-guide/single/01.jpg" alt="Image">
            </div>
        ...
        <div class="col">
          <div class="row row-cols-2 g-3 g-lg-4">
            <div class="col">
              <a class="hover-effect-scale hover-effect-opacity position-relative d-flex rounded overflow-hidden"
                href="assets/img/listings/city-guide/single/02.jpg" data-glightbox data-gallery="image-gallery">
                <i
                  class="fi-zoom-in hover-effect-target fs-3 text-white position-absolute top-50 start-50 translate-middle opacity-0 z-2"></i>
                <span
                  class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 bg-black bg-opacity-25 opacity-0 z-1"></span>
                <div class="ratio hover-effect-target bg-body-tertiary rounded"
                  ...
                  <img src="assets/img/listings/city-guide/single/th02.jpg" alt="Image">
                </div>
              </a>
            </div>
            <div class="col">
              <a class="hover-effect-scale hover-effect-opacity position-relative d-flex rounded overflow-hidden"
                href="assets/img/listings/city-guide/single/03.jpg" data-glightbox data-gallery="image-gallery">
                <i
                  class="fi-zoom-in hover-effect-target fs-3 text-white position-absolute top-50 start-50 translate-middle opacity-0 z-2"></i>
                <span
                  class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 bg-black bg-opacity-25 opacity-0 z-1"></span>
                <div class="ratio hover-effect-target bg-body-tertiary rounded"
                  style="--fn-aspect-ratio: calc(448 / 636 * 100%)">
                  <img src="assets/img/listings/city-guide/single/th03.jpg" alt="Image">
                </div>
              </a>
            </div>
            <div class="col">
              <a class="hover-effect-scale hover-effect-opacity position-relative d-flex rounded overflow-hidden"
                href="assets/img/listings/city-guide/single/04.jpg" data-glightbox data-gallery="image-gallery">
                <i
                  class="fi-zoom-in hover-effect-target fs-3 text-white position-absolute top-50 start-50 translate-middle opacity-0 z-2"></i>
                <span
                  class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 bg-black bg-opacity-25 opacity-0 z-1"></span>
                <div class="ratio hover-effect-target bg-body-tertiary rounded"
                  style="--fn-aspect-ratio: calc(448 / 636 * 100%)">
                  <img src="assets/img/listings/city-guide/single/th04.jpg" alt="Image">
                </div>
              </a>
            </div>
            <div class="col">
              <a class="hover-effect-scale hover-effect-opacity position-relative d-flex rounded overflow-hidden"
                href="assets/img/listings/city-guide/single/05.jpg" data-glightbox data-gallery="image-gallery">
                <i
                  class="fi-zoom-in hover-effect-target fs-3 text-white position-absolute top-50 start-50 translate-middle opacity-0 z-2"></i>
                <span
                  class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 bg-black bg-opacity-25 opacity-0 z-1"></span>
                <div class="ratio hover-effect-target bg-body-tertiary rounded"
                  style="--fn-aspect-ratio: calc(448 / 636 * 100%)">
                  <img src="assets/img/listings/city-guide/single/th05.jpg" alt="Image">
                </div>
              </a>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-md-7 pb-2 pb-md-0 mb-4 mb-md-0">
          ...
          <p class="fs-sm">Sbarro Restaurant offers a delectable fusion of flavors for both meat lovers and vegans
            alike. Our diverse menu features succulent meat dishes and tantalizing vegan creations, ensuring a
            delightful dining experience for every palate. Savor the best of both worlds in a welcoming ambiance that
            celebrates the joy of shared meals and culinary diversity.</p>
          <p class="fs-sm">At Sbarro, we pride ourselves on using only the freshest ingredients, sourced locally
            whenever possible, to craft our mouth-watering dishes. From hearty pasta and pizza options to vibrant salads
            and creative vegan bowls, there's something for everyone to enjoy. Each meal is thoughtfully prepared by our
            talented chefs, bringing bold flavors and authentic tastes to your table.</p>
          <p class="fs-sm mb-0">Whether you're stopping in for a quick lunch or enjoying a leisurely dinner with friends
            and family, Sbarro offers an inviting atmosphere perfect for any occasion. Our friendly staff is dedicated
            to providing exceptional service, ensuring that every visit is a memorable one. Come experience the perfect
            blend of tradition and innovation at Sbarro Restaurant, where every bite is a celebration of good food and
            great company.</p>
        </div>
          ...
          <div class="ps-md-4 ps-lg-5 ps-xl-0">
            <div class="position-relative rounded overflow-hidden" style="max-width: 416px">
              ...
              <div class="ratio bg-body-tertiary" style="--fn-aspect-ratio: calc(369 / 416 * 100%)">
                <img src="assets/img/listings/city-guide/single/map-light.jpg" class="d-none-dark" alt="Map">
                <img src="assets/img/listings/city-guide/single/map-dark.jpg" class="d-none d-block-dark" alt="Map">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row pb-5">
        ...
        <div class="col-md-7 mb-5 mb-md-0">
          ...
          <div class="d-flex align-items-center justify-content-between gap-4 mb-3">
            ...
            <button type="button" class="btn btn-outline-primary rounded-pill mb-3" data-bs-toggle="modal"
          ...
          <div class="vstack gap-4">
            ...
            <div class="vstack gap-2 mb-sm-2">
              ...
              <p class="fs-sm mb-1">Sbarro is my go-to spot for incredible pizza! The crust is always perfectly crispy,
                and the toppings are fresh and flavorful. I love that they have options for both meat lovers and vegans,
                so there's something for everyone in our group. Highly recommend!</p>
            ...
            <div class="vstack gap-2 mb-sm-2">
              ...
              <p class="fs-sm mb-1">Absolutely fantastic experience at Sbarro! The vegan dishes were a pleasant surprise
                - so creative and delicious. The staff was welcoming, and the ambiance made for a perfect night out.
            ...
            <div class="vstack gap-2 mb-sm-2">
              ...
              <p class="fs-sm mb-1">Sbarro never disappoints! Their pasta is rich and flavorful, and the pizza is out of
                this world. The service is fast and friendly, making it a great spot for both casual lunches and special
                dinners. Five stars all the way!</p>
              <div class="nav align-items-center">
                <button type="button" class="nav-link text-body-secondary animate-scale px-0 me-n1">
                  <i class="fi-thumbs-up fs-base animate-target me-1"></i>
                  8
            ...
            <div class="vstack gap-2 mb-sm-2">
              ...
              <p class="fs-sm mb-1">Had an amazing dinner at Sbarro! The portions are generous, and the quality is
                top-notch. The variety on the menu is great, and I loved trying something new. Their vegan options are
                some of the best I've had in town.</p>
              <div class="nav align-items-center">
                <button type="button" class="nav-link text-body-secondary animate-scale px-0 me-n1">
                  <i class="fi-thumbs-up fs-base animate-target me-1"></i>
                  27
            ...
            <div class="vstack gap-2 mb-sm-2">
              ...
              <p class="fs-sm mb-1">Sbarro was a great choice for dinner. The food was delicious, especially the pizza,
                but the service was a bit slow. That said, the staff was friendly, and the atmosphere was nice, so it
                didn't ruin the experience. Overall, I'd definitely come back.</p>
              <div class="nav align-items-center">
                <button type="button" class="nav-link text-body-secondary animate-scale px-0 me-n1">
                  <i class="fi-thumbs-up fs-base animate-target me-1"></i>
                  15
              ...
              <div class="vstack gap-4">
                ...
                <article class="hover-effect-scale position-relative d-inline-flex align-items-start mt-1 mt-sm-2">
                  <div class="position-relative flex-shrink-0 rounded overflow-hidden p-3 px-md-4">
                    ...
                    <img src="assets/img/home/city-guide/places/01.jpg"
                ...
                <article class="hover-effect-scale position-relative d-inline-flex align-items-start mt-1 mt-sm-2">
                  <div class="position-relative flex-shrink-0 rounded overflow-hidden p-3 px-md-4">
                    <div class="ratio" style="width: 64px; --fn-aspect-ratio: calc(48 / 64 * 100%)"></div>
                    <img src="assets/img/home/city-guide/places/02.jpg"
                      class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 object-fit-cover bg-body-secondary z-1"
                      alt="Image">
                  </div>
                  <div class="min-w-0 pt-1 ps-3">
                ...
                <article class="hover-effect-scale position-relative d-inline-flex align-items-start mt-1 mt-sm-2">
                  <div class="position-relative flex-shrink-0 rounded overflow-hidden p-3 px-md-4">
                    <div class="ratio" style="width: 64px; --fn-aspect-ratio: calc(48 / 64 * 100%)"></div>
                    <img src="assets/img/home/city-guide/places/03.jpg"
                      class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 object-fit-cover bg-body-secondary z-1"
                      alt="Image">
                  </div>
                  <div class="min-w-0 pt-1 ps-3">
                ...
                <article class="hover-effect-scale position-relative d-inline-flex align-items-start mt-1 mt-sm-2">
                  <div class="position-relative flex-shrink-0 rounded overflow-hidden p-3 px-md-4">
                    <div class="ratio" style="width: 64px; --fn-aspect-ratio: calc(48 / 64 * 100%)"></div>
                    <img src="assets/img/home/city-guide/places/04.jpg"
                      class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 object-fit-cover bg-body-secondary z-1"
                      alt="Image">
                  </div>
                  <div class="min-w-0 pt-1 ps-3">
      ...
      <div class="accordion row pb-5 mb-sm-2 mb-md-3 mb-lg-4" id="footerLinks">
        ...
        <div class="accordion-item col-sm-4 col-lg-3 border-0">
          <h6 class="accordion-header" id="quickLinksHeading">
            ...
            <button type="button" class="accordion-button collapsed py-3 d-sm-none" data-bs-toggle="collapse"
              data-bs-target="#quickLinks" aria-expanded="false" aria-controls="quickLinks">Quick links</button>
          </h6>
          <div class="accordion-collapse collapse d-sm-block" id="quickLinks" aria-labelledby="quickLinksHeading"
            ...
            <ul class="nav flex-column gap-2 pt-sm-1 pt-lg-2 pb-3 pb-sm-0 mt-n1 mb-1 mb-sm-0">
              ...
              <li class="pt-1">
                <a class="nav-link hover-effect-underline d-inline text-body fw-normal p-0" href="#!">Cafes &amp;
                  restaurants</a>
              </li>
              <li class="pt-1">
                <a class="nav-link hover-effect-underline d-inline text-body fw-normal p-0" href="#!">Night clubs</a>
              </li>
              <li class="pt-1">
                <a class="nav-link hover-effect-underline d-inline text-body fw-normal p-0" href="#!">Events &amp;
                  meetups</a>
              </li>
              <li class="pt-1">
                <a class="nav-link hover-effect-underline d-inline text-body fw-normal p-0" href="#!">Beauty salons</a>
              </li>
              <li class="pt-1">
                <a class="nav-link hover-effect-underline d-inline text-body fw-normal p-0" href="#!">Pharmacies</a>
              </li>
            </ul>
          </div>
        ...
        <div class="accordion-item col-sm-3 col-lg-2 col-xxl-3 border-0">
          <h6 class="accordion-header" id="profileLinksHeading">
            ...
            <button type="button" class="accordion-button collapsed py-3 d-sm-none" data-bs-toggle="collapse"
              data-bs-target="#profileLinks" aria-expanded="false" aria-controls="profileLinks">Profile</button>
          </h6>
          <div class="accordion-collapse collapse d-sm-block" id="profileLinks" aria-labelledby="profileLinksHeading"
            data-bs-parent="#footerLinks">
            <ul class="nav flex-column gap-2 pt-sm-1 pt-lg-2 pb-3 pb-sm-0 mt-n1 mb-1 mb-sm-0">
              <li class="pt-1">
              ...
              <li class="pt-1">
                <a class="nav-link hover-effect-underline d-inline text-body fw-normal p-0" href="#!">Taxes &amp;
                  fees</a>
              </li>
              <li class="pt-1">
        ...
        <div class="col-lg-4 col-xxl-3 pt-4 pt-md-5 pt-lg-0 mt-3 mt-md-0">
          ...
          <form class="d-flex flex-column flex-sm-row flex-lg-column gap-3 needs-validation" novalidate>
            <div class="position-relative w-100">
              ...
              <input type="email" class="form-control form-icon-start text-start rounded-pill" placeholder="Your email"
      ...
      <div class="border-top pt-2 pb-md-2">
        <div class="row align-items-center py-4">
          ...
          <div class="col-lg-5 col-xl-4 d-lg-flex justify-content-end">
            <p class="text-body-secondary fs-sm text-center text-lg-start mb-0">&copy; All rights reserved. Made by <a

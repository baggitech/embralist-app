...
<html lang="en" data-bs-theme="light" data-pwa="true">
  <head>
    ...
    <title>Finder Docs | Web font(s)</title>
    ...
    <div class="container pt-4">
      <div class="row pt-sm-2">
        ...
        <main class="col-lg-9 pt-1 pb-5 mb-sm-2 mb-md-3">
          ...
          <!-- Page content -->
          <section class="mb-3">
            <p class="pb-2 mb-4">This article outlines how Finder optimizes web font loading by implementing local font storage and preloading techniques. These practices are crucial for enhancing site performance and minimizing layout shifts during page load.</p>
            <h2 class="h4">Preloading local web fonts</h2>
            <p>Finder stores local fonts in the <code>assets/fonts</code> folder and preloads them in the <code>&lt;head&gt;</code> section of the HTML document to ensure they are available as soon as the page begins to render:</p>
            <div class="position-relative" data-bs-theme="dark">
              <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 me-2 px-2 z-3" data-copy-code="#preload-font-code">
...
&lt;link rel=&quot;preload&quot; href=&quot;assets/fonts/inter-variable-latin.woff2&quot; as=&quot;font&quot; type=&quot;font/woff2&quot; crossorigin&gt;</code></pre>
            ...
            <p>The preloaded fonts are then referenced in the <code>src/scss/fonts.scss</code> file, which includes necessary <code>@font-face</code> rules:</p>
...
@font-face {
  ...
  unicode-range: U+0000-00FF, U+0131, U+0152-0153, U+02BB-02BC, U+02C6, U+02DA, U+02DC, U+0304, U+0308, U+0329, U+2000-206F, U+2074, U+20AC, U+2122, U+2191, U+2193, U+2212, U+2215, U+FEFF, U+FFFD;
            ...
            <p>To use a custom font from sources like Google Fonts, follow these steps to download and integrate the font locally:</p>
            <ol class="gap-3">
              <li>
                <span class="text-body-emphasis fw-semibold">Find the font on Google Fonts:</span> Locate the necessary font on Google Fonts.
              </li>
              <li>
                <span class="text-body-emphasis fw-semibold">Obtain the embed code:</span> Click the "Get font" button, then "Get embed code". Select the font styles you need and copy the generated link.
              </li>
              <li>
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>Add references to these files in the <code>src/scss/fonts.scss</code> file, similar to the example provided above.</li>
                </ul>
              </li>
            </ol>
            <p class="mb-0"><span class="text-body-emphasis fw-semibold">Note:</span> If the selected font is not variable, you must create a separate <code>@font-face</code> rule for each <code>weight</code> and <code>style</code>, similar to the setup seen in the Google Fonts API generated link.</p>
          </section>
        </main>
      </div>
    </div>

...
<html lang="en" data-bs-theme="light" data-pwa="true">
  <head>
    ...
    <title>Finder Docs | Tooltips</title>
    ...
    <div class="container pt-4">
      <div class="row pt-sm-2">
                  ...
                  <nav class="docs-list list-group list-group-borderless" onclick="closeSidebar()">
                    ...
                    <div class="dropdown">
                      ...
                      <ul id="anchorNav" class="nav nav-underline flex-column border-start ms-2 my-2" style="gap: .25rem;">
                        <li class="nav-item"><a class="nav-link fw-normal" href="#tooltips-static">Static examples</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#tooltips-live">Live demo</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#tooltips-small">Small size</a></li>
                      </ul>
                    </div>
                    <h3 class="h6 d-flex align-items-center border-top pt-4 pb-1 mt-3 mb-2">
        ...
        <main class="col-lg-9 pt-1 pb-5 mb-sm-2 mb-md-3">
          ...
          <!-- Static examples -->
          <section id="tooltips-static" class="docs-section pb-sm-2 mb-5">
          ...
          <!-- Live demo -->
          <section id="tooltips-live" class="docs-section pb-sm-2 mb-5">
            <h4>Live demo</h4>
            <div class="card border-0 shadow">
              <span class="d-none d-block-dark position-absolute top-0 start-0 w-100 h-100 bg-dark rounded opacity-50"></span>
              <div class="card-body position-relative z-2">
...
&lt;/button&gt;</code></pre>
          ...
          <!-- Small size -->
          <section id="tooltips-small" class="docs-section">
            <h4>Small size</h4>
            <div class="card border-0 shadow">
              <span class="d-none d-block-dark position-absolute top-0 start-0 w-100 h-100 bg-dark rounded opacity-50"></span>
              <div class="card-body position-relative z-2">

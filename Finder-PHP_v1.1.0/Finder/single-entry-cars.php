...
<head>
  <?php $title = "Cars - Car Details Page"; include('partials/title-meta.php'); ?>
  ...
  <main class="content-wrapper">
    ...
    <section class="container pt-4 pb-5 mb-xxl-3">
      ...
      <nav class="pb-2" aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="listings-grid-cars.php">Used cars</a></li>
      ...
      <div class="row">
        ...
        <div class="col-lg-8 pb-3 pb-sm-0 mb-4 mb-sm-5 mb-lg-0">
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide swiper-thumb overflow-hidden">
                <div class="ratio bg-body-tertiary" style="--fn-aspect-ratio: calc(115 / 156 * 100%)">
                  <img src="assets/img/listings/cars/single/gallery/th01.jpg" class="swiper-thumb-img" alt="Thumbnail">
                </div>
              </div>
              <div class="swiper-slide swiper-thumb overflow-hidden">
                <div class="ratio bg-body-tertiary" style="--fn-aspect-ratio: calc(115 / 156 * 100%)">
                  <img src="assets/img/listings/cars/single/gallery/th02.jpg" class="swiper-thumb-img" alt="Thumbnail">
                </div>
              </div>
              <div class="swiper-slide swiper-thumb overflow-hidden">
                <div class="ratio bg-body-tertiary" style="--fn-aspect-ratio: calc(115 / 156 * 100%)">
                  <img src="assets/img/listings/cars/single/gallery/th03.jpg" class="swiper-thumb-img" alt="Thumbnail">
                </div>
              </div>
              <div class="swiper-slide swiper-thumb overflow-hidden">
                <div class="ratio bg-body-tertiary" style="--fn-aspect-ratio: calc(115 / 156 * 100%)">
                  <img src="assets/img/listings/cars/single/gallery/th04.jpg" class="swiper-thumb-img" alt="Thumbnail">
                </div>
              </div>
              <div class="swiper-slide swiper-thumb overflow-hidden">
                <div class="ratio bg-body-tertiary" style="--fn-aspect-ratio: calc(115 / 156 * 100%)">
                  <img src="assets/img/listings/cars/single/gallery/th05.jpg" class="swiper-thumb-img" alt="Thumbnail">
                </div>
              </div>
              <div class="swiper-slide swiper-thumb overflow-hidden">
                <div class="ratio bg-body-tertiary" style="--fn-aspect-ratio: calc(115 / 156 * 100%)">
                  <img src="assets/img/listings/cars/single/gallery/th06.jpg" class="swiper-thumb-img" alt="Thumbnail">
                </div>
              </div>
              <div class="swiper-slide swiper-thumb overflow-hidden">
                <div class="ratio bg-body-tertiary" style="--fn-aspect-ratio: calc(115 / 156 * 100%)">
                  <img src="assets/img/listings/cars/single/gallery/th07.jpg" class="swiper-thumb-img" alt="Thumbnail">
                </div>
              </div>
              <div class="swiper-slide swiper-thumb overflow-hidden">
                <div class="ratio bg-body-tertiary" style="--fn-aspect-ratio: calc(115 / 156 * 100%)">
                  <img src="assets/img/listings/cars/single/gallery/th08.jpg" class="swiper-thumb-img" alt="Thumbnail">
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="col">
              <ul class="list-unstyled text-body-secondary mt-n1 mb-0">
                ...
                <li class="mt-1">
                  ...
                  60K miles
                  <i class="fi-alert-circle fs-lg text-primary align-middle ms-2" data-bs-toggle="tooltip"
                    title="Verified by seller"></i>
                </li>
                <li class="mt-1">
            ...
            <div class="row row-cols-2 row-cols-md-4 g-3 gx-xl-4">
              <div class="col">
                <div class="card h-100 bg-info-subtle border-0 py-xl-2">
                  <div class="card-body">
                    <svg class="text-info" xmlns="http://www.w3.org/2000/svg" width="48" viewBox="0 0 48 48" fill="none"
                      stroke="currentColor" stroke-width="1.9" stroke-miterlimit="10" stroke-linejoin="round">
                      <path d="M19.031 24.413l3.55 3.549 7.099-7.099" stroke-linecap="round" />
                      <path
              ...
              <div class="col">
                <div class="card h-100 bg-info-subtle border-0 py-xl-2">
                  <div class="card-body">
                    <svg class="text-info" xmlns="http://www.w3.org/2000/svg" width="48" viewBox="0 0 48 48" fill="none"
                      stroke="currentColor" stroke-width="1.7" stroke-miterlimit="10" stroke-linejoin="round">
                      <path
                  ...
                  <div class="card-body">
                    <svg class="text-info" xmlns="http://www.w3.org/2000/svg" width="48" viewBox="0 0 48 48" fill="none"
                      ...
                      <g stroke-linecap="round">
                        <path d="M1 9.154l5.653.269v10.811L1 19.606" />
                        <path d="M1 19.606l5.653.629-2.234 13.412L1 33.304" />
                        <path d="M1 19.606l5.653.629v-7.164L1 12.761" />
                      </g>
                    </svg>
          ...
          <div class="accordion accordion-alt-icon" id="features">
            ...
            <div class="accordion-item">
              <h3 class="accordion-header" id="headingInterior">
                <button type="button" class="accordion-button fs-5" data-bs-toggle="collapse" data-bs-target="#interior"
                  aria-expanded="true" aria-controls="interior">
                  <span class="hover-effect-underline stretched-link me-2">Interior</span>
                </button>
              </h3>
              <div class="accordion-collapse collapse show" id="interior" aria-labelledby="headingInterior"
                data-bs-parent="#features">
                <div class="accordion-body fs-base">
                  <div class="row row-cols-1 row-cols-sm-2 gy-2">
                    <div class="col">
          ...
          <p>This stunning convertible blends luxury with performance, featuring a sleek design, advanced technology,
            and a powerful engine. Enjoy open-air driving with premium comfort and the unmistakable elegance of
            Mercedes-Benz. Impeccably maintained and ready to provide an exhilarating driving experience. Don't miss out
            on this exceptional vehicle.</p>
          <div class="collapse" id="moreDescription">
            <p>This A205 Cabriolet comes equipped with top-of-the-line features, including a responsive infotainment
              system, advanced safety options, and a finely crafted interior that showcases Mercedes-Benz's commitment
              to quality. The soft-top roof operates seamlessly, allowing you to transition from a cozy cabin to an
              open-air cruiser in seconds. Whether you're navigating city streets or cruising along the coast, this
              cabriolet delivers a smooth, refined ride every time.</p>
            <p>With low mileage and a full service history, this 2021 model remains in excellent condition, both
              mechanically and aesthetically. The exterior shines in pristine condition, and the interior has been
              meticulously cared for, ensuring a like-new experience. This Mercedes-Benz A205 Cabriolet is the perfect
              choice for those who desire a blend of sophistication, comfort, and thrilling performance in their next
              vehicle.</p>
          </div>
          <div class="nav">
            <a class="nav-link position-relative px-0 collapsed" href="#moreDescription" data-bs-toggle="collapse"
              aria-expanded="false" aria-controls="moreDescription" aria-label="Show / hide services">
            ...
            <div class="card p-sm-2 p-lg-0 p-xl-2">
              <div class="card-body">
                ...
                <div class="form-check">
                  ...
                  <label class="form-check-label fs-xs" for="concent">I agree to receive price drop alerts on this
                    vehicle and helpful shopping information.</label>
                </div>
              </div>
            </div>
          </div>
    ...
    <section class="container py-2 py-sm-3 py-md-4 py-lg-5 my-xxl-3">
      <div class="d-flex align-items-start justify-content-between gap-4 pb-3 mb-2 mb-sm-3">
        ...
        <div class="nav">
          <a class="nav-link position-relative text-nowrap py-1 px-0" href="listings-grid-cars.php">
              ...
              <div class="card-body pb-3">
                <div class="d-flex align-items-center justify-content-between mb-2">
                  ...
                  <div class="d-flex gap-2 position-relative z-2">
                    <button type="button" class="btn btn-icon btn-sm btn-outline-secondary animate-pulse rounded-circle"
                      data-bs-toggle="tooltip" data-bs-custom-class="tooltip-sm" title="Wishlist"
                      aria-label="Add to wishlist">
                      <i class="fi-heart animate-target fs-sm"></i>
                    </button>
                    <button type="button" class="btn btn-icon btn-sm btn-outline-secondary animate-shake rounded-circle"
          ...
          <div class="swiper-slide h-auto">
            <article class="card h-100 hover-effect-scale bg-body-tertiary border-0">
              ...
              <div class="card-body pb-3">
                ...
                <h3 class="h6 mb-2">
                  <a class="hover-effect-underline stretched-link me-1" href="single-entry-cars.php">Porsche 911 Turbo
                    S</a>
          ...
          <div class="swiper-slide h-auto">
            <article class="card h-100 hover-effect-scale bg-body-tertiary border-0">
              ...
              <div class="card-body pb-3">
                ...
                <h3 class="h6 mb-2">
                  <a class="hover-effect-underline stretched-link me-1" href="single-entry-cars.php">Tesla Model 3</a>
                  <span class="fs-xs fw-normal text-body-secondary">(2024)</span>
                </h3>

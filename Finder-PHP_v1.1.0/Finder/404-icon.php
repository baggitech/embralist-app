...
<head>
  ...
  <?php $title = "Finder | 404 Error - Icon Image (Cars)";
...
<body class="bg-body-tertiary">
  ...
  <!-- Page content -->
  <main class="content-wrapper container position-relative d-flex flex-column justify-content-center z-1 pt-4 pb-2 py-lg-5 mt-3 mt-sm-4 mt-lg-0 mt-xl-2">
    <div class="row justify-content-center">
      <div class="col-sm-11 col-md-9 col-lg-7 col-xl-6">
        <div class="ratio mx-auto" style="max-width: 196px; --fn-aspect-ratio: calc(126 / 196 * 100%)">
          <img src="assets/img/404/traffic-cones.png" alt="Traffic cones">
        </div>
        <h1 class="h2 text-center pt-4 pt-md-5 mt-1 mt-sm-2 mt-md-0 mb-4">Sorry, we can't find that page</h1>
        <div class="bg-body border rounded shadow p-2">
          <form class="d-flex flex-column flex-sm-row gap-2 gap-sm-0 p-1">
            <div class="d-flex align-items-center w-100 ms-2">
              ...
              <input type="search" class="form-control form-control-lg border-0" placeholder="What are you looking for?" required>
            </div>
            <button type="submit" class="btn btn-lg btn-dark">Search</button>
          </form>
        </div>
        <div class="vstack gap-4 pt-4 pt-md-5 mt-2 mt-sm-3 mt-md-0">
          <div class="position-relative d-flex">
            <div class="d-flex align-items-center justify-content-center flex-shrink-0 bg-body border rounded" style="width: 52px; height: 52px">
              <i class="fi-copy fs-xl text-dark-emphasis"></i>
            </div>
            <div class="ps-3">
              <div class="d-flex align-items-center mb-1">
                <a class="hover-effect-underline stretched-link fw-semibold text-dark-emphasis text-decoration-none" href="#!">Over 1 million listings</a>
                <i class="fi-chevron-right fs-lg ms-1" style="margin-top: 2px"></i>
              </div>
              <p class="fs-sm mb-0">Finder is a leading digital marketplace for the automotive industry.</p>
            </div>
          </div>
          <div class="position-relative d-flex">
            <div class="d-flex align-items-center justify-content-center flex-shrink-0 bg-body border rounded" style="width: 52px; height: 52px">
              <i class="fi-car fs-xl text-dark-emphasis"></i>
            </div>
            <div class="ps-3">
              <div class="d-flex align-items-center mb-1">
                <a class="hover-effect-underline stretched-link fw-semibold text-dark-emphasis text-decoration-none" href="#!">Online car appraisal</a>
                <i class="fi-chevron-right fs-lg ms-1" style="margin-top: 2px"></i>
              </div>
              <p class="fs-sm mb-0">Compare the price and quality of the car and make the right choice.</p>
            </div>
          </div>
          <div class="position-relative d-flex">
            <div class="d-flex align-items-center justify-content-center flex-shrink-0 bg-body border rounded" style="width: 52px; height: 52px">
              <i class="fi-help-circle fs-xl text-dark-emphasis"></i>
            </div>
            <div class="ps-3">
              <div class="d-flex align-items-center mb-1">
                <a class="hover-effect-underline stretched-link fw-semibold text-dark-emphasis text-decoration-none" href="#!">Help and support</a>
                <i class="fi-chevron-right fs-lg ms-1" style="margin-top: 2px"></i>
              </div>
              <p class="fs-sm mb-0">Our friendly team here to help with all you questions.</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <!-- Page footer -->
  <footer class="footer position-relative z-1 pt-5 pb-4">

...
<head>
  <?php $title = "Blog Layout v.3"; include('partials/title-meta.php'); ?>
...
<body>
  ...
  <main class="content-wrapper">
    ...
    <section class="position-relative bg-info py-5">
      <div class="container position-relative z-2 py-4 py-sm-5 my-xl-4 my-xxl-5">
        <div class="row py-md-2 py-lg-5 my-xxl-1">
          <div class="col-sm-8 col-md-5">
            <h2 class="text-white pb-2 pb-sm-3">DIY guide to fixing common power tool issues</h2>
      ...
      <div class="row position-absolute top-0 end-0 w-100 h-100 justify-content-end g-0">
        <div class="col-md-6 position-relative">
          <img src="assets/img/blog/v3/featured.jpg" class="position-absolute top-0 end-0 w-100 h-100 object-fit-cover"
            alt="Image">
        </div>
    ...
    <!-- Selected articles -->
    <section class="container py-5 mt-2 mt-md-3 mt-lg-4 mt-xl-5">
      <div class="row gy-5">
        ...
        <div class="col-md-6 col-lg-4">
          <div class="vstack gap-4">
            <h3 class="h5 mb-0">
              <a class="position-relative d-inline-flex align-items-center" href="#!">
                <span class="hover-effect-underline stretched-link">Most read</span>
                <i class="fi-chevron-right fs-xl ms-2"></i>
              </a>
            </h3>
            <article class="d-flex align-items-center gap-3 pe-xl-4 me-md-2">
              <a class="ratio ratio-1x1 d-flex flex-shrink-0 hover-effect-scale rounded-2 overflow-hidden" href="#!"
                style="width: 96px">
                <img src="assets/img/blog/v3/th01.jpg" class="hover-effect-target" alt="Image">
              </a>
              <div>
                <h3 class="h6 pb-1 mb-2">
                  <a class="hover-effect-underline" href="#!">Serving up storage in kitchen renovations</a>
                </h3>
                <div class="fs-xs text-body-secondary">September 28, 2024</div>
              </div>
            </article>
            <article class="d-flex align-items-center gap-3 pe-xl-4 me-md-2">
              <a class="ratio ratio-1x1 d-flex flex-shrink-0 hover-effect-scale rounded-2 overflow-hidden" href="#!"
              ...
              <div>
                ...
                <div class="fs-xs text-body-secondary">August 17, 2024</div>
              </div>
            </article>
            <article class="d-flex align-items-center gap-3 pe-xl-4 me-md-2">
              <a class="ratio ratio-1x1 d-flex flex-shrink-0 hover-effect-scale rounded-2 overflow-hidden" href="#!"
                style="width: 96px">
                <img src="assets/img/blog/v3/th03.jpg" class="hover-effect-target" alt="Image">
              </a>
              <div>
                <h3 class="h6 pb-1 mb-2">
                  <a class="hover-effect-underline" href="#!">How to make your kitchen ready for hosting</a>
                </h3>
                <div class="fs-xs text-body-secondary">July 23, 2024</div>
              </div>
            </article>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="vstack gap-4">
            <h3 class="h5 mb-0">
              <a class="position-relative d-inline-flex align-items-center" href="#!">
                <span class="hover-effect-underline stretched-link">Recommended</span>
                <i class="fi-chevron-right fs-xl ms-2"></i>
              </a>
            </h3>
            <article class="d-flex align-items-center gap-3 pe-xl-4 me-md-2">
              <a class="ratio ratio-1x1 d-flex flex-shrink-0 hover-effect-scale rounded-2 overflow-hidden" href="#!"
                style="width: 96px">
                <img src="assets/img/blog/v3/th04.jpg" class="hover-effect-target" alt="Image">
              </a>
              <div>
                <h3 class="h6 pb-1 mb-2">
                  <a class="hover-effect-underline" href="#!">Unlocking your dream bathroom</a>
                </h3>
                <div class="fs-xs text-body-secondary">October 30, 2024</div>
              </div>
            </article>
            <article class="d-flex align-items-center gap-3 pe-xl-4 me-md-2">
              <a class="ratio ratio-1x1 d-flex flex-shrink-0 hover-effect-scale rounded-2 overflow-hidden" href="#!"
                style="width: 96px">
                <img src="assets/img/blog/v3/th05.jpg" class="hover-effect-target" alt="Image">
              </a>
              <div>
                <h3 class="h6 pb-1 mb-2">
                  <a class="hover-effect-underline" href="#!">Winter home renovation projects on a budget</a>
                </h3>
                <div class="fs-xs text-body-secondary">September 15, 2024</div>
              </div>
            </article>
            <article class="d-flex align-items-center gap-3 pe-xl-4 me-md-2">
              <a class="ratio ratio-1x1 d-flex flex-shrink-0 hover-effect-scale rounded-2 overflow-hidden" href="#!"
                style="width: 96px">
                <img src="assets/img/blog/v3/th06.jpg" class="hover-effect-target" alt="Image">
              </a>
              <div>
                <h3 class="h6 pb-1 mb-2">
                  <a class="hover-effect-underline" href="#!">Gardening tips for spring 2024</a>
                </h3>
                <div class="fs-xs text-body-secondary">August 09, 2024</div>
              </div>
            </article>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="vstack gap-4">
            <h3 class="h5 mb-0">
              <a class="position-relative d-inline-flex align-items-center" href="#!">
                <span class="hover-effect-underline stretched-link">Useful</span>
                <i class="fi-chevron-right fs-xl ms-2"></i>
              </a>
            </h3>
            <article class="d-flex align-items-center gap-3 pe-xl-4 me-md-2">
              <a class="ratio ratio-1x1 d-flex flex-shrink-0 hover-effect-scale rounded-2 overflow-hidden" href="#!"
                style="width: 96px">
                <img src="assets/img/blog/v3/th07.jpg" class="hover-effect-target" alt="Image">
              </a>
              <div>
                <h3 class="h6 pb-1 mb-2">
                  <a class="hover-effect-underline" href="#!">3 Reasons to update your flooring this winter</a>
                </h3>
                <div class="fs-xs text-body-secondary">August 26, 2024</div>
              </div>
            </article>
            <article class="d-flex align-items-center gap-3 pe-xl-4 me-md-2">
              <a class="ratio ratio-1x1 d-flex flex-shrink-0 hover-effect-scale rounded-2 overflow-hidden" href="#!"
                style="width: 96px">
                <img src="assets/img/blog/v3/th08.jpg" class="hover-effect-target" alt="Image">
              </a>
              <div>
                <h3 class="h6 pb-1 mb-2">
                  <a class="hover-effect-underline" href="#!">Boosting home safety: the latest in smart security</a>
                </h3>
                <div class="fs-xs text-body-secondary">July 19, 2024</div>
              </div>
            </article>
            <article class="d-flex align-items-center gap-3 pe-xl-4 me-md-2">
              <a class="ratio ratio-1x1 d-flex flex-shrink-0 hover-effect-scale rounded-2 overflow-hidden" href="#!"
                style="width: 96px">
                <img src="assets/img/blog/v3/th09.jpg" class="hover-effect-target" alt="Image">
              </a>
              <div>
                <h3 class="h6 pb-1 mb-2">
                  <a class="hover-effect-underline" href="#!">20 professional tips for fencing installers</a>
                </h3>
                <div class="fs-xs text-body-secondary">June 12, 2024</div>
              </div>
            </article>
          </div>
        </div>
    ...
    <section class="container py-2 py-sm-3 py-md-4 py-lg-5 my-xxl-3">
      ...
      <!-- Heading + Categories select + Sorting select -->
      <div class="d-md-flex align-items-center justify-content-between pb-3 mb-2 mb-sm-3">
        <h2 class="mb-md-0">Recent posts</h2>
        <div class="d-flex gap-3 gap-sm-4 ms-n2 ms-sm-n3 ms-md-0">
          <div style="width: 205px">
            <select class="form-select border-0 rounded-0 pe-0" data-select='{
                "removeItemButton": false,
                "classNames": {
                  "containerInner": ["form-select", "border-0", "rounded-0", "pe-0"]
                }
              }'>
              ...
              <option value="Renovation trends">Renovation trends</option>
            </select>
          </div>
          <div class="position-relative" style="width: 125px">
            <i class="fi-sort position-absolute top-50 start-0 translate-middle-y z-2"></i>
            <select class="form-select border-0 rounded-0 ps-4 pe-0" data-select='{
                "removeItemButton": false,
                "classNames": {
                  "containerInner": ["form-select", "border-0", "rounded-0", "ps-4", "pe-0"]
                }
              }'>
      ...
      <!-- Posts grid -->
      <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 gy-4 gx-sm-3 g-md-4">
        ...
        <div class="col mb-md-2">
          <article class="position-relative hover-effect-scale rounded overflow-hidden">
            <div class="ratio hover-effect-target" style="--fn-aspect-ratio: calc(280 / 416 * 100%)">
              <img src="assets/img/blog/v3/01.jpg" alt="Image">
            </div>
            <span class="position-absolute bottom-0 start-0 w-100 h-100"
              style="background: linear-gradient(1deg, rgba(33, 42, 54, .75) 0.33%, rgba(33, 42, 54, .00) 45.72%)"></span>
            <div class="d-flex align-items-end position-absolute bottom-0 start-0 w-100 h-100 z-2 p-3">
              <h3 class="h5 mb-0">
                <a class="hover-effect-underline stretched-link text-white" href="#!">5 Ways to incorporate a stainless
                  bench in your interior decor</a>
              </h3>
            </div>
          </article>
        </div>
        ...
        <div class="col mb-md-2">
          <article class="position-relative hover-effect-scale rounded overflow-hidden">
            <div class="ratio hover-effect-target" style="--fn-aspect-ratio: calc(280 / 416 * 100%)">
              <img src="assets/img/blog/v3/02.jpg" alt="Image">
            </div>
            <span class="position-absolute bottom-0 start-0 w-100 h-100"
              style="background: linear-gradient(1deg, rgba(33, 42, 54, .75) 0.33%, rgba(33, 42, 54, .00) 45.72%)"></span>
            <div class="d-flex align-items-end position-absolute bottom-0 start-0 w-100 h-100 z-2 p-3">
              <h3 class="h5 mb-0">
                <a class="hover-effect-underline stretched-link text-white" href="#!">Choosing the right asbestos
                  removal company</a>
              </h3>
            </div>
          </article>
        ...
        <div class="col mb-md-2">
          <article class="position-relative hover-effect-scale rounded overflow-hidden">
            ...
            <div class="d-flex align-items-end position-absolute bottom-0 start-0 w-100 h-100 z-2 p-3">
              <h3 class="h5 mb-0">
                <a class="hover-effect-underline stretched-link text-white" href="#!">Best features to ask your luxury
                  home builder about</a>
              </h3>
            </div>
          </article>
        </div>
        ...
        <div class="col mb-md-2">
          <article class="position-relative hover-effect-scale rounded overflow-hidden">
            <div class="ratio hover-effect-target" style="--fn-aspect-ratio: calc(280 / 416 * 100%)">
              <img src="assets/img/blog/v3/04.jpg" alt="Image">
            </div>
            <span class="position-absolute bottom-0 start-0 w-100 h-100"
              style="background: linear-gradient(1deg, rgba(33, 42, 54, .75) 0.33%, rgba(33, 42, 54, .00) 45.72%)"></span>
            <div class="d-flex align-items-end position-absolute bottom-0 start-0 w-100 h-100 z-2 p-3">
              <h3 class="h5 mb-0">
                <a class="hover-effect-underline stretched-link text-white" href="#!">Proactive roof care: 4 steps to
                  ensure long-term durability</a>
              </h3>
            </div>
          </article>
        </div>
        ...
        <div class="col mb-md-2">
          <article class="position-relative hover-effect-scale rounded overflow-hidden">
            <div class="ratio hover-effect-target" style="--fn-aspect-ratio: calc(280 / 416 * 100%)">
              <img src="assets/img/blog/v3/05.jpg" alt="Image">
            </div>
            <span class="position-absolute bottom-0 start-0 w-100 h-100"
              style="background: linear-gradient(1deg, rgba(33, 42, 54, .75) 0.33%, rgba(33, 42, 54, .00) 45.72%)"></span>
            <div class="d-flex align-items-end position-absolute bottom-0 start-0 w-100 h-100 z-2 p-3">
              <h3 class="h5 mb-0">
                <a class="hover-effect-underline stretched-link text-white" href="#!">Benefits of having a wine cellar
                  at home</a>
              </h3>
            </div>
          </article>
        ...
        <div class="col mb-md-2">
          <article class="position-relative hover-effect-scale rounded overflow-hidden">
            <div class="ratio hover-effect-target" style=" --fn-aspect-ratio: calc(280 / 416 * 100%)">
              <img src="assets/img/blog/v3/06.jpg" alt="Image">
            </div>
            <span class="position-absolute bottom-0 start-0 w-100 h-100"
              style="background: linear-gradient(1deg, rgba(33, 42, 54, .75) 0.33%, rgba(33, 42, 54, .00) 45.72%)"></span>
            <div class="d-flex align-items-end position-absolute bottom-0 start-0 w-100 h-100 z-2 p-3">
              <h3 class="h5 mb-0">
                <a class="hover-effect-underline stretched-link text-white" href="#!">Developing your roof maintenance
                  checklist</a>
              </h3>
            </div>
          </article>
        ...
        <div class="col mb-md-2">
          <article class="position-relative hover-effect-scale rounded overflow-hidden">
            <div class="ratio hover-effect-target" style="--fn-aspect-ratio: calc(280 / 416 * 100%)">
              <img src="assets/img/blog/v3/07.jpg" alt="Image">
            </div>
            <span class="position-absolute bottom-0 start-0 w-100 h-100"
              style="background: linear-gradient(1deg, rgba(33, 42, 54, .75) 0.33%, rgba(33, 42, 54, .00) 45.72%)"></span>
            <div class="d-flex align-items-end position-absolute bottom-0 start-0 w-100 h-100 z-2 p-3">
              <h3 class="h5 mb-0">
                <a class="hover-effect-underline stretched-link text-white" href="#!">Extend the lifespan of your heater
        ...
        <div class="col mb-md-2">
          <article class="position-relative hover-effect-scale rounded overflow-hidden">
            <div class="ratio hover-effect-target" style="--fn-aspect-ratio: calc(280 / 416 * 100%)">
              <img src="assets/img/blog/v3/08.jpg" alt="Image">
            </div>
            <span class="position-absolute bottom-0 start-0 w-100 h-100"
              style="background: linear-gradient(1deg, rgba(33, 42, 54, .75) 0.33%, rgba(33, 42, 54, .00) 45.72%)"></span>
            <div class="d-flex align-items-end position-absolute bottom-0 start-0 w-100 h-100 z-2 p-3">
              <h3 class="h5 mb-0">
                <a class="hover-effect-underline stretched-link text-white" href="#!">Why you should hire professionals
                  to clean your gutters</a>
              </h3>
            </div>
          </article>
        </div>
        ...
        <div class="col mb-md-2">
          <article class="position-relative hover-effect-scale rounded overflow-hidden">
            <div class="ratio hover-effect-target" style="--fn-aspect-ratio: calc(280 / 416 * 100%)">
              <img src="assets/img/blog/v3/09.jpg" alt="Image">
            </div>
            <span class="position-absolute bottom-0 start-0 w-100 h-100"
              style="background: linear-gradient(1deg, rgba(33, 42, 54, .75) 0.33%, rgba(33, 42, 54, .00) 45.72%)"></span>
            <div class="d-flex align-items-end position-absolute bottom-0 start-0 w-100 h-100 z-2 p-3">
              <h3 class="h5 mb-0">
                <a class="hover-effect-underline stretched-link text-white" href="#!">20 professional tips for fencing
                  installers</a>
              </h3>
            </div>
          </article>
        ...
        <div class="col mb-md-2">
          <article class="position-relative hover-effect-scale rounded overflow-hidden">
            <div class="ratio hover-effect-target" style="--fn-aspect-ratio: calc(280 / 416 * 100%)">
              <img src="assets/img/blog/v3/10.jpg" alt="Image">
            </div>
            <span class="position-absolute bottom-0 start-0 w-100 h-100"
              style="background: linear-gradient(1deg, rgba(33, 42, 54, .75) 0.33%, rgba(33, 42, 54, .00) 45.72%)"></span>
            <div class="d-flex align-items-end position-absolute bottom-0 start-0 w-100 h-100 z-2 p-3">
              <h3 class="h5 mb-0">
                <a class="hover-effect-underline stretched-link text-white" href="#!">Boosting home safety: the latest
                  in smart security</a>
              </h3>
            </div>
          </article>
        ...
        <div class="col mb-md-2">
          <article class="position-relative hover-effect-scale rounded overflow-hidden">
            <div class="ratio hover-effect-target" style="--fn-aspect-ratio: calc(280 / 416 * 100%)">
              <img src="assets/img/blog/v3/11.jpg" alt="Image">
            </div>
            <span class="position-absolute bottom-0 start-0 w-100 h-100"
              style="background: linear-gradient(1deg, rgba(33, 42, 54, .75) 0.33%, rgba(33, 42, 54, .00) 45.72%)"></span>
            <div class="d-flex align-items-end position-absolute bottom-0 start-0 w-100 h-100 z-2 p-3">
              <h3 class="h5 mb-0">
                <a class="hover-effect-underline stretched-link text-white" href="#!">How to choose the best company for
                  installing your HVAC</a>
              </h3>
            </div>
          </article>
        </div>
        ...
        <div class="col mb-md-2">
          <article class="position-relative hover-effect-scale rounded overflow-hidden">
            <div class="ratio hover-effect-target" style="--fn-aspect-ratio: calc(280 / 416 * 100%)">
              <img src="assets/img/blog/v3/12.jpg" alt="Image">
            </div>
            <span class="position-absolute bottom-0 start-0 w-100 h-100"
              style="background: linear-gradient(1deg, rgba(33, 42, 54, .75) 0.33%, rgba(33, 42, 54, .00) 45.72%)"></span>
            <div class="d-flex align-items-end position-absolute bottom-0 start-0 w-100 h-100 z-2 p-3">
              <h3 class="h5 mb-0">
                <a class="hover-effect-underline stretched-link text-white" href="#!">Unlocking your dream bathroom</a>
              </h3>
            </div>
          </article>
        </div>
    ...
    <section class="container py-5 mt-md-n2 mb-xxl-3">
      <div class="bg-primary-subtle rounded mb-2 mb-sm-3 mb-md-4 mb-lg-5">

...
<head>
  <?php $title = "Cars - Homepage"; include('partials/title-meta.php'); ?>
...
<body>
  ...
  <main class="content-wrapper">
    ...
    <section class="position-relative bg-info overflow-hidden py-5">
      <div class="container position-relative z-2 pb-2 py-sm-3 py-md-4 py-lg-5 my-lg-3 my-xl-4 my-xxl-5">
        <div class="row align-items-center pt-lg-2 pb-lg-3 pb-xl-4 pb-xxl-5">
          ...
          <div class="col-lg-4 order-lg-2 text-center text-lg-start pb-2 pb-sm-3 pb-md-0 mb-4 mb-md-5 mb-lg-0">
            ...
            <div class="d-flex align-items-center justify-content-center justify-content-lg-start" data-bs-theme="dark">
          ...
          <div class="col-lg-8 order-lg-1">
              ...
              <form class="p-sm-2" data-bs-theme="light">
                ...
                <div class="row row-cols-1 row-cols-md-2 g-3">
                  <div class="col d-flex flex-column gap-3">
                    ...
                    <select class="form-select" data-select aria-label="Car body type select" data-bs-theme="light">
                  ...
                  <div class="col d-flex flex-column gap-3">
                    <select class="form-select" data-select='{"searchEnabled": true}' aria-label="Car location select"
                      data-bs-theme="light">
                    ...
                    <div class="input-group">
                      <div class="w-50">
                        <select class="form-select rounded-end-0" data-select='{
                            "classNames": {
                      ...
                      <div class="w-50">
                        <select class="form-select rounded-start-0" data-select='{
                            "classNames": {
                    ...
                    <div class="input-group flex-nowrap" data-bs-theme="light">
                      <div class="position-relative w-100">
                        ...
                        <input type="text" class="form-control form-icon-start rounded-end-0" placeholder="Price from"
                          data-input-format='{"numeral": true}' data-bs-theme="light">
                      </div>
                      <div class="position-relative w-100">
                        <i
                          class="fi-dollar-sign position-absolute top-50 start-0 translate-middle-y text-body ms-3"></i>
                        <input type="text" class="form-control form-icon-start rounded-start-0" placeholder="Price to"
                          data-input-format='{"numeral": true}' data-bs-theme="light">
                      </div>
                    </div>
                  </div>
            ...
            <div data-bs-theme="dark">
              <p class="text-body text-center text-md-start mb-0">Finder is a <span class="fw-semibold">leading digital
      ...
      <div
        ...
        <div class="d-flex justify-content-xl-end position-relative bg-info mb-n5 mb-xxl-4" style="width: 2039px">
          <img class="position-absolute top-0 rtl-flip" src="assets/img/home/cars/hero/layer01.png" width="1308"
            style="right: 0; opacity: .2; mix-blend-mode: overlay" alt="Image">
          ...
          <img class="position-absolute top-0 rtl-flip" src="assets/img/home/cars/hero/layer03.png" width="1132"
            style="left: 0; opacity: .06; mix-blend-mode: overlay" alt="Image">
        </div>
      </div>
    </section>
            ...
            <article class="card w-100 hover-effect-scale bg-body-tertiary border-0">
              <div class="card-body text-center px-3">
                ...
                <h3 class="h6 pt-3 mb-1">
                  <a class="hover-effect-underline stretched-link" href="listings-grid-cars.php">Sedan</a>
                </h3>
          ...
          <div class="swiper-slide">
            <article class="card w-100 hover-effect-scale bg-body-tertiary border-0">
              <div class="card-body text-center px-3">
                ...
                <h3 class="h6 pt-3 mb-1">
                  <a class="hover-effect-underline stretched-link" href="listings-grid-cars.php">Coupe</a>
                </h3>
          ...
          <div class="swiper-slide">
            <article class="card w-100 hover-effect-scale bg-body-tertiary border-0">
              <div class="card-body text-center px-3">
                ...
                <h3 class="h6 pt-3 mb-1">
                  <a class="hover-effect-underline stretched-link" href="listings-grid-cars.php">Convertible</a>
                </h3>
          ...
          <div class="swiper-slide">
            <article class="card w-100 hover-effect-scale bg-body-tertiary border-0">
              <div class="card-body text-center px-3">
                ...
                <h3 class="h6 pt-3 mb-1">
                  <a class="hover-effect-underline stretched-link" href="listings-grid-cars.php">SUV</a>
                </h3>
          ...
          <div class="swiper-slide">
            <article class="card w-100 hover-effect-scale bg-body-tertiary border-0">
              <div class="card-body text-center px-3">
                ...
                <h3 class="h6 pt-3 mb-1">
                  <a class="hover-effect-underline stretched-link" href="listings-grid-cars.php">Family MPV</a>
                </h3>
          ...
          <div class="swiper-slide">
            <article class="card w-100 hover-effect-scale bg-body-tertiary border-0">
              <div class="card-body text-center px-3">
                ...
                <h3 class="h6 pt-3 mb-1">
                  <a class="hover-effect-underline stretched-link" href="listings-grid-cars.php">Pickup</a>
                </h3>
    ...
    <section class="container pt-2 pt-sm-3 pt-md-4 pt-lg-5 pb-5 my-xxl-3">
      ...
      <div class="swiper pt-1 pt-sm-2 py-lg-2 py-xl-3" data-swiper='{
          "slidesPerView": 3,
          "spaceBetween": 0,
          "pagination": {
            "el": ".swiper-pagination",
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide nav">
            <a class="nav-link p-0" href="listings-grid-cars.php" data-bs-toggle="tooltip" title="Mercedes-Benz"
          ...
          <!-- Logo -->
          <div class="swiper-slide nav">
            <a class="nav-link p-0" href="listings-grid-cars.php" data-bs-toggle="tooltip" title="Opel"
              aria-label="Opel">
              <svg xmlns="http://www.w3.org/2000/svg" width="141" viewBox="0 0 141 64" fill="currentColor">
                <path
          ...
          <!-- Logo -->
          <div class="swiper-slide nav">
            <a class="nav-link p-0" href="listings-grid-cars.php" data-bs-toggle="tooltip" title="Volkswagen"
          ...
          <!-- Logo -->
          <div class="swiper-slide nav">
            <a class="nav-link p-0" href="listings-grid-cars.php" data-bs-toggle="tooltip" title="Toyota"
              aria-label="Toyota">
              <svg xmlns="http://www.w3.org/2000/svg" width="141" viewBox="0 0 141 64" fill="currentColor">
                <path
          ...
          <!-- Logo -->
          <div class="swiper-slide nav">
            <a class="nav-link p-0" href="listings-grid-cars.php" data-bs-toggle="tooltip" title="Citroen"
              aria-label="Citroen">
              <svg xmlns="http://www.w3.org/2000/svg" width="141" viewBox="0 0 141 64" fill="currentColor">
                <path
          ...
          <!-- Logo -->
          <div class="swiper-slide nav">
            <a class="nav-link p-0" href="listings-grid-cars.php" data-bs-toggle="tooltip" title="Land Rover"
          ...
          <!-- Logo -->
          <div class="swiper-slide nav">
            <a class="nav-link p-0" href="listings-grid-cars.php" data-bs-toggle="tooltip" title="Honda"
              aria-label="Honda">
              <svg xmlns="http://www.w3.org/2000/svg" width="141" viewBox="0 0 141 64" fill="currentColor">
                <path
          ...
          <!-- Logo -->
          <div class="swiper-slide nav">
            <a class="nav-link p-0" href="listings-grid-cars.php" data-bs-toggle="tooltip" title="Lexus"
              aria-label="Lexus">
              <svg xmlns="http://www.w3.org/2000/svg" width="141" viewBox="0 0 141 64" fill="currentColor">
                <path
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <article class="hover-effect-scale position-relative text-center">
              ...
              <h3 class="h6 pt-3 mb-0">
                <a class="hover-effect-underline stretched-link" href="listings-grid-cars.php">Electric cars</a>
              </h3>
            </article>
          </div>
          ...
          <div class="swiper-slide">
            <article class="hover-effect-scale position-relative text-center">
              ...
              <h3 class="h6 pt-3 mb-0">
                <a class="hover-effect-underline stretched-link" href="listings-grid-cars.php">New cars</a>
              </h3>
            </article>
          </div>
          ...
          <div class="swiper-slide">
            <article class="hover-effect-scale position-relative text-center">
              ...
              <h3 class="h6 pt-3 mb-0">
                <a class="hover-effect-underline stretched-link" href="listings-grid-cars.php">City cars</a>
              </h3>
            </article>
          </div>
          ...
          <div class="swiper-slide">
            <article class="hover-effect-scale position-relative text-center">
              ...
              <h3 class="h6 pt-3 mb-0">
                <a class="hover-effect-underline stretched-link" href="listings-grid-cars.php">Off-road cars</a>
              </h3>
            </article>
          </div>
          ...
          <div class="swiper-slide">
            <article class="hover-effect-scale position-relative text-center">
              ...
              <h3 class="h6 pt-3 mb-0">
                <a class="hover-effect-underline stretched-link" href="listings-grid-cars.php">Family cars</a>
              </h3>
            </article>
          </div>
        </div>
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <article class="position-relative text-center">
                    <div class="ratio mx-auto mb-3" style="max-width: 164px; --fn-aspect-ratio: calc(120 / 164 * 100%)">
                ...
                <div class="swiper-slide">
                  <article class="position-relative text-center">
                    ...
                    <h3 class="h6 fw-medium mb-0">
                      <a class="hover-effect-underline stretched-link" href="#!">Child seat</a>
                    </h3>
                  </article>
                </div>
              </div>
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <article class="position-relative hover-effect-scale">
              ...
              <h3 class="h5 pt-3 pt-sm-4 mt-1 mt-sm-0 mb-0">
                <a class="hover-effect-underline stretched-link" href="blog-single-v2.php">Budget vs Premium tyres:
          ...
          <div class="swiper-slide">
            <article class="position-relative hover-effect-scale">
              ...
              <h3 class="h5 pt-3 pt-sm-4 mt-1 mt-sm-0 mb-0">
                <a class="hover-effect-underline stretched-link" href="blog-single-v2.php">Tesla fixes common recall

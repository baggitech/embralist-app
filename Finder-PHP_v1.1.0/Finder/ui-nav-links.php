...
<html lang="en" data-bs-theme="light" data-pwa="true">
  <head>
    ...
    <title>Finder Docs | Nav links</title>
      ...
      <div class="row pt-sm-2">
                  ...
                  <nav class="docs-list list-group list-group-borderless" onclick="closeSidebar()">
                    ...
                    <div class="dropdown">
                      ...
                      <ul id="anchorNav" class="nav nav-underline flex-column border-start ms-2 my-2" style="gap: .25rem;">
                        <li class="nav-item"><a class="nav-link fw-normal" href="#nav-links-basic">Basic example</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#nav-links-bg-hover">Background hover effect</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#nav-links-vertical">Vertical alignment</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#nav-links-icons">With icons and dropdowns</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#nav-links-sizing">Sizing</a></li>
                      </ul>
                    </div>
                    <div class="dropend">
        ...
        <main class="col-lg-9 pt-1 pb-5 mb-sm-2 mb-md-3">
          ...
          <section class="py-2 pb-sm-3">
            <a class="badge d-inline-flex align-items-center text-info bg-info-subtle fw-semibold text-decoration-none py-2 px-3 mb-2 rounded-pill" href="https://getbootstrap.com/docs/5.3/components/navs-tabs/" target="_blank" rel="noreferrer">
              Bootstrap docs
              <i class="fi-external-link fs-sm ms-1"></i>
            </a>
            <h1 class="pt-1">Nav links</h1>
            <p class="text-body-secondary mb-4">Horizontally or vertically stacked list links that provide a foundation for building all types of navigation components.</p>
          </section>


          <!-- Basic example -->
          <section id="nav-links-basic" class="docs-section pb-sm-2 mb-5">
            <h4>Basic example</h4>
                ...
                <div class="tab-content">
                  ...
                  <div id="html-1" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#nav-links-basic-code">
...
&lt;/ul&gt;</code></pre>
          ...
          <section id="nav-links-bg-hover" class="docs-section pb-sm-2 mb-5">
            <h4>Background hover effect</h4>
            <div class="card border-0 shadow">
              <span class="d-none d-block-dark position-absolute top-0 start-0 w-100 h-100 bg-dark rounded opacity-50"></span>
              <div class="card-body position-relative z-2">
                <ul class="nav nav-tabs m-n2" role="tablist" style="max-width: 240px">
                ...
                <div class="tab-content">
                  ...
                  <div id="html-2" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#nav-links-bg-hover-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
                      <pre id="nav-links-bg-hover-code" class="code-highlight mx-n2 mb-n2"><code class="language-html">&lt;!-- All nav links inside .navbar automatically receive background effect on hover. --&gt;
&lt;nav class=&quot;navbar navbar-expand p-0&quot;&gt;
  &lt;ul class=&quot;navbar-nav flex-wrap&quot;&gt;
    &lt;li class=&quot;nav-item&quot;&gt;
      &lt;a class=&quot;nav-link fs-sm active&quot; aria-current=&quot;page&quot; href=&quot;#&quot;&gt;Active&lt;/a&gt;
...
&lt;/nav&gt;</code></pre>
          ...
          <!-- Vertical alignment -->
          <section id="nav-links-vertical" class="docs-section pb-sm-2 mb-5">
              ...
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  ...
                  <div id="html-3" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#nav-links-vertical-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
...
&lt;/nav&gt;</code></pre>
          ...
          <section id="nav-links-icons" class="docs-section pb-sm-2 mb-5">
              ...
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  ...
                  <div id="html-4" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#nav-links-icons-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
...
&lt;/nav&gt;</code></pre>
          ...
          <!-- Sizing -->
          <section id="nav-links-sizing" class="docs-section">
            <h4>Sizing</h4>
            <div class="card border-0 shadow">
              <span class="d-none d-block-dark position-absolute top-0 start-0 w-100 h-100 bg-dark rounded opacity-50"></span>
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  ...
                  <div id="html-5" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#nav-links-sizing-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>

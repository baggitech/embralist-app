...
<html lang="en" data-bs-theme="light" data-pwa="true">
  <head>
    ...
    <title>Finder Docs | Popovers</title>
      ...
      <div class="row pt-sm-2">
                  ...
                  <nav class="docs-list list-group list-group-borderless" onclick="closeSidebar()">
                    ...
                    <div class="dropdown">
                      ...
                      <ul id="anchorNav" class="nav nav-underline flex-column border-start ms-2 my-2" style="gap: .25rem;">
                        <li class="nav-item"><a class="nav-link fw-normal" href="#popovers-static">Static examples</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#popovers-live">Live demo</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#popovers-toggle">Toggle options</a></li>
                      </ul>
                    </div>
                    <div class="dropend">
        ...
        <main class="col-lg-9 pt-1 pb-5 mb-sm-2 mb-md-3">
          ...
          <section class="py-2 pb-sm-3">
            <a class="badge d-inline-flex align-items-center text-info bg-info-subtle fw-semibold text-decoration-none py-2 px-3 mb-2 rounded-pill" href="https://getbootstrap.com/docs/5.3/components/popovers/" target="_blank" rel="noreferrer">
              Bootstrap docs
          ...
          <!-- Static examples -->
          <section id="popovers-static" class="docs-section pb-sm-2 mb-5">
              ...
              <div class="card-body position-relative z-2">
                <div class="hstack flex-wrap gap-4 pt-1 pb-2">
                  <div class="popover bs-popover-top position-relative" role="tooltip">
                    ...
                    <div class="popover-body">And here's some amazing content inside popover body that can be html. It's very engaging. Right?</div>
                  </div>
          ...
          <!-- Live demo -->
          <section id="popovers-live" class="docs-section pb-sm-2 mb-5">
            <h4>Live demo</h4>
            <div class="card border-0 shadow">
              <span class="d-none d-block-dark position-absolute top-0 start-0 w-100 h-100 bg-dark rounded opacity-50"></span>
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  <div id="preview-2" class="tab-pane pt-4 mt-3 fade show active" role="tabpanel">
                    <button type="button" class="btn btn-outline-secondary mb-3 me-2" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="hover" title="Top popover" data-bs-content="And here's some amazing content. It's very engaging. Right?">Popover on top</button>
                    <button type="button" class="btn btn-outline-secondary mb-3 me-2" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="right" data-bs-trigger="hover" title="Right popover" data-bs-content="And here's some amazing content. It's very engaging. Right?">Popover on right</button>
                    <button type="button" class="btn btn-outline-secondary mb-3 me-2" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="bottom" data-bs-trigger="hover" title="Bottom popover" data-bs-content="And here's some amazing content. It's very engaging. Right?">Popover on bottom</button>
                    <button type="button" class="btn btn-outline-secondary mb-3" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="left" data-bs-trigger="hover" title="Left popover" data-bs-content="And here's some amazing content. It's very engaging. Right?">Popover on left</button>
                  </div>
                  <div id="html-2" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#popovers-live-code">
...
&lt;/button&gt;</code></pre>
          ...
          <!-- Toggle options -->
          <section id="popovers-toggle" class="docs-section">
              ...
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  <div id="preview-3" class="tab-pane pt-4 mt-3 fade show active" role="tabpanel">
                    <button type="button" class="btn btn-primary mb-3 me-2" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" title="Popover on click" data-bs-content="And here's some amazing content. It's very engaging. Right?">Toggle popover on click</button>
                    <button type="button" class="btn btn-outline-primary mb-3 me-2" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="hover" title="Popover on hover" data-bs-content="And here's some amazing content. It's very engaging. Right?">Toggle popover on hover</button>
                    <a class="btn btn-outline-secondary mb-3" href="#!" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="focus" title="Popover on focus" data-bs-content="And here's some amazing content. It's very engaging. Right?" tabindex="1">Toggle popover on focus</a>
                  </div>
                  <div id="html-3" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#popovers-toggle-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>

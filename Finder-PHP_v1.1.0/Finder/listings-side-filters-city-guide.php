...
<head>
  <?php $title = "City Guide - Listings with Side Filters"; include('partials/title-meta.php'); ?>
        ...
        <aside class="col-lg-3">
          <div class="offcanvas-lg offcanvas-start pe-lg-2 pe-xl-3 pe-xxl-4" id="filterSidebar">
            ...
            <div class="offcanvas-body d-block">
              ...
              <!-- Location and date -->
              <div class="pb-4 mb-2 mb-xl-3">
                <h4 class="h6">Location and date</h4>
                <div class="vstack gap-3">
                  ...
                  <div class="position-relative">
                    ...
                    <input type="text" class="form-control form-icon-start rounded-pill"
                ...
                <ul class="nav flex-column gap-2 m-0">
                  <li>
                    <a class="nav-link text-body fw-normal py-1 px-0" href="#!">
                      <svg class="flex-shrin-0 text-light-emphasis me-3" xmlns="http://www.w3.org/2000/svg" width="24"
              ...
              <div class="pb-4 mb-2 mb-xl-3">
                ...
                <div class="range-slider"
                  data-range-slider='{"startMin": 5, "startMax": 150, "min": 0, "max": 300, "step": 5, "tooltipPrefix": "$"}'
                  aria-labelledby="headingPrice">
                  <div class="range-slider-ui"></div>
                  <div class="d-flex align-items-center">
                    <div class="position-relative w-50">
                      <i class="fi-dollar-sign position-absolute top-50 start-0 translate-middle-y ms-3"></i>
                      <input type="number" class="form-control form-icon-start rounded-pill" min="0" max="250" step="5"
                        data-range-slider-min>
                    </div>
                    <i class="fi-minus text-body-emphasis mx-2"></i>
                    <div class="position-relative w-50">
                      <i class="fi-dollar-sign position-absolute top-50 start-0 translate-middle-y ms-3"></i>
                      <input type="number" class="form-control form-icon-start rounded-pill" min="5" max="300" step="5"
              ...
              <article class="card h-100 hover-effect-scale hover-effect-opacity bg-transparent">
                ...
                <div class="card-body pt-3 pb-2 px-3">
                  <span
                    class="badge text-body-emphasis bg-secondary-subtle text-decoration-none mb-2">Entertainment</span>
                  <h3 class="h5 pt-1 mb-2">
                    <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.php">Sky Views
                      Observatory</a>
                  </h3>
              ...
              <article class="card h-100 hover-effect-scale hover-effect-opacity bg-transparent">
                ...
                <div class="card-body pt-3 pb-2 px-3">
                  <span
                    class="badge text-body-emphasis bg-secondary-subtle text-decoration-none mb-2">Entertainment</span>
                  <h3 class="h5 pt-1 mb-2">
                    <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.php">Museum of
                      Illusions</a>
                  </h3>
            ...
            <div class="col">
              <article class="card h-100 hover-effect-scale hover-effect-opacity bg-transparent">
                ...
                <div class="card-body pt-3 pb-2 px-3">
                  ...
                  <p class="fs-sm mb-0">Enter a world of aquatic discovery at one of the biggest aquariums in Europe.
                  </p>
                </div>
                <div class="card-footer bg-transparent border-0 pt-0 pb-3 px-3">
                  <div class="d-flex align-items-center gap-3">
              ...
              <article class="card h-100 hover-effect-scale hover-effect-opacity bg-transparent">
                ...
                <div class="card-body pt-3 pb-2 px-3">
                  <span
                    class="badge text-body-emphasis bg-secondary-subtle text-decoration-none mb-2">Entertainment</span>
                  <h3 class="h5 pt-1 mb-2">
                    <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.php">Tibidabo Ferris
                      Wheel</a>
                  </h3>
              ...
              <article class="card h-100 hover-effect-scale hover-effect-opacity bg-transparent">
                ...
                <div class="card-body pt-3 pb-2 px-3">
                  <span
                    class="badge text-body-emphasis bg-secondary-subtle text-decoration-none mb-2">Entertainment</span>
                  <h3 class="h5 pt-1 mb-2">
                    <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.php">VRFun Virtual
                      Reality Park</a>
                  </h3>
                  <p class="fs-sm mb-0">Immersive virtual reality park offering stunning VR experiences for all ages.
                  </p>
                </div>
                <div class="card-footer bg-transparent border-0 pt-0 pb-3 px-3">
                  <div class="d-flex align-items-center gap-3">
              ...
              <article class="card h-100 hover-effect-scale hover-effect-opacity bg-transparent">
                ...
                <div class="card-body pt-3 pb-2 px-3">
                  <span
                    class="badge text-body-emphasis bg-secondary-subtle text-decoration-none mb-2">Entertainment</span>
                  <h3 class="h5 pt-1 mb-2">
                    <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.php">La Sagrada
                      Familia</a>
                  </h3>
              ...
              <article class="card h-100 hover-effect-scale hover-effect-opacity bg-transparent">
                ...
                <div class="card-body pt-3 pb-2 px-3">
                  <span
                    class="badge text-body-emphasis bg-secondary-subtle text-decoration-none mb-2">Entertainment</span>
                  <h3 class="h5 pt-1 mb-2">
                    <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.php">City Guided
                      Tour</a>
                  </h3>
              ...
              <article class="card h-100 hover-effect-scale hover-effect-opacity bg-transparent">
                ...
                <div class="card-body pt-3 pb-2 px-3">
                  <span
                    class="badge text-body-emphasis bg-secondary-subtle text-decoration-none mb-2">Entertainment</span>
                  <h3 class="h5 pt-1 mb-2">
                    <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.php">Live Music Boat
                      Tour</a>
                  </h3>
                  <p class="fs-sm mb-0">Listen to professional musicians onboard as they entertain you on your journey.
                  </p>
                </div>
                <div class="card-footer bg-transparent border-0 pt-0 pb-3 px-3">
                  <div class="d-flex align-items-center gap-3">

...
<html lang="en" data-bs-theme="light" data-pwa="true">
  <head>
    ...
    <title>Finder Docs | Badges</title>
      ...
      <div class="row pt-sm-2">
                  ...
                  <nav class="docs-list list-group list-group-borderless" onclick="closeSidebar()">
                    ...
                    <div class="dropdown">
                      ...
                      <ul id="anchorNav" class="nav nav-underline flex-column border-start ms-2 my-2" style="gap: .25rem;">
                        <li class="nav-item"><a class="nav-link fw-normal" href="#badges-solid">Solid</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#badges-outline">Outline</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#badges-subtle">Subtle</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#badges-icon">Badge with icon</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#badges-shapes">Shapes</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#badges-heading">Inside heading</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#badges-button">Inside button</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#badges-list-group">Inside list group</a></li>
                      </ul>
                    </div>
                    <div class="dropend">
        ...
        <main class="col-lg-9 pt-1 pb-5 mb-sm-2 mb-md-3">
          ...
          <section class="py-2 pb-sm-3">
            <a class="badge d-inline-flex align-items-center text-info bg-info-subtle fw-semibold text-decoration-none py-2 px-3 mb-2 rounded-pill" href="https://getbootstrap.com/docs/5.3/components/badge/" target="_blank" rel="noreferrer">
              Bootstrap docs
          ...
          <!-- Solid -->
          <section id="badges-solid" class="docs-section pb-sm-2 mb-5">
            <h4>Solid</h4>
                ...
                <div class="tab-content">
                  ...
                  <div id="html-1" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#badges-solid-code">
...
&lt;span class=&quot;badge text-bg-dark&quot;&gt;Dark&lt;/span&gt;</code></pre>
          ...
          <!-- Outline -->
          <section id="badges-outline" class="docs-section pb-sm-2 mb-5">
            <h4>Outline</h4>
            <div class="card border-0 shadow">
              <span class="d-none d-block-dark position-absolute top-0 start-0 w-100 h-100 bg-dark rounded opacity-50"></span>
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  ...
                  <div id="html-2" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#badges-outline-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
...
&lt;span class=&quot;badge text-dark border border-dark&quot;&gt;Dark&lt;/span&gt;</code></pre>
          ...
          <!-- Subtle -->
          <section id="badges-subtle" class="docs-section pb-sm-2 mb-5">
            <h4>Subtle</h4>
            <div class="card border-0 shadow">
              <span class="d-none d-block-dark position-absolute top-0 start-0 w-100 h-100 bg-dark rounded opacity-50"></span>
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  ...
                  <div id="html-3" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#badges-subtle-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
...
&lt;span class=&quot;badge text-body-emphasis bg-dark-subtle&quot;&gt;Dark&lt;/span&gt;</code></pre>
          ...
          <!-- Badge with icon -->
          <section id="badges-icon" class="docs-section pb-sm-2 mb-5">
                ...
                <div class="tab-content">
                  <div id="preview-4" class="tab-pane pt-4 pb-2 mt-3 fade show active" role="tabpanel">
                    <div class="d-flex align-items-center">
                      ...
                      <span class="badge text-primary border border-primary d-inline-flex align-items-center mb-2 me-2">
                        Favorite
                  ...
                  <div id="html-4" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#badges-icon-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
...
&lt;/span&gt;</code></pre>
          ...
          <!-- Shapes -->
          <section id="badges-shapes" class="docs-section pb-sm-2 mb-5">
            <h4>Shapes</h4>
            <div class="card border-0 shadow">
              <span class="d-none d-block-dark position-absolute top-0 start-0 w-100 h-100 bg-dark rounded opacity-50"></span>
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  ...
                  <div id="html-5" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#badges-shapes-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
...
&lt;span class=&quot;badge text-bg-primary rounded-0 mb-2&quot;&gt;Square&lt;/span&gt;</code></pre>
          ...
          <!-- Inside heading -->
          <section id="badges-heading" class="docs-section pb-sm-2 mb-5">
              ...
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  ...
                  <div id="html-6" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#badges-heading-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
...
&lt;h6&gt;Example heading &lt;span class=&quot;badge bg-secondary&quot;&gt;New&lt;/span&gt;&lt;/h6&gt;</code></pre>
          ...
          <!-- Inside button -->
          <section id="badges-button" class="docs-section pb-sm-2 mb-5">
            <h4>Inside button</h4>
            <div class="card border-0 shadow">
              <span class="d-none d-block-dark position-absolute top-0 start-0 w-100 h-100 bg-dark rounded opacity-50"></span>
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  ...
                  <div id="html-7" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#badges-button-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
...
&lt;/button&gt;</code></pre>
          ...
          <!-- Inside list group -->
          <section id="badges-list-group" class="docs-section">
              ...
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  ...
                  <div id="html-8" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#badges-list-group-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>

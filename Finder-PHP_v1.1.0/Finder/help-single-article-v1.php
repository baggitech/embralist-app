...
<head>
  <?php $title = "Help Single Article v.1"; include('partials/title-meta.php'); ?>
      ...
      <div class="row g-0">
        <div class="col-md-4 col-lg-3 pb-2 pb-sm-3 pb-md-0 mb-4 mb-md-0">
          ...
          <div class="list-group list-group-borderless pt-4 pe-md-4" role="tablist">
            <a class="list-group-item list-group-item-action d-flex align-items-center fs-base active"
              href="help-topics-v1.php">Accommodation</a>
            <a class="list-group-item list-group-item-action d-flex align-items-center fs-base"
              href="help-topics-v1.php">Booking</a>
            <a class="list-group-item list-group-item-action d-flex align-items-center fs-base"
              href="help-topics-v1.php">Payment</a>
            <a class="list-group-item list-group-item-action d-flex align-items-center fs-base"
              href="help-topics-v1.php">After a booking</a>
            <a class="list-group-item list-group-item-action d-flex align-items-center fs-base"
              href="help-topics-v1.php">Cancellation, notice, extension</a>
            <a class="list-group-item list-group-item-action d-flex align-items-center fs-base"
              href="help-topics-v1.php">Regulations</a>
            <a class="list-group-item list-group-item-action d-flex align-items-center fs-base"
              href="help-topics-v1.php">Insurances</a>
          </div>
        ...
        <div class="col-md-8 col-lg-9">
          <div class="d-flex align-items-start border-bottom ps-md-4 pb-3 pb-sm-4">
            <a class="btn btn-sm btn-outline-secondary border-0 p-0 pe-2" href="help-topics-v1.php"
              aria-label="Back to main topic">
              <i class="fi-chevron-left fs-4"></i>
            </a>
            <h2 class="h5 d-flex min-w-0 mb-0">
              <span class="d-md-none">What is included in my rental accommodation?</span>
              <span class="text-truncate d-none d-md-inline">What is included in my rental accommodation?</span>
            </h2>
          </div>
          <div class="position-relative">
            ...
            <div class="row g-0">
              <div class="col-xl-11 col-xxl-10 pt-4 ps-md-4">
                <p>When you rent a property, it's important to understand exactly what is included in your rental
                  accommodation to ensure that it meets your needs and expectations. Here's a breakdown of the typical
                  inclusions and what you should consider:</p>
                <h3 class="h6 pt-2 pt-lg-3">1. Furnishings</h3>
                <p>The level of furnishing can vary significantly between rental properties. Typically, rental
                  accommodations are categorized as:</p>
                <ul>
                  <li><span class="text-body-emphasis fw-medium">Fully furnished:</span> Includes essential furniture
                    such as beds, sofas, dining tables, chairs, and sometimes even decor items like lamps, artwork, and
                    rugs. Kitchens are usually equipped with basic appliances and utensils.</li>
                  <li><span class="text-body-emphasis fw-medium">Partially furnished:</span> Includes some essential
                    furniture but may not have everything you need. For example, the property might include a bed and
                    sofa, but you'll need to provide your own kitchenware and additional furnishings.</li>
                  <li><span class="text-body-emphasis fw-medium">Unfurnished:</span> Contains no furniture or only basic
                    appliances like a stove and refrigerator. This option gives you the freedom to furnish the space
                    according to your taste but requires an initial investment in furniture.</li>
                </ul>
                ...
                <ul>
                  <li><span class="text-body-emphasis fw-medium">Kitchen appliances:</span> Standard inclusions often
                    cover a refrigerator, stove/oven, and microwave. Some rentals may also include a dishwasher,
                    toaster, and coffee maker.</li>
                  <li><span class="text-body-emphasis fw-medium">Laundry:</span> Depending on the property, you might
                    have an in-unit washer and dryer, access to shared laundry facilities, or no laundry facilities at
                    all.</li>
                  <li><span class="text-body-emphasis fw-medium">Heating and cooling:</span> Central heating and air
                    conditioning are common, but some properties may only have portable heaters or window A/C units.
                    It's important to check what's available to ensure comfort throughout the year.</li>
                </ul>
                <h3 class="h6 pt-2 pt-lg-3">3. Utilities</h3>
                <p>Utilities are sometimes included in the rent, but this varies by property:</p>
                <ul>
                  <li><span class="text-body-emphasis fw-medium">Included utilities:</span> Some rentals include the
                    cost of water, electricity, gas, heating, and even internet or cable in the rent. This can simplify
                    budgeting, as you won't have separate utility bills to pay.</li>
                  <li><span class="text-body-emphasis fw-medium">Excluded utilities:</span> If utilities are not
                    included, you'll be responsible for setting up and paying for these services separately. Be sure to
                    ask for an estimate of monthly utility costs so you can budget accordingly.</li>
                </ul>
                <h3 class="h6 pt-2 pt-lg-3">4. Internet and cable</h3>
                <p>Some rental accommodations come with pre-installed internet and cable services, either included in
                  the rent or available as an add-on. If these services are not provided, you'll need to arrange for
                  installation and pay for them separately.</p>
                <h3 class="h6 pt-2 pt-lg-3">5. Maintenance and repairs</h3>
                <p>Most rental agreements specify that the landlord is responsible for the maintenance and repair of
                  essential services like plumbing, heating, and electrical systems. However, tenants are usually
                  responsible for minor maintenance, such as changing light bulbs or keeping the property clean.</p>
                <ul>
                  <li><span class="text-body-emphasis fw-medium">Emergency repairs:</span> It's important to know how to
                    report urgent issues, such as leaks or heating failures, and what the expected response time is.
                  </li>
                </ul>
                <h3 class="h6 pt-2 pt-lg-3">6. Parking</h3>
                <p>If you have a vehicle, parking is an essential consideration:</p>
                <ul>
                  <li><span class="text-body-emphasis fw-medium">Included parking:</span> Some properties offer
                    dedicated parking spaces, either in a garage or an outdoor lot, as part of the rental agreement.
                  </li>
                  <li><span class="text-body-emphasis fw-medium">Additional parking:</span> In some cases, parking is
                    available but at an additional cost, or you may need to apply for a permit for street parking.</li>
                </ul>
                <h3 class="h6 pt-2 pt-lg-3">7. Outdoor space</h3>
                <p>Depending on the property type, you may have access to outdoor areas:</p>
                <ul>
                  <li><span class="text-body-emphasis fw-medium">Private outdoor space:</span> Some rentals include a
                    private balcony, patio, or yard, which is typically your responsibility to maintain.</li>
                  <li><span class="text-body-emphasis fw-medium">Shared outdoor areas:</span> In multi-unit buildings,
                    you might have access to shared spaces like gardens, courtyards, or rooftop terraces.</li>
                </ul>
                <h3 class="h6 pt-2 pt-lg-3">8. Lease terms</h3>
                <p>The inclusions and responsibilities associated with your rental accommodation should be clearly
                  outlined in your lease agreement. This document will specify what is covered by your rent and what
                  additional costs or responsibilities you may incur.</p>
                <h3 class="h6 pt-2 pt-lg-3">9. Tenant's responsibilities</h3>
                <p>While the landlord typically covers major maintenance and repairs, you may be responsible for
                  maintaining cleanliness, minor repairs, and following specific rules regarding the use of shared
                  facilities.</p>
                <h3 class="h6 pt-2 pt-lg-3">Conclusion</h3>
                <p>Understanding what is included in your rental accommodation is essential for avoiding surprises and
                  ensuring that the property meets your needs. Always clarify with the landlord or property manager
                  exactly what is provided and what you're responsible for before signing the lease.</p>
        ...
        <div class="swiper" data-swiper='{
          ...
          <div class="swiper-wrapper">
            ...
            <article class="swiper-slide">
              <a class="ratio d-flex hover-effect-scale bg-body-secondary rounded overflow-hidden" href="#!"
              ...
              <div class="pt-4">
                ...
                <h3 class="h5 mb-2">
                  <a class="hover-effect-underline" href="#!">Renting out a condo</a>
                </h3>
            ...
            <article class="swiper-slide">
              ...
              <div class="pt-4">
                ...
                <h3 class="h5 mb-2">
                  <a class="hover-effect-underline" href="#!">What is renters' insurance?</a>
                </h3>
            ...
            <article class="swiper-slide">
              ...
              <div class="pt-4">
                ...
                <h3 class="h5 mb-2">
                  <a class="hover-effect-underline" href="#!">Tips and tricks for renters</a>
                </h3>

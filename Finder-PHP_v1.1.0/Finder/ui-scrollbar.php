...
<html lang="en" data-bs-theme="light" data-pwa="true">
  <head>
    ...
    <title>Finder Docs | Scrollbar</title>
                  ...
                  <nav class="docs-list list-group list-group-borderless" onclick="closeSidebar()">
                    ...
                    <div class="dropdown">
                      ...
                      <ul id="anchorNav" class="nav nav-underline flex-column border-start ms-2 my-2" style="gap: .25rem;">
                        <li class="nav-item"><a class="nav-link fw-normal" href="#scrollbar-vertical">Vertical</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#scrollbar-horizontal">Horizontal</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#scrollbar-autohide">Autohide</a></li>
                      </ul>
                    </div>
                    <div class="dropend">
        ...
        <main class="col-lg-9 pt-1 pb-5 mb-sm-2 mb-md-3">
          ...
          <section class="alert d-sm-flex text-body-emphasis bg-info-subtle border-0 py-4 mb-5">
            ...
            <div class="ps-sm-3 pe-sm-5 w-100">
              <p>The custom scrollbar is powered by <a class="alert-link" href="http://grsmto.github.io/simplebar/" target="_blank" rel="noreferrer">SimpleBar</a> plugin. To use a custom scrollbar, make sure to include the required reference to the plugin's .css and .js files.</p>
              ...
              <pre class="code-highlight border mb-3" data-bs-theme="dark"><code class="language-html">&lt;link rel=&quot;stylesheet&quot; href=&quot;assets/vendor/simplebar/dist/simplebar.min.css&quot;&gt;</code></pre>
              ...
              <pre class="code-highlight border" data-bs-theme="dark"><code class="language-html">&lt;script src=&quot;assets/vendor/simplebar/dist/simplebar.min.js&quot;&gt;&lt;/script&gt;</code></pre>
            </div>
          </section>


          <!-- Vertical -->
          <section id="scrollbar-vertical" class="docs-section pb-sm-2 mb-5">
            <h4>Vertical</h4>
                ...
                <div class="tab-content">
                  ...
                  <div id="html-1" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#scrollbar-vertical-code">
...
&lt;/div&gt;</code></pre>
          ...
          <!-- Horizontal -->
          <section id="scrollbar-horizontal" class="docs-section pb-sm-2 mb-5">
            <h4>Horizontal</h4>
            <div class="card border-0 shadow">
              <span class="d-none d-block-dark position-absolute top-0 start-0 w-100 h-100 bg-dark rounded opacity-50"></span>
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  ...
                  <div id="html-2" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#scrollbar-horizontal-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
...
&lt;/div&gt;</code></pre>
          ...
          <!-- Autohide -->
          <section id="scrollbar-autohide" class="docs-section">
            <h4>Autohide</h4>
            <div class="card border-0 shadow">
              <span class="d-none d-block-dark position-absolute top-0 start-0 w-100 h-100 bg-dark rounded opacity-50"></span>
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  ...
                  <div id="html-3" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#scrollbar-autohide-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>

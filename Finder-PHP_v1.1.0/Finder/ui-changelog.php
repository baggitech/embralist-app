...
<head>
  ...
  <title>Finder Docs | Changelog</title>
    ...
    <div class="row pt-sm-2">
                ...
                <nav class="docs-list list-group list-group-borderless" onclick="closeSidebar()">
                  ...
                  <div class="dropdown">
                    ...
                    <ul id="anchorNav" class="nav nav-underline flex-column border-start ms-2 my-2" style="gap: .25rem;">
                      <li class="nav-item"><a class="nav-link fw-normal" href="#v-1-0-0">v1.0.0</a></li>
                    </ul>
                  </div>
      ...
      <main class="col-lg-9 pt-1 pb-5 mb-sm-2 mb-md-3">
        ...
        <section class="mb-3">
          ...
          <!-- v1.0.0 -->
          <section class="docs-section d-flex" id="v-1-0-0">
            <div class="flex-shrink-0 bg-body border border-2 rounded-circle" style="width: 17px; height: 17px; margin-top: 5px"></div>
            <div class="ps-4">
              <h2 class="h5">v1.0.0 - August 27, 2025</h2>

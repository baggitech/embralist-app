...
<head>
  <?php $title = "Listings with Top Filters - City Guide"; include('partials/title-meta.php'); ?>
...
<body>
  ...
  <!-- Filters offcanvas -->
  <div class="offcanvas offcanvas-end pb-sm-2 px-sm-2" id="filtersOffcanvas" tabindex="-1"
    ...
    <div class="offcanvas-body pt-0">
      ...
      <div class="accordion" id="filters">
        ...
        <div class="position-relative">
          ...
          <input type="number"
            class="form-control form-control-lg form-select-flush text-dark-emphasis fw-medium py-3 ps-4 pe-0" min="1"
            ...
            <div class="accordion-body d-flex flex-column gap-2 px-1">
              <div class="form-check m-0">
                <input type="checkbox" class="form-check-input fs-base" id="rating-5"
                  onclick="updateFilterCount('ratingCount')" data-count-id="ratingCount" checked>
      ...
      <div class="sticky-top bg-body mb-3 mb-sm-2" style="margin-top: -76px">
        ...
        <div class="row align-items-center py-2 py-sm-3">
            ...
            <div class="row row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-3 g-xl-4">
                ...
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu w-100 p-3">
                    <div class="d-flex flex-column gap-2">
                      <div class="form-check m-0">
                        <input type="checkbox" class="form-check-input fs-base" id="apartments" checked
                      ...
                      <div class="form-check m-0">
                        <input type="checkbox" class="form-check-input fs-base" id="hotels" checked
                          onclick="updateFilterCount('typeCount')" data-count-id="typeCount">
                      ...
                      <div class="form-check m-0">
                        <input type="checkbox" class="form-check-input fs-base" id="resorts" checked
                          onclick="updateFilterCount('typeCount')" data-count-id="typeCount">
                      ...
                      <div class="form-check m-0">
                        <input type="checkbox" class="form-check-input fs-base" id="cabins" checked
                          onclick="updateFilterCount('typeCount')" data-count-id="typeCount">
              ...
              <div class="col d-none d-sm-block">
                <div class="position-relative">
                  ...
                  <select class="form-select filter-select form-icon-start rounded-pill" data-select='{
                      "classNames": {
          ...
          <div class="col-5 col-sm-3 col-lg-2">
            <div class="nav">
              <a class="nav-link position-relative text-nowrap p-0" href="#filtersOffcanvas" data-bs-toggle="offcanvas"
      ...
      <div class="d-flex align-items-center gap-4 pb-3 mb-2 mb-xl-3">
        ...
        <div class="nav ms-auto ms-md-0">
          <a class="nav-link position-relative p-0" href="#map" data-bs-toggle="offcanvas">
            ...
            <span class="hover-effect-underline stretched-link">View on <span class="d-none d-sm-inline">the</span>
              map</span>
          </a>
        </div>
      </div>
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 g-4 mb-n2">
        ...
        <div class="col pb-2">
          <article class="card h-100 hover-effect-scale hover-effect-opacity bg-transparent border-0">
            ...
            <div class="card-body pt-3 pb-2 px-0">
              <h3 class="h5 mb-0">
                <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.php">Barcelona Business
                  Hotel</a>
              </h3>
            </div>
            <div class="card-footer d-flex align-items-center gap-3 bg-transparent border-0 p-0">
              <div class="d-flex align-items-center gap-1">
                ...
                <span class="fs-xs text-body-secondary align-self-end">(472)</span>
              </div>
              ...
              <div class="d-flex align-items-center gap-1 min-w-0 fs-sm">
                ...
                <span class="text-truncate">0.6 km from center</span>
              </div>
            </div>
          </article>
        </div>
        ...
        <div class="col pb-2">
          <article class="card h-100 hover-effect-scale hover-effect-opacity bg-transparent border-0">
            <div class="bg-body-tertiary rounded overflow-hidden">
              <div class="ratio hover-effect-target" style="--fn-aspect-ratio: calc(280 / 416 * 100%)">
                <img src="assets/img/listings/city-guide/v2/03.jpg" alt="Image">
              </div>
            </div>
            <div
              class="position-absolute top-0 end-0 z-2 hover-effect-target opacity-0 pt-1 pt-sm-0 pe-1 pe-sm-0 mt-2 mt-sm-3 me-2 me-sm-3">
            ...
            <div class="card-body pt-3 pb-2 px-0">
              <h3 class="h5 mb-0">
                <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.php">Grand Resort &amp;
                  Spa</a>
              </h3>
            </div>
            <div class="card-footer d-flex align-items-center gap-3 bg-transparent border-0 p-0">
              <div class="d-flex align-items-center gap-1">
                ...
                <span class="fs-xs text-body-secondary align-self-end">(209)</span>
              </div>
              <div class="d-flex align-items-center gap-1 fs-sm">
                <i class="fi-credit-card"></i>
                $$$
              ...
              <div class="d-flex align-items-center gap-1 min-w-0 fs-sm">
                <i class="fi-map-pin"></i>
                <span class="text-truncate">5.3 km from center</span>
              </div>
            </div>
          </article>
        </div>
        ...
        <div class="col pb-2">
          <article class="card h-100 hover-effect-scale hover-effect-opacity bg-transparent border-0">
            <div class="bg-body-tertiary rounded overflow-hidden">
              <div class="ratio hover-effect-target" style="--fn-aspect-ratio: calc(280 / 416 * 100%)">
                <img src="assets/img/listings/city-guide/v2/04.jpg" alt="Image">
              </div>
            </div>
            <div
              class="position-absolute top-0 end-0 z-2 hover-effect-target opacity-0 pt-1 pt-sm-0 pe-1 pe-sm-0 mt-2 mt-sm-3 me-2 me-sm-3">
            ...
            <div class="card-body pt-3 pb-2 px-0">
              <h3 class="h5 mb-0">
                <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.php">Serenity Hotel</a>
              </h3>
            </div>
            <div class="card-footer d-flex align-items-center gap-3 bg-transparent border-0 p-0">
              <div class="d-flex align-items-center gap-1">
                ...
                <span class="fs-xs text-body-secondary align-self-end">(318)</span>
              </div>
              <div class="d-flex align-items-center gap-1 fs-sm">
                <i class="fi-credit-card"></i>
                $$
        ...
        <div class="col pb-2">
          <article class="card h-100 hover-effect-scale hover-effect-opacity bg-transparent border-0">
            <div class="bg-body-tertiary rounded overflow-hidden">
              <div class="ratio hover-effect-target" style="--fn-aspect-ratio: calc(280 / 416 * 100%)">
                <img src="assets/img/listings/city-guide/v2/05.jpg" alt="Image">
              </div>
            </div>
            <div
              class="position-absolute top-0 end-0 z-2 hover-effect-target opacity-0 pt-1 pt-sm-0 pe-1 pe-sm-0 mt-2 mt-sm-3 me-2 me-sm-3">
            ...
            <div class="card-body pt-3 pb-2 px-0">
              <h3 class="h5 mb-0">
                <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.php">Merry Berry
                  Motel</a>
              </h3>
            </div>
            <div class="card-footer d-flex align-items-center gap-3 bg-transparent border-0 p-0">
              <div class="d-flex align-items-center gap-1">
                ...
                <span class="fs-xs text-body-secondary align-self-end">(734)</span>
              </div>
              <div class="d-flex align-items-center gap-1 fs-sm">
                <i class="fi-credit-card"></i>
                $
              ...
              <div class="d-flex align-items-center gap-1 min-w-0 fs-sm">
                <i class="fi-map-pin"></i>
                <span class="text-truncate">6.5 km from center</span>
              </div>
            </div>
          </article>
        </div>
        ...
        <div class="col pb-2">
          <article class="card h-100 hover-effect-scale hover-effect-opacity bg-transparent border-0">
            <div class="bg-body-tertiary rounded overflow-hidden">
              <div class="ratio hover-effect-target" style="--fn-aspect-ratio: calc(280 / 416 * 100%)">
                <img src="assets/img/listings/city-guide/v2/06.jpg" alt="Image">
              </div>
            </div>
            <div
              class="position-absolute top-0 end-0 z-2 hover-effect-target opacity-0 pt-1 pt-sm-0 pe-1 pe-sm-0 mt-2 mt-sm-3 me-2 me-sm-3">
            ...
            <div class="card-body pt-3 pb-2 px-0">
              <h3 class="h5 mb-0">
                <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.php">Repose Hotel</a>
              </h3>
            </div>
            <div class="card-footer d-flex align-items-center gap-3 bg-transparent border-0 p-0">
              <div class="d-flex align-items-center gap-1">
                <i class="fi-star-filled text-warning"></i>
                <span class="fs-sm text-secondary-emphasis">4.8</span>
                <span class="fs-xs text-body-secondary align-self-end">(165)</span>
              </div>
              <div class="d-flex align-items-center gap-1 fs-sm">
                <i class="fi-credit-card"></i>
                $$$
        ...
        <div class="col pb-2">
          <article class="card h-100 hover-effect-scale hover-effect-opacity bg-transparent border-0">
            <div class="bg-body-tertiary rounded overflow-hidden">
              <div class="ratio hover-effect-target" style="--fn-aspect-ratio: calc(280 / 416 * 100%)">
                <img src="assets/img/listings/city-guide/v2/07.jpg" alt="Image">
              </div>
            </div>
            <div
              class="position-absolute top-0 end-0 z-2 hover-effect-target opacity-0 pt-1 pt-sm-0 pe-1 pe-sm-0 mt-2 mt-sm-3 me-2 me-sm-3">
            ...
            <div class="card-body pt-3 pb-2 px-0">
              <h3 class="h5 mb-0">
                <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.php">Tranquil Hotel</a>
              </h3>
            </div>
            <div class="card-footer d-flex align-items-center gap-3 bg-transparent border-0 p-0">
              <div class="d-flex align-items-center gap-1">
                <i class="fi-star-filled text-warning"></i>
                <span class="fs-sm text-secondary-emphasis">4.5</span>
                <span class="fs-xs text-body-secondary align-self-end">(96)</span>
              </div>
              <div class="d-flex align-items-center gap-1 fs-sm">
                <i class="fi-credit-card"></i>
                $$
              ...
              <div class="d-flex align-items-center gap-1 min-w-0 fs-sm">
                <i class="fi-map-pin"></i>
                <span class="text-truncate">3.8 km from center</span>
              </div>
            </div>
          </article>
        </div>
        ...
        <div class="col pb-2">
          <article class="card h-100 hover-effect-scale hover-effect-opacity bg-transparent border-0">
            <div class="bg-body-tertiary rounded overflow-hidden">
              <div class="ratio hover-effect-target" style="--fn-aspect-ratio: calc(280 / 416 * 100%)">
                <img src="assets/img/listings/city-guide/v2/08.jpg" alt="Image">
              </div>
            </div>
            <div
              class="position-absolute top-0 end-0 z-2 hover-effect-target opacity-0 pt-1 pt-sm-0 pe-1 pe-sm-0 mt-2 mt-sm-3 me-2 me-sm-3">
            ...
            <div class="card-body pt-3 pb-2 px-0">
              <h3 class="h5 mb-0">
                <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.php">Soothe &amp;
                  Stay</a>
              </h3>
            </div>
            <div class="card-footer d-flex align-items-center gap-3 bg-transparent border-0 p-0">
              <div class="d-flex align-items-center gap-1">
                ...
                <span class="fs-xs text-body-secondary align-self-end">(290)</span>
              </div>
              <div class="d-flex align-items-center gap-1 fs-sm">
                <i class="fi-credit-card"></i>
                $
        ...
        <div class="col pb-2">
          <article class="card h-100 hover-effect-scale hover-effect-opacity bg-transparent border-0">
            <div class="bg-body-tertiary rounded overflow-hidden">
              <div class="ratio hover-effect-target" style="--fn-aspect-ratio: calc(280 / 416 * 100%)">
                <img src="assets/img/listings/city-guide/v2/09.jpg" alt="Image">
              </div>
            </div>
            <div
              class="position-absolute top-0 end-0 z-2 hover-effect-target opacity-0 pt-1 pt-sm-0 pe-1 pe-sm-0 mt-2 mt-sm-3 me-2 me-sm-3">
            ...
            <div class="card-body pt-3 pb-2 px-0">
              <h3 class="h5 mb-0">
                <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.php">Best Nest
                  Apartment</a>
              </h3>
            </div>
            <div class="card-footer d-flex align-items-center gap-3 bg-transparent border-0 p-0">
              ...
              <div class="d-flex align-items-center gap-1 min-w-0 fs-sm">
                <i class="fi-map-pin"></i>
                <span class="text-truncate">1.6 km from center</span>
              </div>
            </div>
          </article>
        </div>
        ...
        <div class="col pb-2">
          <article class="card h-100 hover-effect-scale hover-effect-opacity bg-transparent border-0">
            ...
            <div class="card-body pt-3 pb-2 px-0">
              <h3 class="h5 mb-0">
                <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.php">Pine Cottage</a>
              </h3>
            </div>
            <div class="card-footer d-flex align-items-center gap-3 bg-transparent border-0 p-0">
              <div class="d-flex align-items-center gap-1">
        ...
        <div class="col pb-2">
          <article class="card h-100 hover-effect-scale hover-effect-opacity bg-transparent border-0">
            <div class="bg-body-tertiary rounded overflow-hidden">
              <div class="ratio hover-effect-target" style="--fn-aspect-ratio: calc(280 / 416 * 100%)">
                <img src="assets/img/listings/city-guide/v2/11.jpg" alt="Image">
              </div>
            </div>
            <div
              class="position-absolute top-0 end-0 z-2 hover-effect-target opacity-0 pt-1 pt-sm-0 pe-1 pe-sm-0 mt-2 mt-sm-3 me-2 me-sm-3">
            ...
            <div class="card-body pt-3 pb-2 px-0">
              <h3 class="h5 mb-0">
                <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.php">Greenpoint Boutique
                  Hotel</a>
              </h3>
            </div>
            <div class="card-footer d-flex align-items-center gap-3 bg-transparent border-0 p-0">
              <div class="d-flex align-items-center gap-1">
                ...
                <span class="fs-xs text-body-secondary align-self-end">(216)</span>
              </div>
              <div class="d-flex align-items-center gap-1 fs-sm">
                <i class="fi-credit-card"></i>
                $$
              ...
              <div class="d-flex align-items-center gap-1 min-w-0 fs-sm">
                <i class="fi-map-pin"></i>
                <span class="text-truncate">1.9 km from center</span>
              </div>
            </div>
          </article>
        </div>

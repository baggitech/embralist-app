...
<head>
  <?php $title = "Account - Sign Up"; include('partials/title-meta.php'); ?>
    ...
    <div class="d-lg-flex">
      ...
      <div class="d-flex flex-column min-vh-100 w-100 py-4 mx-auto me-lg-5" style="max-width: 416px">
        ...
        <form class="needs-validation" novalidate>
          ...
          <div class="mb-4">
            ...
            <div class="password-toggle">
              <input type="password" class="form-control form-control-lg" id="register-password" minlength="8"
          ...
          <div class="d-flex flex-column gap-2 mb-4">
            ...
            <div class="form-check">
              ...
              <label for="privacy" class="form-check-label">I have read and accept the <a class="text-dark-emphasis"
        ...
        <footer class="mt-auto">
          <div class="nav mb-4">
            <a class="nav-link text-decoration-underline p-0" href="help-topics-v1.php">Need help?</a>
          </div>
          <p class="fs-xs mb-0">
            &copy; All rights reserved. Made by <a
              class="hover-effect-underline text-dark-emphasis text-decoration-none" href="https://1.envato.market/coderthemes"
              target="_blank" rel="noreferrer">Coderthemes</a>
          </p>
        </footer>
      </div>
              ...
              <div class="row row-cols-1 row-cols-sm-2 g-3 g-md-4 g-lg-3 g-xl-4">
                <div class="col">
                  <div class="card h-100 bg-transparent border-0">
                    <span
                      class="position-absolute top-0 start-0 w-100 h-100 bg-white border border-white border-opacity-75 rounded-4 d-none-dark"
                      style="--fn-bg-opacity: .3"></span>
                    <span
                      class="position-absolute top-0 start-0 w-100 h-100 bg-white border rounded-4 d-none d-block-dark"
                      style="--fn-bg-opacity: .05"></span>

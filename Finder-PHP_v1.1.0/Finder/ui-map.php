      ...
      <div class="row pt-sm-2">
                  ...
                  <nav class="docs-list list-group list-group-borderless" onclick="closeSidebar()">
                    ...
                    <div class="dropdown">
                      ...
                      <ul id="anchorNav" class="nav nav-underline flex-column border-start ms-2 my-2" style="gap: .25rem;">
                        <li class="nav-item"><a class="nav-link fw-normal" href="#map-js-usage">Use in JavaScript</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#map-options">Options</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#map-methods">Methods</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#map-features">Features (markers)</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#map-plugins">Plugins</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#map-basic">Basic example (no options passed)</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#map-layers-markers">Different map layers and markers</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#map-multiple-markers">Multiple markers with popups</a></li>
                      </ul>
                    </div>
                    <div class="dropend">
        ...
        <main class="col-lg-9 pt-1 pb-5 mb-sm-2 mb-md-3">
          ...
          <section class="pt-2 pb-md-2">
            ...
            <h1 class="pt-1">Map</h1>
            <p class="text-body-secondary mb-4">Interactive map component powered by Leaflet plugin.</p>
          </section>
          ...
          <section class="alert d-sm-flex text-body-emphasis bg-info-subtle border-0 py-4 mb-5">
            ...
            <div class="ps-sm-3 pe-sm-5 w-100">
              <p>The Map component relies on the <a class="alert-link" href="https://leafletjs.com/" target="_blank" rel="noreferrer">Leaflet</a> plugin. To use a map, make sure to include the required reference to the plugin's .css and .js files.</p>
              ...
              <pre class="code-highlight border mb-3" data-bs-theme="dark"><code class="language-html">&lt;link rel=&quot;stylesheet&quot; href=&quot;assets/vendor/leaflet/dist/leaflet.css&quot;&gt;</code></pre>
              ...
              <pre class="code-highlight border mb-2" data-bs-theme="dark"><code class="language-html">&lt;script src=&quot;assets/vendor/leaflet/dist/leaflet.js&quot;&gt;&lt;/script&gt;</code></pre>
            </div>
          </section>


          <!-- Use in JavaScript -->
          <section class="docs-section pb-sm-2 mb-5" id="map-js-usage">
            <h4 class="mb-sm-4">Example of usage in JavaScript</h4>
            <pre class="code-highlight"><code class="language-javascript">import Map from './map/map-core'

const canvas = document.querySelector('[data-map]')
const map = new Map(canvas, options)
map.render(features)</code></pre>
          </section>


          <!-- Options -->
          <section class="docs-section mb-5" id="map-options">
            <h4>Options</h4>
            <p class="mb-sm-4">You can apply virtually any Leaflet option by specifying it within the <code>data-map="{}"</code> attribute in JSON format.</p>
            <div class="table-responsive fs-sm">
              <table class="table table-bordered mb-2">
                ...
                <tbody>
                  <tr>
                    <td class="fs-base"><code>center</code></td>
                    <td><a href="https://leafletjs.com/reference.php#latlng" target="_blank" rel="noreferrer">[LatLng]</a></td>
                    <td class="text-body text-nowrap">[51.509865, -0.118092]</td>
                    <td class="text-body"><a href="https://leafletjs.com/reference.php#map-center" target="_blank" rel="noreferrer">https://leafletjs.com/reference.php#map-center</a><br>By default coordinates of London. Also works as a fallback in case you don't specify any features (coordinates).</td>
                  </tr>
                  <tr>
                    <td class="fs-base"><code>zoom</code></td>
                    <td class="text-body">Number</td>
                    <td class="text-body">10</td>
                    <td><a href="https://leafletjs.com/reference.php#map-zoom" target="_blank" rel="noreferrer">https://leafletjs.com/reference.php#map-zoom</a></td>
                  </tr>
                  <tr>
                    <td class="fs-base"><code>minZoom</code></td>
                    <td class="text-body">Number</td>
                    <td class="text-body">1</td>
                    <td><a href="https://leafletjs.com/reference.php#map-minzoom" target="_blank" rel="noreferrer">https://leafletjs.com/reference.php#map-minzoom</a></td>
                  </tr>
                  <tr>
                    <td class="fs-base"><code>maxZoom</code></td>
                    <td class="text-body">Number</td>
                    <td class="text-body">22</td>
                    <td><a href="https://leafletjs.com/reference.php#map-maxzoom" target="_blank" rel="noreferrer">https://leafletjs.com/reference.php#map-maxzoom</a></td>
                  </tr>
                  <tr>
                    <td class="fs-base"><code>tileLayer</code></td>
                    <td class="text-body">String</td>
                    <td class="text-body">https://tile.openstreetmap.org/{z}/{x}/{y}.png</td>
                    <td><a href="https://leafletjs.com/reference.php#tilelayer" target="_blank" rel="noreferrer">https://leafletjs.com/reference.php#tilelayer</a></td>
                  </tr>
                  <tr>
                    <td class="fs-base"><code>tileSize</code></td>
                    <td class="text-body">Number</td>
                    <td class="text-body">256</td>
                    <td class="text-body">Specify the size of map tile. Should be supported by your tiles provider.</td>
                  </tr>
                  <tr>
                    <td class="fs-base"><code>setViewStrategy</code></td>
                    <td class="text-body">String</td>
                    <td class="text-body">bounds</td>
                    <td class="text-body">Set <code>bounds</code> or <code>center</code>. This will determine what will be the view of the map after calling the <code>render</code> method.</td>
                  </tr>
                  <tr>
                    <td class="fs-base"><code>zoomOffset</code></td>
                    <td class="text-body">Number</td>
                    <td class="text-body">0</td>
                    <td><a href="https://leafletjs.com/reference.php#tilelayer-zoomoffset" target="_blank" rel="noreferrer">https://leafletjs.com/reference.php#tilelayer-zoomoffset</a></td>
                  </tr>
                  <tr>
                    <td class="fs-base"><code>plugins</code></td>
                    <td class="text-body">Array</td>
                    <td class="text-body">[]</td>
                    <td class="text-body">List of plugins.</td>
                  </tr>
                  <tr>
                    <td class="fs-base"><code>templates.marker</code></td>
                    <td class="text-body">String</td>
                    <td class="text-body">&lt;div class="map-marker"&gt;&lt;i class="fi-map-pin-filled text-primary fs-4"&gt;&lt;/i&gt;&lt;/div&gt;</td>
                    <td class="text-body">Default template for markers. Can be overridden per-feature (<code>markerTemplate</code>) or through the plugin.</td>
                  </tr>
                  <tr>
                    <td class="fs-base"><code>templates.popup</code></td>
                    <td class="text-body">String</td>
                    <td class="text-body">—</td>
                    <td class="text-body">Default template for popups. Can be overridden per-feature (<code>popupTemplate</code>) or through the plugin.</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <!-- Methods -->
          <section class="docs-section mb-5" id="map-methods">
            <h4 class="mb-sm-4">Methods</h4>
            <div class="table-responsive fs-sm">
              <table class="table table-bordered mb-2">
                <thead>
                  <tr>
                ...
                <tbody>
                  <tr>
                    <td class="fs-base"><code>render(&lt;Array&gt; features)</code></td>
                    <td class="text-body">—</td>
                    <td class="text-body">Renders features (markers) on the map.</td>
                  </tr>
                  <tr>
                    <td class="fs-base"><code>getOptions()</code></td>
                    <td class="text-body">Object</td>
                    <td class="text-body">Returns options.</td>
                  </tr>
                  <tr>
                    <td class="fs-base"><code>registerPlugin(&lt;Object&gt; plugin)</code></td>
                    <td class="text-body">—</td>
                    <td class="text-body">Registers the plugin.</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <!-- Features (markers) -->
          <section class="docs-section pb-sm-2 mb-5" id="map-features">
            <h4>Features (markers)</h4>
            <p class="mb-sm-4">Feature is a normal JavaScript object. You are free to put any props inside of the feature, however there are some properties that will be used by the plugin in a certain way.</p>
            <pre class="code-highlight"><code class="language-javascript">let feature = {
  ...
  coordinates: {
    ...
    lng: -0.09,
            ...
            <h5 class="fs-lg pt-4 mt-2">Features/markers can be set in a 3 different ways:</h5>
            <ol>
              <li>Specify the path/URL to a <code>.json</code> file in <code>data-map-markers</code> attribute.</li>
              <li>Pass a JSON array in <code>data-map-markers</code>.</li>
              <li>Use API to render the features, but in this case it is expected that you will create the <code>Map</code> instance and call the <code>map.render()</code> method.</li>
            </ol>
            <div class="alert alert-info mb-0"><span class="fw-semibold">Note</span>: <code>data-map-markers</code> must be set on the same HTML element where you set <code>data-map</code>.</div>
          </section>


          <!-- Plugins -->
          <section class="docs-section pb-sm-2 mb-5" id="map-plugins">
            <h4>Plugins</h4>
            <p class="mb-sm-4">Plugins allows you to modify the certain aspect of the `Map`. Plugin can be a JavaScript object or class with methods:</p>
            <div class="table-responsive fs-sm">
              <table class="table table-bordered mb-2">
                <thead>
                  <tr>
                ...
                <tbody>
                  <tr>
                    <td class="fs-base"><code>features(&lt;Array&gt;  features)</code></td>
                    <td class="text-body">&lt;Array&gt;</td>
                    <td class="text-body">Handle features before they will be rendered on the map. Suitable for filtering, modifying, or processing features before they are rendered on the map.</td>
                  </tr>
                  <tr>
                    <td class="fs-base"><code>marker(&lt;L.Marker&gt; marker, &lt;Object&gt; feature)</code></td>
                    <td class="text-body">&lt;L.Marker&gt;</td>
                    <td class="text-body">Handle the marker instance. Suitable for modifying the marker instance before it is added to the map. Note: `feature` here is in the GeoJSON format.</td>
                  </tr>
                  <tr>
                    <td class="fs-base"><code>popup(&lt;String&gt; template, &lt;Object&gt; feature)</code></td>
                    <td class="text-body">&lt;String&gt;</td>
                    <td class="text-body">Register the pluginHandle the popup content. Suitable for modifying the popup content before it binds to the marker. By returning an empty string from the plugin method, you can prevent the popup from being displayed.</td>
                  </tr>
                </tbody>
              </table>
            </div>
            <h5 class="fs-lg pt-4">Example:</h5>
            <pre class="code-highlight"><code class="language-javascript">// Define a very basic "logger" plugin
let logger = {
...
map.render()</code></pre>
          ...
          <section id="map-basic" class="docs-section pb-sm-2 mb-5">
            <h4>Basic example (no options passed)</h4>
                ...
                <div class="tab-content">
                  ...
                  <div id="html-1" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#map-basic-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
                      <pre id="map-basic-code" class="code-highlight mx-n2 mb-n2"><code class="language-html">&lt;!-- Default map example without any options passed. The OpenStreetMap tiles (layers) are used by default. --&gt;
&lt;div class=&quot;ratio ratio-16x9 bg-body-tertiary border rounded&quot; data-map&gt;&lt;/div&gt;</code></pre>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <section id="map-layers-markers" class="docs-section pb-sm-2 mb-5">
            <h4>Different map layers and markers</h4>
            <div class="card border-0 shadow">
              <span class="d-none d-block-dark position-absolute top-0 start-0 w-100 h-100 bg-dark rounded opacity-50"></span>
              <div class="card-body position-relative z-2">
                <ul class="nav nav-tabs m-n2" role="tablist" style="max-width: 240px">
                ...
                <div class="tab-content">
                  <div id="preview-2" class="tab-pane pt-4 pb-2 mt-3 fade show active" role="tabpanel">
                    <div class="vstack gap-4">
                      <div class="ratio ratio-16x9 bg-body-tertiary border rounded" data-map='{
                        "tileLayer": "https://api.maptiler.com/maps/backdrop/{z}/{x}/{y}.png?key=rqrCHwDtUZCUA2fCt3vV",
                        "attribution": "© Maptiler © OpenStreetMap contributors",
                        "zoom": 15
                      }'></div>
                      <div class="ratio ratio-16x9 bg-body-tertiary border rounded" data-map='{
                        "tileLayer": "https://api.maptiler.com/maps/streets/{z}/{x}/{y}.png?key=rqrCHwDtUZCUA2fCt3vV",
                        "attribution": "© Maptiler © OpenStreetMap contributors",
                        "zoom": 15,
                        "templates": {
                  ...
                  <div id="html-2" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#map-layers-markers-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
                      <pre id="map-layers-markers-code" class="code-highlight mx-n2 mb-n2"><code class="language-html">&lt;!-- IMPORTANT! These map styles require generating MapTiler API Key. --&gt;
&lt;!-- Example #1 --&gt;
&lt;div class=&quot;ratio ratio-16x9 bg-body-tertiary border rounded&quot; data-map='{
...
&lt;div class=&quot;ratio ratio-16x9 bg-body-tertiary border rounded&quot; data-map='{
  ...
  &quot;coordinates&quot;: {
    ...
    &quot;lng&quot;: -0.118092
          ...
          <section id="map-multiple-markers" class="docs-section">
            <h4>Multiple markers with popups</h4>
            <div class="card border-0 shadow">
              <span class="d-none d-block-dark position-absolute top-0 start-0 w-100 h-100 bg-dark rounded opacity-50"></span>
              <div class="card-body position-relative z-2">
                <ul class="nav nav-tabs m-n2" role="tablist" style="max-width: 240px">
                ...
                <div class="tab-content">
                  <div id="preview-3" class="tab-pane pt-4 pb-2 mt-3 fade show active" role="tabpanel">
                    <div class="w-100 bg-body-tertiary border rounded" style="height: 500px" data-map='{
                    ...
                    }' data-map-markers="../assets/json/map-docs.json"></div>
                  </div>
                  <div id="html-3" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#map-multiple-markers-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
                      <pre id="map-multiple-markers-code" class="code-highlight mx-n2 mb-n2"><code class="language-html">&lt;!-- Map example showing multiple markers with price and popup listing card. Markers are passed via external JSON file. IMPORTANT! This map style requires generating MapTiler API Key. --&gt;
&lt;div class="ratio ratio-16x9 bg-body-tertiary border rounded" data-map='{

...
<head>
  <?php $title = "Cars - Listings List View"; include('partials/title-meta.php'); ?>
      ...
      <div class="row pt-md-2 pt-lg-3 pb-2 pb-sm-3 pb-md-4 pb-lg-5">
        ...
        <div class="col-lg-9">
          ...
          <div class="d-flex align-items-center gap-2 gap-sm-3 pb-3 mb-2">
            ...
            <div class="nav">
              <a class="nav-link fs-xl text-body-secondary py-0 px-2" href="listings-grid-cars.php"
                aria-label="Grid view">
                <i class="fi-grid"></i>
              </a>
              <a class="nav-link fs-xl text-body-secondary py-0 px-2 active pe-none" href="listings-list-cars.php"
              ...
              <div class="row g-0">
                ...
                <div class="col-sm-7 py-md-2">
                  <div class="card-body pb-3 pb-md-4">
                    ...
                    <h3 class="h5 mb-2">
                      <a class="hover-effect-underline stretched-link me-1" href="single-entry-cars.php">Volvo XC90
                        Sport 4WD</a>
                      <span class="fs-sm fw-normal text-body-secondary">(2019)</span>
                    </h3>
                    <div class="h6 mb-0">$43,500</div>
                    <p class="fs-sm pt-2 mt-1 mb-0">This SUV combines robust power with sophisticated design, offering
                      advanced safety features and all-terrain capability.</p>
                  </div>
            ...
            <article class="card hover-effect-scale bg-body-tertiary border-0 overflow-hidden">
              <div class="row g-0">
                <div class="col-sm-5 position-relative bg-body-secondary overflow-hidden" style="min-height: 220px">
                  ...
                  <img src="assets/img/listings/cars/list/02.jpg"
                    class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 object-fit-cover"
                    alt="Image">
                </div>
                <div class="col-sm-7 py-md-2">
                  <div class="card-body pb-3 pb-md-4">
                    ...
                    <h3 class="h5 mb-2">
                      <a class="hover-effect-underline stretched-link me-1" href="single-entry-cars.php">Porsche 911
                        Turbo S</a>
                      <span class="fs-sm fw-normal text-body-secondary">(2017)</span>
                    </h3>
                    <div class="h6 mb-0">$85,000</div>
                    <p class="fs-sm pt-2 mt-1 mb-0">This pristine sports car, free of damages, features a powerful
                      turbocharged engine, iconic design, and a meticulously crafted interior.</p>
                  </div>
                  <div class="card-footer bg-transparent border-0 pt-0 pb-4">
                    <div
                      class="d-flex flex-wrap justify-content-between gap-3 border-top fs-sm text-nowrap pt-3 pt-md-4">
            ...
            <article class="card hover-effect-scale bg-body-tertiary border-0 overflow-hidden">
              <div class="row g-0">
                <div class="col-sm-5 position-relative bg-body-secondary overflow-hidden" style="min-height: 220px">
                  ...
                  <img src="assets/img/listings/cars/list/03.jpg"
                    class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 object-fit-cover"
                    alt="Image">
                </div>
                <div class="col-sm-7 py-md-2">
                  <div class="card-body pb-3 pb-md-4">
                    ...
                    <h3 class="h5 mb-2">
                      <a class="hover-effect-underline stretched-link me-1" href="single-entry-cars.php">Ford Truck
                        Lifted</a>
                      <span class="fs-sm fw-normal text-body-secondary">(2022)</span>
                    </h3>
                    <div class="h6 mb-0">$63,000</div>
                    <p class="fs-sm pt-2 mt-1 mb-0">A rugged, commanding presence on and off the road, the lifted Ford
                      Truck delivers enhanced performance and superior ground clearance.</p>
                  </div>
                  <div class="card-footer bg-transparent border-0 pt-0 pb-4">
                    <div
                      class="d-flex flex-wrap justify-content-between gap-3 border-top fs-sm text-nowrap pt-3 pt-md-4">
            ...
            <article class="card hover-effect-scale bg-body-tertiary border-0 overflow-hidden">
              <div class="row g-0">
                <div class="col-sm-5 position-relative bg-body-secondary overflow-hidden" style="min-height: 220px">
                  ...
                  <img src="assets/img/listings/cars/list/04.jpg"
                    class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 object-fit-cover"
                    alt="Image">
                </div>
                <div class="col-sm-7 py-md-2">
                  <div class="card-body pb-3 pb-md-4">
                    ...
                    <h3 class="h5 mb-2">
                      <a class="hover-effect-underline stretched-link me-1" href="single-entry-cars.php">Land Rover
                        Defender</a>
                      <span class="fs-sm fw-normal text-body-secondary">(2003)</span>
                    </h3>
                    <div class="h6 mb-0">$25,900</div>
                    <p class="fs-sm pt-2 mt-1 mb-0">An iconic off-road legend, known for its rugged durability, timeless
                      design, and unmatched capability. Built to conquer any terrain.</p>
                  </div>
                  <div class="card-footer bg-transparent border-0 pt-0 pb-4">
                    <div
                      class="d-flex flex-wrap justify-content-between gap-3 border-top fs-sm text-nowrap pt-3 pt-md-4">
              ...
              <div class="row g-0">
                ...
                <div class="col-sm-7 py-md-2">
                  <div class="card-body pb-3 pb-md-4">
                    ...
                    <p class="fs-sm pt-2 mt-1 mb-0">A sleek, luxurious vehicle featuring powerful performance, advanced
                      technology, and elegant design for a premium driving experience.</p>
                  </div>
                  <div class="card-footer bg-transparent border-0 pt-0 pb-4">
                    <div
                      class="d-flex flex-wrap justify-content-between gap-3 border-top fs-sm text-nowrap pt-3 pt-md-4">
            ...
            <article class="card hover-effect-scale bg-body-tertiary border-0 overflow-hidden">
              <div class="row g-0">
                <div class="col-sm-5 position-relative bg-body-secondary overflow-hidden" style="min-height: 220px">
                  ...
                  <img src="assets/img/listings/cars/list/07.jpg"
                    class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 object-fit-cover"
                    alt="Image">
                </div>
                <div class="col-sm-7 py-md-2">
                  <div class="card-body pb-3 pb-md-4">
                    ...
                    <h3 class="h5 mb-2">
                      <a class="hover-effect-underline stretched-link me-1" href="single-entry-cars.php">BMW Series
                        3</a>
                      <span class="fs-sm fw-normal text-body-secondary">(2021)</span>
                    </h3>
                    <div class="h6 mb-0">$42,000</div>
                    <p class="fs-sm pt-2 mt-1 mb-0">Blending cutting-edge technology with sporty handling, it offers a
                      thrilling driving experience wrapped in a sleek, modern design.</p>
                  </div>
                  <div class="card-footer bg-transparent border-0 pt-0 pb-4">
                    <div
                      class="d-flex flex-wrap justify-content-between gap-3 border-top fs-sm text-nowrap pt-3 pt-md-4">
            ...
            <article class="card hover-effect-scale bg-body-tertiary border-0 overflow-hidden">
              <div class="row g-0">
                <div class="col-sm-5 position-relative bg-body-secondary overflow-hidden" style="min-height: 220px">
                  ...
                  <img src="assets/img/listings/cars/list/08.jpg"
                    class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 object-fit-cover"
                    alt="Image">
                </div>
                <div class="col-sm-7 py-md-2">
                  <div class="card-body pb-3 pb-md-4">
                    ...
                    <p class="fs-sm pt-2 mt-1 mb-0">Experience the thrill of a V10 engine, precision handling, and the
                      luxury of top-down driving in an iconic, head-turning package.</p>
                  </div>
                  <div class="card-footer bg-transparent border-0 pt-0 pb-4">
                    <div
                      class="d-flex flex-wrap justify-content-between gap-3 border-top fs-sm text-nowrap pt-3 pt-md-4">

...
<head>
  <?php $title = "Doctors - Listings Grid View"; include('partials/title-meta.php'); ?>
...
<body class="bg-body-tertiary">
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="bookAppointment">
    <div class="offcanvas-header pt-3">
      <h5 class="offcanvas-title">Book an appointment</h5>
      <button type="button" class="btn-close" data-bs-dismiss="offcanvas" data-bs-target="#bookAppointment-1"
        aria-label="Close"></button>
    </div>
    <div class="offcanvas-body d-block pt-0">
      ...
      <button type="button" class="btn btn-lg btn-primary w-100 mt-4">
        <i class="fi-clock fs-lg me-2 ms-n1"></i>
  ...
  <main class="content-wrapper">
    <div class="container pt-4 pb-5 mb-xxl-3">
      ...
      <div class="d-flex align-items-center gap-2 gap-sm-3 mb-3 mb-sm-4">
        ...
        <div class="nav ms-n2">
          <a class="nav-link fs-xl text-body-secondary py-0 px-2 active pe-none" href="listings-grid-doctors.php"
            aria-label="Grid view">
            <i class="fi-grid"></i>
          </a>
          <a class="nav-link fs-xl text-body-secondary py-0 px-2" href="listings-list-doctors.php"
              ...
              <div class="w-100 ps-sm-4">
                <div class="d-flex flex-wrap align-items-center justify-content-between ms-3 ms-sm-0 mb-2">
                  <h3 class="h5 me-2 mb-0">
                    <a class="hover-effect-underline stretched-link" href="single-entry-doctors.php">Dr. Sophia
                      Davis</a>
                  </h3>
                ...
                <p class="fs-sm ms-n5 ms-sm-0">Dr. Davis is highly respected in her field, known for her innovative
                  treatment plans and her ability to connect with young patients and their families.</p>
            ...
            <div class="card-footer bg-transparent border-0 pt-0 p-4">
              ...
              <div class="d-flex flex-column flex-sm-row align-items-sm-center justify-content-between gap-3">
                ...
                <button type="button" class="btn btn-outline-primary" data-bs-toggle="offcanvas"
                  data-bs-target="#bookAppointment" aria-controls="bookAppointment">
                  Book an appointment
                </button>
              </div>
            </div>
          ...
          <article class="card h-100 border-0 z-1">
            <div class="card-body position-relative d-flex">
              <div class="flex-shrink-0">
                ...
                <div class="d-none d-xl-block" style="width: 150px"></div>
                <div class="ratio" style="--fn-aspect-ratio: calc(164 / 150 * 100%)">
                  <img src="assets/img/listings/doctors/09.jpg" class="bg-body-secondary rounded" alt="Image">
                </div>
              </div>
              <div class="w-100 ps-sm-4">
                <div class="d-flex flex-wrap align-items-center justify-content-between ms-3 ms-sm-0 mb-2">
                ...
                <div class="h6 fs-sm ms-3 ms-sm-0 mb-0">Cardiologist</div>
                <ul class="list-unstyled flex-row flex-wrap align-items-center gap-3 pt-3 ms-n5 ms-sm-0 mb-3">
                  <li class="badge text-bg-info d-inline-flex align-items-center me-n1">
                    Verified
                    <i class="fi-shield ms-1"></i>
                  ...
                  <li class="d-flex align-items-center fs-sm">
                    <i class="fi-user fs-base me-1"></i>
                    Adults
                  </li>
                  <li class="d-flex align-items-center fs-sm">
                    <i class="fi-baby fs-base me-1"></i>
                ...
                <p class="fs-sm ms-n5 ms-sm-0">Dr. Michael Johnston, a cardiologist with over two decades of experience,
                  offers advanced cardiovascular care, utilizing cutting-edge techniques and thorough diagnostic
                  analysis.</p>
                <ul class="list-unstyled fs-sm ms-n5 ms-sm-0 mb-0">
                  <li>
                    <span class="fw-semibold text-dark-emphasis me-1">Citywide Heart Clinic</span>
                    1.4 mi
                  </li>
                  <li>
                    <span class="fw-semibold text-dark-emphasis me-1">Skyline Medical Center</span>
                    3.2 mi
                  </li>
                </ul>
              </div>
            ...
            <div class="card-footer bg-transparent border-0 pt-0 p-4">
              ...
              <div class="d-flex flex-column flex-sm-row align-items-sm-center justify-content-between gap-3">
                <div class="d-flex flex-wrap align-items-center gap-2">
                  <div class="h5 me-1 mb-0">From $75.00</div>
                  <div class="fs-sm">Online / Offline</div>
                </div>
                <button type="button" class="btn btn-outline-primary" data-bs-toggle="offcanvas"
                  data-bs-target="#bookAppointment" aria-controls="bookAppointment">
                  Book an appointment
          ...
          <article class="card h-100 border-0 z-1">
            <div class="card-body position-relative d-flex">
              <div class="flex-shrink-0">
                ...
                <div class="d-none d-xl-block" style="width: 150px"></div>
                <div class="ratio" style="--fn-aspect-ratio: calc(164 / 150 * 100%)">
                  <img src="assets/img/listings/doctors/10.jpg" class="bg-body-secondary rounded" alt="Image">
                </div>
              </div>
              <div class="w-100 ps-sm-4">
                <div class="d-flex flex-wrap align-items-center justify-content-between ms-3 ms-sm-0 mb-2">
                  <h3 class="h5 me-2 mb-0">
                    <a class="hover-effect-underline stretched-link" href="single-entry-doctors.php">Dr. Gloria Fox</a>
                  </h3>
                  <div class="d-flex align-items-center gap-1">
                    <i class="fi-star-filled text-warning"></i>
                ...
                <p class="fs-sm ms-n5 ms-sm-0">Dr. Gloria Fox has extensive experience in caring for infants, children,
                  and adolescents. Known for her compassionate approach and expertise in child health.</p>
                <ul class="list-unstyled fs-sm ms-n5 ms-sm-0 mb-0">
                  <li>
                    <span class="fw-semibold text-dark-emphasis me-1">Bright Futures Pediatric Clinic</span>
                    1.3 mi
                  </li>
                  <li>
                    <span class="fw-semibold text-dark-emphasis me-1">Children's Health Center</span>
                    2.5 mi
                  </li>
                </ul>
              </div>
            ...
            <div class="card-footer bg-transparent border-0 pt-0 p-4">
              ...
              <div class="d-flex flex-column flex-sm-row align-items-sm-center justify-content-between gap-3">
                <div class="d-flex flex-wrap align-items-center gap-2">
                  <div class="h5 me-1 mb-0">From $30.00</div>
                  <div class="fs-sm">Online / Offline / Home visit</div>
                </div>
                <button type="button" class="btn btn-outline-primary" data-bs-toggle="offcanvas"
                  data-bs-target="#bookAppointment" aria-controls="bookAppointment">
          ...
          <article class="card h-100 border-0 z-1">
            <div class="card-body position-relative d-flex">
              <div class="flex-shrink-0">
                ...
                <div class="d-none d-xl-block" style="width: 150px"></div>
                <div class="ratio" style="--fn-aspect-ratio: calc(164 / 150 * 100%)">
                  <img src="assets/img/listings/doctors/11.jpg" class="bg-body-secondary rounded" alt="Image">
                </div>
              </div>
              <div class="w-100 ps-sm-4">
                <div class="d-flex flex-wrap align-items-center justify-content-between ms-3 ms-sm-0 mb-2">
                ...
                <div class="h6 fs-sm ms-3 ms-sm-0 mb-0">Neurologist</div>
                <ul class="list-unstyled flex-row flex-wrap align-items-center gap-3 pt-3 ms-n5 ms-sm-0 mb-3">
                  <li class="badge text-bg-info d-inline-flex align-items-center me-n1">
                    Verified
                    <i class="fi-shield ms-1"></i>
                ...
                <p class="fs-sm ms-n5 ms-sm-0">Dr. Williams is a distinguished neurologist specializing in the diagnosis
                  and treatment of neurological disorders. He provides comprehensive care through advanced diagnostic
                  techniques and tailored treatment plans.</p>
                <ul class="list-unstyled fs-sm ms-n5 ms-sm-0 mb-0">
                  <li>
                    <span class="fw-semibold text-dark-emphasis me-1">Central Neurology Clinic</span>
                    0.9 mi
                  </li>
                  <li>
                    <span class="fw-semibold text-dark-emphasis me-1">Chicago Brain and Spine Center</span>
                    1.8 mi
                  </li>
                </ul>
              </div>
            ...
            <div class="card-footer bg-transparent border-0 pt-0 p-4">
              ...
              <div class="d-flex flex-column flex-sm-row align-items-sm-center justify-content-between gap-3">
                <div class="d-flex flex-wrap align-items-center gap-2">
                  <div class="h5 me-1 mb-0">From $70.00</div>
                  <div class="fs-sm">Online / Offline</div>
                </div>
                <button type="button" class="btn btn-outline-primary" data-bs-toggle="offcanvas"
                  data-bs-target="#bookAppointment" aria-controls="bookAppointment">
          ...
          <article class="card h-100 border-0 z-1">
            <div class="card-body position-relative d-flex">
              <div class="flex-shrink-0">
                ...
                <div class="d-none d-xl-block" style="width: 150px"></div>
                <div class="ratio" style="--fn-aspect-ratio: calc(164 / 150 * 100%)">
                  <img src="assets/img/listings/doctors/12.jpg" class="bg-body-secondary rounded" alt="Image">
                </div>
              </div>
              <div class="w-100 ps-sm-4">
                <div class="d-flex flex-wrap align-items-center justify-content-between ms-3 ms-sm-0 mb-2">
                  <h3 class="h5 me-2 mb-0">
                    <a class="hover-effect-underline stretched-link" href="single-entry-doctors.php">Dr. David
                      McCluskey</a>
                  </h3>
                  <div class="d-flex align-items-center gap-1">
                    <i class="fi-star-filled text-warning"></i>
                    <span class="fs-sm text-secondary-emphasis">4.6</span>
                    <span class="fs-xs text-body-secondary align-self-end">(59)</span>
                  </div>
                </div>
                <div class="h6 fs-sm ms-3 ms-sm-0 mb-0">Endocrinologist</div>
                <ul class="list-unstyled flex-row flex-wrap align-items-center gap-3 pt-3 ms-n5 ms-sm-0 mb-3">
                  <li class="badge text-bg-info d-inline-flex align-items-center me-n1">
                    Verified
                    <i class="fi-shield ms-1"></i>
                ...
                <p class="fs-sm ms-n5 ms-sm-0">Dr. McCluskey is an experienced endocrinologist specializing in the
                  diagnosis and treatment of hormonal disorders. With a focus on diabetes, thyroid disease, and
                  metabolic imbalances.</p>
                <ul class="list-unstyled fs-sm ms-n5 ms-sm-0 mb-0">
                  <li>
                    <span class="fw-semibold text-dark-emphasis me-1">Lakeshore Endocrine Center</span>
                    1.2 mi
                  </li>
                  <li>
                    <span class="fw-semibold text-dark-emphasis me-1">South Loop Endocrinology Clinic</span>
                    3.4 mi
                  </li>
                </ul>
              </div>
            ...
            <div class="card-footer bg-transparent border-0 pt-0 p-4">
              ...
              <div class="d-flex flex-column flex-sm-row align-items-sm-center justify-content-between gap-3">
                <div class="d-flex flex-wrap align-items-center gap-2">
                  <div class="h5 me-1 mb-0">From $65.00</div>
                  <div class="fs-sm">Online / Offline</div>
                </div>
                <button type="button" class="btn btn-outline-primary" data-bs-toggle="offcanvas"
                  data-bs-target="#bookAppointment" aria-controls="bookAppointment">
          ...
          <article class="card h-100 border-0 z-1">
            <div class="card-body position-relative d-flex">
              <div class="flex-shrink-0">
                ...
                <div class="d-none d-xl-block" style="width: 150px"></div>
                <div class="ratio" style="--fn-aspect-ratio: calc(164 / 150 * 100%)">
                  <img src="assets/img/listings/doctors/13.jpg" class="bg-body-secondary rounded" alt="Image">
                </div>
              </div>
              <div class="w-100 ps-sm-4">
                <div class="d-flex flex-wrap align-items-center justify-content-between ms-3 ms-sm-0 mb-2">
                ...
                <div class="h6 fs-sm ms-3 ms-sm-0 mb-0">General Practitioner</div>
                <ul class="list-unstyled flex-row flex-wrap align-items-center gap-3 pt-3 ms-n5 ms-sm-0 mb-3">
                  <li class="d-flex align-items-center fs-sm">
                    <i class="fi-award fs-base me-1"></i>
                    11 years experience
                ...
                <p class="fs-sm ms-n5 ms-sm-0">Dr. Johnson is a dedicated general practitioner with a focus on providing
                  comprehensive, patient-centered care. With experience in diagnosing and managing a wide range of
                  health conditions, she takes a holistic approach to healthcare.</p>
                <ul class="list-unstyled fs-sm ms-n5 ms-sm-0 mb-0">
                  <li>
                    <span class="fw-semibold text-dark-emphasis me-1">Riverwalk Family Health Clinic</span>
                    1.3 mi
                  </li>
                  <li>
                    <span class="fw-semibold text-dark-emphasis me-1">Southside Wellness Medical Center</span>
                    2.7 mi
                  </li>
                </ul>
              </div>
            ...
            <div class="card-footer bg-transparent border-0 pt-0 p-4">
              ...
              <div class="d-flex flex-column flex-sm-row align-items-sm-center justify-content-between gap-3">
                <div class="d-flex flex-wrap align-items-center gap-2">
                  <div class="h5 me-1 mb-0">From $40.00</div>
                  <div class="fs-sm">Online / Offline / Home visit</div>
                </div>
                <button type="button" class="btn btn-outline-primary" data-bs-toggle="offcanvas"
                  data-bs-target="#bookAppointment" aria-controls="bookAppointment">
          ...
          <article class="card h-100 border-0 z-1">
            <div class="card-body position-relative d-flex">
              <div class="flex-shrink-0">
                ...
                <div class="d-none d-xl-block" style="width: 150px"></div>
                <div class="ratio" style="--fn-aspect-ratio: calc(164 / 150 * 100%)">
                  <img src="assets/img/listings/doctors/14.jpg" class="bg-body-secondary rounded" alt="Image">
                </div>
              </div>
              <div class="w-100 ps-sm-4">
                <div class="d-flex flex-wrap align-items-center justify-content-between ms-3 ms-sm-0 mb-2">
                  <h3 class="h5 me-2 mb-0">
                    <a class="hover-effect-underline stretched-link" href="single-entry-doctors.php">Dr. Thomas
                      Brown</a>
                  </h3>
                  <div class="d-flex align-items-center gap-1">
                    <i class="fi-star-filled text-warning"></i>
                    <span class="fs-sm text-secondary-emphasis">4.9</span>
                    <span class="fs-xs text-body-secondary align-self-end">(218)</span>
                  </div>
                </div>
                <div class="h6 fs-sm ms-3 ms-sm-0 mb-0">Orthopedic Surgeon</div>
                <ul class="list-unstyled flex-row flex-wrap align-items-center gap-3 pt-3 ms-n5 ms-sm-0 mb-3">
                  <li class="d-flex align-items-center fs-sm">
                    <i class="fi-award fs-base me-1"></i>
                    17 years experience
                ...
                <p class="fs-sm ms-n5 ms-sm-0">Dr. Thomas Brown is a renowned orthopedic surgeon specializing in the
                  treatment of musculoskeletal conditions, including joint replacements, fractures, and sports injuries.
                </p>
                <ul class="list-unstyled fs-sm ms-n5 ms-sm-0 mb-0">
                  <li>
                    <span class="fw-semibold text-dark-emphasis me-1">Lincoln Park Orthopedic Center</span>
                    1.5 mi
                  </li>
                  <li>
                    <span class="fw-semibold text-dark-emphasis me-1">Windy City Orthopedic Institute</span>
                    2.2 mi
                  </li>
                </ul>
              </div>
            ...
            <div class="card-footer bg-transparent border-0 pt-0 p-4">
              ...
              <div class="d-flex flex-column flex-sm-row align-items-sm-center justify-content-between gap-3">
                <div class="d-flex flex-wrap align-items-center gap-2">
                  <div class="h5 me-1 mb-0">From $80.00</div>
                  <div class="fs-sm">Online / Offline</div>
                </div>
                <button type="button" class="btn btn-outline-primary" data-bs-toggle="offcanvas"
                  data-bs-target="#bookAppointment" aria-controls="bookAppointment">
          ...
          <article class="card h-100 border-0 z-1">
            <div class="card-body position-relative d-flex">
              <div class="flex-shrink-0">
                ...
                <div class="d-none d-xl-block" style="width: 150px"></div>
                <div class="ratio" style="--fn-aspect-ratio: calc(164 / 150 * 100%)">
                  <img src="assets/img/listings/doctors/15.jpg" class="bg-body-secondary rounded" alt="Image">
                </div>
              </div>
              <div class="w-100 ps-sm-4">
                <div class="d-flex flex-wrap align-items-center justify-content-between ms-3 ms-sm-0 mb-2">
                ...
                <div class="h6 fs-sm ms-3 ms-sm-0 mb-0">Dermatologist</div>
                <ul class="list-unstyled flex-row flex-wrap align-items-center gap-3 pt-3 ms-n5 ms-sm-0 mb-3">
                  <li class="badge text-bg-info d-inline-flex align-items-center me-n1">
                    Verified
                    <i class="fi-shield ms-1"></i>
                ...
                <ul class="list-unstyled fs-sm ms-n5 ms-sm-0 mb-0">
                  <li>
                    <span class="fw-semibold text-dark-emphasis me-1">Lakeside Dermatology Clinic</span>
                    1.5 mi
                  </li>
                  <li>
                    <span class="fw-semibold text-dark-emphasis me-1">North Shore Skin Care Center</span>
                    2.2 mi
                  </li>
                </ul>
              </div>
            ...
            <div class="card-footer bg-transparent border-0 pt-0 p-4">
              ...
              <div class="d-flex flex-column flex-sm-row align-items-sm-center justify-content-between gap-3">
                <div class="d-flex flex-wrap align-items-center gap-2">
                  <div class="h5 me-1 mb-0">From $55.00</div>
                  <div class="fs-sm">Online / Offline</div>
                </div>
                <button type="button" class="btn btn-outline-primary" data-bs-toggle="offcanvas"
                  data-bs-target="#bookAppointment" aria-controls="bookAppointment">
          ...
          <article class="card h-100 border-0 z-1">
            <div class="card-body position-relative d-flex">
              <div class="flex-shrink-0">
                ...
                <div class="d-none d-xl-block" style="width: 150px"></div>
                <div class="ratio" style="--fn-aspect-ratio: calc(164 / 150 * 100%)">
                  <img src="assets/img/listings/doctors/16.jpg" class="bg-body-secondary rounded" alt="Image">
                </div>
              </div>
              <div class="w-100 ps-sm-4">
                <div class="d-flex flex-wrap align-items-center justify-content-between ms-3 ms-sm-0 mb-2">
                ...
                <p class="fs-sm ms-n5 ms-sm-0">Dr. Vanessa Thompson is a highly regarded endocrinologist specializing in
                  the diagnosis of hormonal disorders, including thyroid conditions, diabetes, and metabolic issues.</p>
                <ul class="list-unstyled fs-sm ms-n5 ms-sm-0 mb-0">
                  <li>
                    <span class="fw-semibold text-dark-emphasis me-1">Westside Endocrine Specialists</span>
                    1.4 mi
                  </li>
                  <li>
                    <span class="fw-semibold text-dark-emphasis me-1">Magnolia Endocrinology Center</span>
                    2.6 mi
                  </li>
                </ul>
              </div>
            ...
            <div class="card-footer bg-transparent border-0 pt-0 p-4">
              ...
              <div class="d-flex flex-column flex-sm-row align-items-sm-center justify-content-between gap-3">
                <div class="d-flex flex-wrap align-items-center gap-2">
                  <div class="h5 me-1 mb-0">From $45.00</div>
                  <div class="fs-sm">Online / Offline / Home visit</div>
                </div>
                <button type="button" class="btn btn-outline-primary" data-bs-toggle="offcanvas"
                  data-bs-target="#bookAppointment" aria-controls="bookAppointment">
          ...
          <article class="card h-100 border-0 z-1">
            <div class="card-body position-relative d-flex">
              <div class="flex-shrink-0">
                ...
                <div class="d-none d-xl-block" style="width: 150px"></div>
                <div class="ratio" style="--fn-aspect-ratio: calc(164 / 150 * 100%)">
                  <img src="assets/img/listings/doctors/17.jpg" class="bg-body-secondary rounded" alt="Image">
                </div>
              </div>
              <div class="w-100 ps-sm-4">
                <div class="d-flex flex-wrap align-items-center justify-content-between ms-3 ms-sm-0 mb-2">
                ...
                <p class="fs-sm ms-n5 ms-sm-0">Dr. Parker is a highly skilled orthopedic surgeon specializing in the
                  diagnosis and surgical treatment of musculoskeletal conditions. He helps patients recover from
                  injuries.</p>
                <ul class="list-unstyled fs-sm ms-n5 ms-sm-0 mb-0">
                  <li>
                    <span class="fw-semibold text-dark-emphasis me-1">Lakeview Orthopedic Institute</span>
                    1.5 mi
                  </li>
                  <li>
                    <span class="fw-semibold text-dark-emphasis me-1">Midtown Joint and Spine Center</span>
                    2.3 mi
                  </li>
                </ul>
              </div>

...
<html lang="en" data-bs-theme="light" data-pwa="true">
  <head>
    ...
    <title>Finder Docs | Images &amp; figures</title>
      ...
      <div class="row pt-sm-2">
                  ...
                  <nav class="docs-list list-group list-group-borderless" onclick="closeSidebar()">
                    ...
                    <div class="dropdown">
                      ...
                      <ul id="anchorNav" class="nav nav-underline flex-column border-start ms-2 my-2" style="gap: .25rem;">
                        <li class="nav-item"><a class="nav-link fw-normal" href="#image-shapes">Image shapes</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#image-thumbnails">Thumbnails</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#figures">Figures with caption</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#image-swap">Image swap on hover</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#image-scale">Image scale on hover</a></li>
                      </ul>
                    </div>
                    <div class="dropend">
        ...
        <main class="col-lg-9 pt-1 pb-5 mb-sm-2 mb-md-3">
          ...
          <section class="py-2 pb-sm-3">
            <a class="badge d-inline-flex align-items-center text-info bg-info-subtle fw-semibold text-decoration-none py-2 px-3 mb-2 rounded-pill" href="https://getbootstrap.com/docs/5.3/content/images/" target="_blank" rel="noreferrer">
              Bootstrap docs
          ...
          <!-- Image shapes -->
          <section id="image-shapes" class="docs-section pb-sm-2 mb-5">
            <h4>Image shapes</h4>
                ...
                <div class="tab-content">
                  <div id="preview-1" class="tab-pane pt-4 pb-2 mt-3 fade show active" role="tabpanel">
                    <div class="row row-cols-1 row-cols-sm-3 gx-3 gx-md-4 gy-4">
                      <div class="col">
                        <div class="ratio ratio-1x1 bg-body-secondary">
                          <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center display-5">
                            <i class="fi-image opacity-75"></i>
                          </div>
                        </div>
                      </div>
                      <div class="col">
                        <div class="ratio ratio-1x1 bg-body-secondary rounded-4">
                          <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center display-5">
                            <i class="fi-image opacity-75"></i>
                          </div>
                        </div>
                      ...
                      <div class="col">
                        <div class="ratio ratio-1x1 bg-body-secondary rounded-circle">
                          <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center display-5">
                            <i class="fi-image opacity-75"></i>
                          </div>
                        </div>
                  ...
                  <div id="html-1" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#image-shapes-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
                      <pre id="image-shapes-code" class="code-highlight mx-n2 mb-n2"><code class="language-html">&lt;!-- Square image (default) --&gt;
&lt;img src=&quot;...&quot; alt=&quot;...&quot;&gt;
...
&lt;!-- Circle image --&gt;
&lt;img src=&quot;...&quot; class=&quot;rounded-circle&quot; alt=&quot;...&quot;&gt;</code></pre>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <!-- Thumbnails -->
          <section id="image-thumbnails" class="docs-section pb-sm-2 mb-5">
            <h4>Thumbnails</h4>
            <div class="card border-0 shadow">
              <span class="d-none d-block-dark position-absolute top-0 start-0 w-100 h-100 bg-dark rounded opacity-50"></span>
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  ...
                  <div id="html-2" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#image-thumbnails-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
                      <pre id="image-thumbnails-code" class="code-highlight mx-n2 mb-n2"><code class="language-html">&lt;!-- Square thumbnail --&gt;
...
&lt;!-- Circle thumbnail --&gt;
&lt;img src=&quot;...&quot; class=&quot;img-thumbnail rounded-circle&quot; alt=&quot;...&quot;&gt;</code></pre>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <section id="figures" class="docs-section pb-sm-2 mb-5">
              ...
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  <div id="preview-3" class="tab-pane pt-4 pb-2 mt-3 fade show active" role="tabpanel">
                    <div class="row row-cols-1 row-cols-sm-3 gx-3 gx-md-4 gy-4">
                      <div class="col">
                        <figure class="figure w-100 mb-0" style="max-width: 290px;">
                          <div class="figure-img ratio ratio-4x3 bg-body-secondary rounded">
                            <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center display-5">
                              <i class="fi-image opacity-75"></i>
                            </div>
                          </div>
                  ...
                  <div id="html-3" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#figures-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
...
&lt;/figure&gt;</code></pre>
          ...
          <!-- Image swap on hover -->
          <section id="image-swap" class="docs-section pb-sm-2 mb-5">
              ...
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  ...
                  <div id="html-4" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#image-swap-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
...
&lt;/div&gt;</code></pre>
          ...
          <section id="image-scale" class="docs-section">
              ...
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  ...
                  <div id="html-5" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#image-scale-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>

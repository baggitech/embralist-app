...
<head>
  <?php $title = "Add Contractor - Profile Details"; include('partials/title-meta.php'); ?>
        ...
        <div class="overflow-x-auto">
          <div class="d-flex flex-nowrap align-items-center gap-1 pb-3 mb-md-1">
            ...
            <div class="d-flex align-items-center gap-2 gap-sm-3 text-nowrap">
              <div class="d-flex align-items-center justify-content-center bg-white rounded-circle flex-shrink-0"
                style="width: 44px; height: 44px">
                <i class="fi-user-check fs-lg text-info"></i>
              </div>
      ...
      <div class="row pt-md-1 pt-lg-2 pt-xl-3 pb-2 pb-sm-3 pb-md-4 pb-lg-5">
        ...
        <div class="col-lg-7">
          ...
          <div class="d-flex align-items-start align-items-sm-center">
            <div class="ratio ratio-1x1 hover-effect-opacity bg-body-tertiary border rounded-circle overflow-hidden"
              style="width: 160px">
              <img src="assets/img/add-item/contractor/avatar.jpg" alt="Avatar">
              <div
          ...
          <!-- Next step button -->
          <div class="pt-5">
            <a class="btn btn-lg btn-dark" href="add-contractor-price-hours.php">
        ...
        <div class="col-lg-5 d-none d-lg-block">
          <svg xmlns="http://www.w3.org/2000/svg" width="526" viewBox="0 0 526 526" fill="none">
            <rect x="25.5" y="74.5" width="476" height="377" rx="18.5" stroke="currentColor" stroke-width="5"
              style="color: var(--fn-info-border-subtle)" />
            <path fill="currentColor" d="M28 77h471v30H28z" style="color: var(--fn-info-border-subtle)" />
            <g fill="currentColor" style="color: var(--fn-body-bg)">
              <circle cx="51.5" cy="92.5" r="5.5" />
              <circle cx="69.5" cy="92.5" r="5.5" />
              <circle cx="87.5" cy="92.5" r="5.5" />
            </g>
            <g clip-path="url(#A)">
              <circle class="text-info" cx="104.5" cy="183.5" r="52" stroke="currentColor" />
              <g class="text-info" fill="currentColor">
                <path
                  d="M88.559 157c-.376-.02-.673 0-.99.019-.218.02-.455.02-.633.06-.218.039-.356.138-.515.217-.099.059-.178.099-.237.178.099.04.158.158.277.178 1.583.553 3.028.257 4.473-.297l-1.742-.276c-.198-.04-.435-.06-.633-.079zm38.455 17.83c.039.455.02.91.02 1.384.396-.079.653-.237.752-.474.178-.455-.198-1.147-1.01-2.017.08.356.198.732.238 1.107zm-37.032 54.797l4.473-16.882-1.069-.336-2.91 10.971-1.564 5.871 1.069.376zm27.832-.475c.376-.158.693-.237 1.089-.395l-.614-6.603-1.108-12.058-1.049.751 1.682 18.305z" />
              </g>
              <path
                d="M56.375 306.662l10.668-.178-.356-.929 2.237-.04 6.116-71.757.099-1.225.376-4.409c0-.039 0-.079.02-.118-5.878 2.372-17.892 9.31-22.939 12.79l.119 1.937 3.503 61.675.158 2.254z"

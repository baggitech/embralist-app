...
<head>
  <?php $title = "Real Estate - Map/Listings Split View"; include('partials/title-meta.php'); ?>
...
<body>
      ...
      <div class="row row-cols-1 row-cols-md-2 g-4 pb-3 mb-3">
        <div class="col">
          ...
          <div class="position-relative w-100">
            ...
            <input type="search" class="form-control form-icon-start" value="New York, Brooklyn"
          ...
          <div class="row g-3">
            ...
            <div class="col-7">
              <div class="dropdown w-100">
                <button type="button"
                  class="btn btn-outline-secondary dropdown-toggle justify-content-between w-100 text-body fw-normal px-3"
                ...
                <div class="dropdown-menu w-100 p-3" style="--fn-dropdown-min-width: 0">
                  <div class="d-flex flex-column gap-2">
                    <div class="form-check m-0">
                      <input type="checkbox" class="form-check-input fs-base" id="apartments-offcanvas" checked
                        onclick="updateFilterCount('typeCountOffcanvas')" data-count-id="typeCountOffcanvas">
                    ...
                    <div class="form-check m-0">
                      <input type="checkbox" class="form-check-input fs-base" id="houses-offcanvas"
                        onclick="updateFilterCount('typeCountOffcanvas')" data-count-id="typeCountOffcanvas">
                    ...
                    <div class="form-check m-0">
                      <input type="checkbox" class="form-check-input fs-base" id="condos-offcanvas"
                        onclick="updateFilterCount('typeCountOffcanvas')" data-count-id="typeCountOffcanvas">
                    ...
                    <div class="form-check m-0">
                      <input type="checkbox" class="form-check-input fs-base" id="townhomes-offcanvas"
                        onclick="updateFilterCount('typeCountOffcanvas')" data-count-id="typeCountOffcanvas">
  ...
  <header class="navbar navbar-expand-lg bg-body navbar-sticky sticky-top z-fixed px-0" data-sticky-element>
    <div class="container-fluid px-lg-4 px-xxl-5">
      ...
      <div class="map-section">
        <div class="offcanvas-lg offcanvas-start d-flex flex-column w-100 h-100" id="map">
          <div class="offcanvas-body position-relative h-100 p-0">
            <button type="button"
              class="btn btn-icon btn-outline-secondary bg-body shadow position-absolute top-0 z-5 mt-2 d-lg-none"
              style="right: 0; margin-right: 8px; z-index: 500" data-bs-dismiss="offcanvas" data-bs-target="#map"
              aria-label="Close">
            ...
            <div class="position-absolute top-0 start-0 w-100 h-100 bg-body-tertiary" data-map='{
                ...
                "templates": {
                  ...
                  "popup": "<div class=\"card bg-transparent border-0\" data-bs-theme=\"light\"><div class=\"card-img-top position-relative bg-body-tertiary overflow-hidden\"><div class=\"ratio d-block\" style=\"--fn-aspect-ratio: calc(248 / 362 * 100%)\"><img src=\"{{image}}\" alt=\"Image\"></div></div><div class=\"card-body p-3\"><div class=\"h5 mb-2\">${{price}}</div><h3 class=\"fs-sm fw-normal text-body mb-2\"><a class=\"stretched-link text-body\" href=\"single-entry-real-estate.php\">{{address}}</a></h3><div class=\"h6 fs-sm mb-0\">{{area}} sq.m</div></div><div class=\"card-footer d-flex gap-2 border-0 bg-transparent pt-0 pb-3 px-3 mt-n1\"><div class=\"d-flex align-items-center fs-sm gap-1 me-1\">{{bedrooms}}<i class=\"fi-bed-single fs-base text-secondary-emphasis\"></i></div><div class=\"d-flex align-items-center fs-sm gap-1 me-1\">{{bathrooms}}<i class=\"fi-shower fs-base text-secondary-emphasis\"></i></div><div class=\"d-flex align-items-center fs-sm gap-1 me-1\">{{garage}}<i class=\"fi-car-garage fs-base text-secondary-emphasis\"></i></div></div></div>"
                }
      ...
      <div class="listings-section px-3 px-lg-4 pe-xxl-5">
        ...
        <div class="sticky-top bg-body mb-2 mb-sm-1">
          ...
          <div class="d-flex gap-2 gap-sm-3 py-2 py-sm-3">
            ...
            <div class="dropdown flex-shrink-0 d-none d-xxl-block" style="width: 180px">
              ...
              <div class="dropdown-menu w-100 p-3" style="--fn-dropdown-min-width: 0">
                <div class="d-flex flex-column gap-2">
                  ...
                  <div class="form-check m-0">
                    <input type="checkbox" class="form-check-input fs-base" id="houses"
                      onclick="updateFilterCount('typeCount')" data-count-id="typeCount">
                  ...
                  <div class="form-check m-0">
                    <input type="checkbox" class="form-check-input fs-base" id="condos"
                      onclick="updateFilterCount('typeCount')" data-count-id="typeCount">
                  ...
                  <div class="form-check m-0">
                    <input type="checkbox" class="form-check-input fs-base" id="townhomes"
                      onclick="updateFilterCount('typeCount')" data-count-id="typeCount">
            ...
            <button type="button" class="btn btn-outline-dark pe-3 d-lg-none" data-bs-toggle="offcanvas"
              data-bs-target="#map" aria-controls="map">
            ...
            <div class="position-relative">
              <span
                class="badge text-bg-primary rounded-pill position-absolute top-0 start-100 translate-middle mt-1 ms-n1">3</span>
              <button type="button" class="btn btn-icon btn-dark" data-bs-toggle="offcanvas" data-bs-target="#filters"
                aria-controls="filters" aria-label="Toogle filters">
        ...
        <div class="row row-cols-1 row-cols-sm-2 g-4">
          ...
          <!-- Listing -->
          <div class="col">
            <article class="card hover-effect-opacity h-100" data-map-bind-to-marker="2">
              <div class="card-img-top position-relative bg-body-tertiary overflow-hidden">
                <div class="swiper z-2" data-swiper='{
                    "pagination": {
                      "el": ".swiper-pagination"
          ...
          <!-- Listing -->
          <div class="col">
            <article class="card hover-effect-opacity h-100" data-map-bind-to-marker="3">
              <div class="card-img-top position-relative bg-body-tertiary overflow-hidden">
                <div class="swiper z-2" data-swiper='{
                    "pagination": {
                      "el": ".swiper-pagination"
          ...
          <!-- Listing -->
          <div class="col">
            <article class="card hover-effect-opacity h-100" data-map-bind-to-marker="4">
              <div class="card-img-top position-relative bg-body-tertiary overflow-hidden">
                <div class="swiper z-2" data-swiper='{
                    "pagination": {
                      "el": ".swiper-pagination"
          ...
          <!-- Listing -->
          <div class="col">
            <article class="card hover-effect-opacity h-100" data-map-bind-to-marker="5">
              <div class="card-img-top position-relative bg-body-tertiary overflow-hidden">
                <div class="swiper z-2" data-swiper='{
                    "pagination": {
                      "el": ".swiper-pagination"
          ...
          <!-- Listing -->
          <div class="col">
            <article class="card hover-effect-opacity h-100" data-map-bind-to-marker="6">
              <div class="card-img-top position-relative bg-body-tertiary overflow-hidden">
                <div class="swiper z-2" data-swiper='{
                    "pagination": {
                      "el": ".swiper-pagination"
          ...
          <!-- Listing -->
          <div class="col">
            <article class="card hover-effect-opacity h-100" data-map-bind-to-marker="7">
              <div class="card-img-top position-relative bg-body-tertiary overflow-hidden">
                <div class="swiper z-2" data-swiper='{
                    "pagination": {
                      "el": ".swiper-pagination"
          ...
          <!-- Listing -->
          <div class="col">
            <article class="card hover-effect-opacity h-100" data-map-bind-to-marker="8">
              <div class="card-img-top position-relative bg-body-tertiary overflow-hidden">
                <div class="swiper z-2" data-swiper='{
                    "pagination": {
                      "el": ".swiper-pagination"
                  ...
                  <a class="swiper-wrapper" href="single-entry-real-estate.php">
                    <div class="swiper-slide">
                      <div class="ratio d-block" style="--fn-aspect-ratio: calc(248 / 362 * 100%)">
                        <img src="assets/img/listings/real-estate/08.jpg" alt="Image">
                        <span class="position-absolute top-0 start-0 w-100 h-100 z-1"
                          style="background: linear-gradient(180deg, rgba(0,0,0, 0) 0%, rgba(0,0,0, .11) 100%)"></span>
                      </div>
                    </div>
              ...
              <div class="card-body p-3">
                <div class="h5 mb-2">$1,560</div>
                <h3 class="fs-sm fw-normal text-body mb-2">
                  <a class="stretched-link text-body" href="single-entry-real-estate.php">124 Maple Street, Brooklyn,
                    NY 11211</a>
                </h3>
                <div class="h6 fs-sm mb-0">50 sq.m</div>
              </div>
              <div class="card-footer d-flex gap-2 border-0 bg-transparent pt-0 pb-3 px-3 mt-n1">
                <div class="d-flex align-items-center fs-sm gap-1 me-1">
                  1<i class="fi-bed-single fs-base text-secondary-emphasis"></i>
          ...
          <!-- Listing -->
          <div class="col">
            <article class="card hover-effect-opacity h-100" data-map-bind-to-marker="9">
              <div class="card-img-top position-relative bg-body-tertiary overflow-hidden">
                <div class="swiper z-2" data-swiper='{
                    "pagination": {
                      "el": ".swiper-pagination"
              ...
              <div class="card-body p-3">
                ...
                <h3 class="fs-sm fw-normal text-body mb-2">
                  <a class="stretched-link text-body" href="single-entry-real-estate.php">212 Harrison Street,
                    Brooklyn, NY 11240</a>
                </h3>
          ...
          <!-- Listing -->
          <div class="col">
            <article class="card hover-effect-opacity h-100" data-map-bind-to-marker="10">
              <div class="card-img-top position-relative bg-body-tertiary overflow-hidden">
                <div class="swiper z-2" data-swiper='{
                    "pagination": {
                      "el": ".swiper-pagination"
                  ...
                  <a class="swiper-wrapper" href="single-entry-real-estate.php">
                    <div class="swiper-slide">
                      <div class="ratio d-block" style="--fn-aspect-ratio: calc(248 / 362 * 100%)">
                        <img src="assets/img/listings/real-estate/10.jpg" alt="Image">
                        <span class="position-absolute top-0 start-0 w-100 h-100 z-1"
                          style="background: linear-gradient(180deg, rgba(0,0,0, 0) 0%, rgba(0,0,0, .11) 100%)"></span>
                      </div>
                    </div>
              ...
              <div class="card-body p-3">
                <div class="h5 mb-2">$2,950</div>
                <h3 class="fs-sm fw-normal text-body mb-2">
                  <a class="stretched-link text-body" href="single-entry-real-estate.php">456 Court Street, Brooklyn,
                    NY 11231</a>
                </h3>
                <div class="h6 fs-sm mb-0">96 sq.m</div>
              </div>
              <div class="card-footer d-flex gap-2 border-0 bg-transparent pt-0 pb-3 px-3 mt-n1">
                <div class="d-flex align-items-center fs-sm gap-1 me-1">
                  3<i class="fi-bed-single fs-base text-secondary-emphasis"></i>
        ...
        <footer class="text-center pt-4 pt-md-5">
          ...
          <div class="d-flex justify-content-center pt-2 mt-3">
            <a class="btn btn-icon fs-base btn-outline-secondary border-0" href="#!" data-bs-toggle="tooltip"
              data-bs-template='<div class="tooltip fs-xs mb-n2" role="tooltip"><div class="tooltip-inner bg-transparent text-body opacity-75 p-0"></div></div>'
          ...
          <div class="py-4">
            <p class="text-body-secondary fs-sm mb-0 mb-sm-2">&copy; All rights reserved. Made by <a

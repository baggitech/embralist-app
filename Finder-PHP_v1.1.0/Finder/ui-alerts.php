...
<html lang="en" data-bs-theme="light" data-pwa="true">
  <head>
    ...
    <title>Finder Docs | Alerts</title>
      ...
      <div class="row pt-sm-2">
                  ...
                  <nav class="docs-list list-group list-group-borderless" onclick="closeSidebar()">
                    ...
                    <div class="dropdown">
                      ...
                      <ul id="anchorNav" class="nav nav-underline flex-column border-start ms-2 my-2" style="gap: .25rem;">
                        <li class="nav-item"><a class="nav-link fw-normal" href="#alerts-basic">Basic example</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#alerts-icon">Alert with icon</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#alerts-dismissible">Dismissible alerts</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#alerts-additional-content">Additional content</a></li>
                      </ul>
                    </div>
                    <div class="dropend">
        ...
        <main class="col-lg-9 pt-1 pb-5 mb-sm-2 mb-md-3">
          ...
          <section class="py-2 pb-sm-3">
            <a class="badge d-inline-flex align-items-center text-info bg-info-subtle fw-semibold text-decoration-none py-2 px-3 mb-2 rounded-pill" href="https://getbootstrap.com/docs/5.3/components/alerts/" target="_blank" rel="noreferrer">
              Bootstrap docs
          ...
          <!-- Basic example -->
          <section id="alerts-basic" class="docs-section pb-sm-2 mb-5">
            <h4>Basic example</h4>
                ...
                <div class="tab-content">
                  ...
                  <div id="html-1" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#alerts-basic-code">
...
&lt;/div&gt;</code></pre>
          ...
          <!-- Alert with icon -->
          <section id="alerts-icon" class="docs-section pb-sm-2 mb-5">
                ...
                <div class="tab-content">
                  <div id="preview-2" class="tab-pane pt-4 pb-2 mt-3 fade show active" role="tabpanel">
                    <div class="alert d-flex alert-primary" role="alert">
                      <i class="fi-bell fs-lg pe-1 mt-1 me-2"></i>
                    ...
                    <div class="alert d-flex alert-secondary" role="alert">
                      <i class="fi-clock fs-lg pe-1 mt-1 me-2"></i>
                    ...
                    <div class="alert d-flex alert-danger" role="alert">
                      <i class="fi-banned fs-lg pe-1 mt-1 me-2"></i>
                    ...
                    <div class="alert d-flex alert-warning" role="alert">
                      <i class="fi-alert-triangle fs-lg pe-1 mt-1 me-2"></i>
                    ...
                    <div class="alert d-flex alert-light" role="alert">
                      <i class="fi-unlock fs-lg pe-1 mt-1 me-2"></i>
                    ...
                    <div class="alert d-flex alert-dark mb-0" role="alert">
                      <i class="fi-map-pin fs-lg pe-1 mt-1 me-2"></i>
                  ...
                  <div id="html-2" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#alerts-icon-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
...
&lt;/div&gt;</code></pre>
          ...
          <!-- Dismissible alerts -->
          <section id="alerts-dismissible" class="docs-section pb-sm-2 mb-5">
              ...
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  ...
                  <div id="html-3" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#alerts-dismissible-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
...
&lt;/div&gt;</code></pre>
          ...
          <!-- Additional content -->
          <section id="alerts-additional-content" class="docs-section">
                ...
                <div class="tab-content">
                  <div id="preview-4" class="tab-pane pt-4 pb-2 mt-3 fade show active" role="tabpanel">
                    <div class="alert d-sm-flex alert-success pb-4 pt-sm-4 mb-0" role="alert">
                      <i class="fi-check-circle fs-4 mt-1 mb-2 mb-sm-0"></i>
                  ...
                  <div id="html-4" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#alerts-additional-content-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>

...
<html lang="en" data-bs-theme="light" data-pwa="true">
  <head>
    ...
    <title>Finder Docs | Dropdowns</title>
      ...
      <div class="row pt-sm-2">
                  ...
                  <nav class="docs-list list-group list-group-borderless" onclick="closeSidebar()">
                    ...
                    <div class="dropdown">
                      ...
                      <ul id="anchorNav" class="nav nav-underline flex-column border-start ms-2 my-2" style="gap: .25rem;">
                        <li class="nav-item"><a class="nav-link fw-normal" href="#dropdowns-static">Static examples</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#dropdowns-dark">Dark dropdowns</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#dropdowns-forms">Forms inside dropdown</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#dropdowns-directions">Directions</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#dropdowns-hover">Show on hover / focus</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#dropdowns-alignment">Menu alignment</a></li>
                        <li class="nav-item"><a class="nav-link fw-normal" href="#dropdowns-split-btn">Split button</a></li>
                      </ul>
                    </div>
                    <div class="dropend">
        ...
        <main class="col-lg-9 pt-1 pb-5 mb-sm-2 mb-md-3">
          ...
          <section class="py-2 pb-sm-3">
            <a class="badge d-inline-flex align-items-center text-info bg-info-subtle fw-semibold text-decoration-none py-2 px-3 mb-2 rounded-pill" href="https://getbootstrap.com/docs/5.3/components/dropdowns/" target="_blank" rel="noreferrer">
              Bootstrap docs
          ...
          <!-- Static examples -->
          <section id="dropdowns-static" class="docs-section pb-sm-2 mb-5">
                ...
                <div class="tab-content">
                  <div id="preview-1" class="tab-pane pt-4 mt-3 fade show active" role="tabpanel">
                    ...
                    <ul class="dropdown-menu d-inline-block align-top mb-3" style="position: static; width: 12.5rem">
                      ...
                      <li>
                        <a class="dropdown-item" href="#!">
                          <i class="fi-message-square opacity-75 me-2"></i>
                          Messages
                  ...
                  <div id="html-1" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#dropdowns-static-code">
...
&lt;/ul&gt;</code></pre>
          ...
          <!-- Dark dropdowns -->
          <section id="dropdowns-dark" class="docs-section pb-sm-2 mb-5">
              ...
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  <div id="preview-2" class="tab-pane pt-4 pb-2 mt-3 fade show active" role="tabpanel">
                    <ul class="dropdown-menu d-inline-block align-top me-4 mb-3" style="position: static; width: 12.5rem" data-bs-theme="dark">
                      <li><a class="dropdown-item" href="#!">Regular link</a></li>
                      <li><a class="dropdown-item" href="#!">Another regular link</a></li>
                      <li><a class="dropdown-item active" href="#!">Active link</a></li>
                      <li><a class="dropdown-item disabled" href="#!">Disabled link</a></li>
                    ...
                    <ul class="dropdown-menu d-inline-block align-top mb-3" style="position: static; width: 12.5rem" data-bs-theme="dark">
                      <li>
                        <a class="dropdown-item" href="#!">
                          <i class="fi-home opacity-75 me-2"></i>
                          Home
                  ...
                  <div id="html-2" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#dropdowns-dark-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
...
&lt;/ul&gt;</code></pre>
          ...
          <section id="dropdowns-forms" class="docs-section pb-sm-2 mb-5">
              ...
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  ...
                  <div id="html-3" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#dropdowns-forms-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
...
&lt;/div&gt;</code></pre>
          ...
          <!-- Directions -->
          <section id="dropdowns-directions" class="docs-section pb-sm-2 mb-5">
            <h4>Directions</h4>
            <div class="card border-0 shadow">
              <span class="d-none d-block-dark position-absolute top-0 start-0 w-100 h-100 bg-dark rounded opacity-50"></span>
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  ...
                  <div id="html-4" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#dropdowns-directions-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
...
&lt;/div&gt;</code></pre>
          ...
          <!-- Show on hover / focus -->
          <section id="dropdowns-hover" class="docs-section pb-sm-2 mb-5">
              ...
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  ...
                  <div id="html-5" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#dropdowns-hover-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
...
&lt;/div&gt;</code></pre>
          ...
          <!-- Menu alignment -->
          <section id="dropdowns-alignment" class="docs-section pb-sm-2 mb-5">
              ...
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  ...
                  <div id="html-6" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#dropdowns-alignment-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>
...
&lt;/div&gt;</code></pre>
          ...
          <!-- Split button -->
          <section id="dropdowns-split-btn" class="docs-section">
            <h4>Split button</h4>
            <div class="card border-0 shadow">
              <span class="d-none d-block-dark position-absolute top-0 start-0 w-100 h-100 bg-dark rounded opacity-50"></span>
              <div class="card-body position-relative z-2">
                ...
                <div class="tab-content">
                  <div id="preview-7" class="tab-pane pt-4 pb-3 mt-3 fade show active" role="tabpanel">
                    <div class="hstack flex-wrap gap-3">
                      <div class="btn-group">
                        ...
                        <button type="button" class="btn btn-primary dropdown-toggle dropdown-toggle-split position-relative z-1 border-0 border-start border-light" style="--fn-border-opacity: .25;" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  ...
                  <div id="html-7" class="tab-pane pt-4 fade" role="tabpanel">
                    <div class="position-relative" data-bs-theme="dark">
                      <button type="button" class="btn btn-sm btn-outline-secondary bg-dark position-absolute top-0 end-0 mt-2 px-2 z-3" data-copy-code="#dropdowns-split-btn-code">
                        <i class="fi-copy fs-sm me-1"></i>
                        Copy
                      </button>

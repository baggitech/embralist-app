  <header class="navbar navbar-expand-lg bg-body navbar-sticky sticky-top z-fixed px-0" data-sticky-element>
    <div class="container">
      ...
      <div class="d-flex gap-sm-1">
          ...
          <ul class="dropdown-menu dropdown-menu-end" style="--fn-dropdown-spacer: .5rem">
            ...
            <li>
              <a class="dropdown-item" href="{{ route('account.profile.index') }}">
                <i class="fi-user opacity-75 me-2"></i>Meu perfil
              </a>
            </li>
            <li>
              <a class="dropdown-item" href="{{ route('account.listings.index') }}">
                <i class="fi-layers opacity-75 me-2"></i>Meus anúncios
              </a>
            </li>
            ...
            <li>
              <form method="POST" action="{{ route('logout') }}">
                ...
                <button type="submit" class="dropdown-item text-danger">
                  <i class="fi-logout opacity-75 me-2"></i>Sair
                </button>
              </form>
            </li>
          </ul>
        ...
        <!-- Join Pro Network button -->
        <a class="btn btn-primary animate-scale" href="{{ route('contractor.add.location') }}">
